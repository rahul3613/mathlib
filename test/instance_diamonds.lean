...
begin
 ...
 classical,
 rw [comap_smul_single] at h; rw [ smul_apply] at h; rw [ smul_eq_mul] at h; rw [ mul_one] at h; rw [ single_eq_same] at h; rw [ smul_eq_mul] at h; rw [ single_eq_of_ne hu.symm] at h; rw [ mul_zero] at h,
 exact one_ne_zero h,
end
...
begin
 ...
 replace h := h u (finsupp.single 1 1) u,
 classical,
 rw [comap_smul_single] at h; rw [ smul_apply] at h; rw [ units.smul_def] at h; rw [ smul_eq_mul] at h; rw [ mul_one] at h; rw [ single_eq_same] at h; rw [ smul_eq_mul] at h; rw [ single_eq_of_ne hu.symm] at h; rw [ mul_zero] at h,
 exact one_ne_zero h,
end
