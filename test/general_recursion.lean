...
by rw [easy]; rw [ lawful_fix.fix_eq' easy.cont]; refl
...
by conv_lhs { rw [div]; rw [ lawful_fix.fix_eq' div.cont] }; refl
...
by rw [tree_map]; rw [lawful_fix.fix_eq' (tree_map.cont f)]; refl
...
by conv_lhs { rw [tree_map]; rw [lawful_fix.fix_eq' (tree_map.cont f)] }; refl
...
by conv_lhs { rw [f91]; rw [ lawful_fix.fix_eq' f91.cont] }; refl
...
begin
 ...
 clear n, dsimp [measure,inv_image], intros n ih,
 by_cases h' : n > 100,
 { rw [part.examples.f91.equations.eqn_1]; rw [if_pos h']; rw [if_pos h'],
 simp [pure] },
 { rw [part.examples.f91.equations.eqn_1]; rw [if_neg h']; rw [if_neg h'],
 simp, rcases ih (n + 11) _ with ⟨n',hn'₀,hn'₁⟩,
 split_ifs at hn'₁,
