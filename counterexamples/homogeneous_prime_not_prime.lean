...
lemma grading.mul_mem : ∀ ⦃i j : two⦄ {a b : (R × R)} (ha : a ∈ grading R i) (hb : b ∈ grading R j),
 a * b ∈ grading R (i + j)
| 0 0 a b (ha : a.1 = a.2) (hb : b.1 = b.2) := show a.1 * b.1 = a.2 * b.2, by rw [ha]; rw [ hb]
| 0 1 a b (ha : a.1 = a.2) (hb : b.1 = 0) := show a.1 * b.1 = 0, by rw [hb]; rw [ mul_zero]
| 1 0 a b (ha : a.1 = 0) hb := show a.1 * b.1 = 0, by rw [ha]; rw [ zero_mul]
| 1 1 a b (ha : a.1 = 0) hb := show a.1 * b.1 = 0, by rw [ha]; rw [ zero_mul]
