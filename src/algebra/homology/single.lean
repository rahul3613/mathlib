...
{ map_injective' := λ X Y f g w, begin
 ...
 rw [←is_iso.inv_comp_eq] at this; rw [ inv_eq_to_hom] at this; rw [ eq_to_hom_trans_assoc] at this; rw [ eq_to_hom_refl] at this; rw [ category.id_comp] at this; rw [ ←is_iso.comp_inv_eq] at this; rw [ category.assoc] at this; rw [ inv_eq_to_hom] at this; rw [ eq_to_hom_trans] at this; rw [ eq_to_hom_refl] at this; rw [ category.comp_id] at this,
 exact this,
 end, }
...
{ to_fun := λ f, ⟨f.f 0, by { rw ←f.comm 1 0, simp, }⟩,
 ...
 { rw [C.shape]; rw [ zero_comp], simp, },
 { exact f.2.symm, },
 { rw [C.shape]; rw [ zero_comp], simp [i.succ_succ_ne_one.symm] },
 end, },
 left_inv := λ f, begin
 ext i,
 rcases i,
