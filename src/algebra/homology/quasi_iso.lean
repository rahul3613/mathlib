...
begin
 constructor,
 intros Z g h Hgh,
 rw [←cokernel.π_desc (X.d 1 0) (f.f 0) (by rw ←f.2 1 0 rfl; exact comp_zero), ←to_single₀_cokernel_at_zero_iso_hom_eq] at Hgh,
...
begin
 constructor,
 intros Z g h Hgh,
 rw [←kernel.lift_ι (X.d 0 1) (f.f 0) (by rw f.2 0 1 rfl; exact zero_comp), ←from_single₀_kernel_at_zero_iso_inv_eq] at Hgh,
...
⟨λ i, begin
 ...
 { rw [← functor.comp_map]; rw [ ← nat_iso.naturality_2 (F.homology_functor_iso i) f]; rw [ functor.comp_map],
 apply_instance, },
