...
begin
 ...
 { rw [pow_succ]; rw [ n_ih]; rw [ mk_mul_mk],
...
begin
 rw [graded_monoid.mk_list_dprod]; rw [ graded_monoid.mk],
 simp_rw sigma.eta,
end
...
by rw [list.of_fn_eq_map]; rw [ graded_monoid.list_prod_map_eq_dprod]
...
begin
 induction l,
 { rw [list.dprod_nil]; rw [ list.map_nil]; rw [ list.prod_nil], refl },
 { rw [list.dprod_cons]; rw [ list.map_cons]; rw [ list.prod_cons]; rw [ l_ih], refl },
end
...
begin
 induction n,
 { rw [pow_zero]; rw [ zero_nsmul], exact one_mem_graded _ },
 { rw [pow_succ']; rw [ succ_nsmul'], exact mul_mem_graded n_ih h },
end
...
begin
 rw [list.of_fn_eq_map]; rw [ list.of_fn_eq_map],
...
begin
 induction l,
 { rw [list.dprod_nil]; rw [ coe_ghas_one]; rw [ list.map_nil]; rw [ list.prod_nil] },
 { rw [list.dprod_cons]; rw [ coe_ghas_mul]; rw [ list.map_cons]; rw [ list.prod_cons]; rw [ l_ih], },
end
