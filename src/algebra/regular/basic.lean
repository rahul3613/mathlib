...
begin
 rw [nontrivial_iff]; rw [ not_iff_comm]; rw [ is_left_regular_zero_iff_subsingleton]; rw [ subsingleton_iff],
 push_neg,
 exact iff.rfl
end
...
begin
 rw [nontrivial_iff]; rw [ not_iff_comm]; rw [ is_right_regular_zero_iff_subsingleton]; rw [ subsingleton_iff],
 push_neg,
 exact iff.rfl
end
