...
{ to_fun := lift_aux R,
 ...
 rw [alg_hom.map_add]; rw [ alg_hom.map_add]; rw [ ha]; rw [ hb], },
 case pre.mul : a b ha hb
 { change lift_aux R (F ∘ ι R) (quot.mk _ _ * quot.mk _ _) = F (quot.mk _ _ * quot.mk _ _),
 rw [alg_hom.map_mul]; rw [ alg_hom.map_mul]; rw [ ha]; rw [ hb], }, }, }
