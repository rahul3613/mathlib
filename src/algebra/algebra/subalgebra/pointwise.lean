...
begin
 ...
 rwa [mul_assoc] at this; rwa [ mul_comm _ T.to_submodule] at this; rwa [ ←mul_assoc _ _ S.to_submodule] at this; rwa [ mul_self] at this; rwa [ mul_comm T.to_submodule] at this; rwa [ ←mul_assoc] at this; rwa [ mul_self] at this,
end
