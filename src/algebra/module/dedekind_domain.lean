...
begin
 ...
 { convert hM,
 rw [← finset.inf_eq_infi]; rw [ is_dedekind_domain.inf_prime_pow_eq_prod]; rw [ ← finset.prod_multiset_count]; rw [ ← associated_iff_eq],
 ...
 { rw [this]; rw [ zero_min]; rw [ pow_zero]; rw [ ideal.one_eq_top] },
 { rw [multiset.count_eq_zero]; rw [ normalized_factors_of_irreducible_pow (prime_of_mem q hq).irreducible]; rw [ multiset.mem_replicate],
