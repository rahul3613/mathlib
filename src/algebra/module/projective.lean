...
begin
 ...
 { rw [←fst_apply _]; rw [ apply_total R], exact hsP x, },
 { rw [←snd_apply _]; rw [ apply_total R], exact finsupp.total_zero_apply _ (sP x), },
 { rw [←fst_apply _]; rw [ apply_total R], exact finsupp.total_zero_apply _ (sQ x), },
 { rw [←snd_apply _]; rw [ apply_total R], exact hsQ x, },
end
...
begin
 ...
 rw [←dfinsupp.lapply_apply j]; rw [ apply_total R],
