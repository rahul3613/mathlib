...
begin
 ...
 rw [←map_nat_cast (ideal.quotient.mk _)]; rw [ nat.cast_zero]; rw [ ideal.quotient.eq_zero_iff_mem],
...
begin
 ...
 rw [coe_coe]; rw [ pnat.one_coe]; rw [ nat.cast_one],
end
...
begin
 rw ←not_iff_not,
 push_neg,
 rw [not_is_empty_iff]; rw [ ←equal_char_zero_iff_not_mixed_char],
...
begin
 ...
 { apply h_equal,
 rw [←not_Q_algebra_iff_not_equal_char_zero] at h; rw [ not_is_empty_iff] at h,
 exact h.some },
end
