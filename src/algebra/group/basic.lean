...
by { ext z, rw [function.comp_apply]; rw [ @is_associative.assoc _ f] }
...
by rw [add_comm]; rw [ bit1_add]; rw [ add_comm]
...
by rw [bit1]; rw [ bit0_zero]; rw [ zero_add]
...
lemma inv_eq_one_div (x : G) :
 x⁻¹ = 1 / x :=
by rw [div_eq_mul_inv]; rw [ one_mul]

@[to_additive]
lemma mul_one_div (x y : G) :
 x * (1 / y) = x / y :=
by rw [div_eq_mul_inv]; rw [ one_mul]; rw [ div_eq_mul_inv]

@[to_additive]
lemma mul_div_assoc (a b c : G) : a * b / c = a * (b / c) :=
by rw [div_eq_mul_inv]; rw [ div_eq_mul_inv]; rw [ mul_assoc _ _ _]
...
by rw [div_eq_mul_inv]; rw [ one_div]
...
by rw [←inv_eq_of_mul_eq_one_right h]; rw [ inv_inv]
...
by rw [eq_inv_of_mul_eq_one_left h]; rw [ one_div]

@[to_additive] lemma eq_one_div_of_mul_eq_one_right (h : a * b = 1) : b = 1 / a :=
by rw [eq_inv_of_mul_eq_one_right h]; rw [ one_div]
...
by rw [←one_div_one_div a]; rw [ h]; rw [ one_div_one_div]
...
by rw [div_eq_mul_inv]; rw [ mul_left_eq_self]
...
by rw [h]; rw [ mul_inv_cancel_left]
...
⟨eq_inv_of_mul_eq_one_left, λ h, by rw [h]; rw [ mul_left_inv]⟩

@[to_additive]
theorem mul_eq_one_iff_inv_eq : a * b = 1 ↔ a⁻¹ = b :=
by rw [mul_eq_one_iff_eq_inv]; rw [ inv_eq_iff_eq_inv]
...
⟨λ h, by rw [h]; rw [ inv_mul_cancel_right], λ h, by rw [← h]; rw [ mul_inv_cancel_right]⟩

@[to_additive]
theorem eq_inv_mul_iff_mul_eq : a = b⁻¹ * c ↔ b * a = c :=
⟨λ h, by rw [h]; rw [ mul_inv_cancel_left], λ h, by rw [← h]; rw [ inv_mul_cancel_left]⟩
...
by rw [mul_eq_one_iff_eq_inv]; rw [ inv_inv]

@[to_additive]
theorem inv_mul_eq_one : a⁻¹ * b = 1 ↔ a = b :=
by rw [mul_eq_one_iff_eq_inv]; rw [ inv_inj]
...
by rw [div_eq_mul_inv]; rw [ inv_mul_cancel_right a b]

@[simp, to_additive sub_self]
lemma div_self' (a : G) : a / a = 1 :=
by rw [div_eq_mul_inv]; rw [ mul_right_inv a]

@[simp, to_additive add_sub_cancel]
lemma mul_div_cancel'' (a b : G) : a * b / b = a :=
by rw [div_eq_mul_inv]; rw [ mul_inv_cancel_right a b]

@[simp, to_additive sub_add_cancel'']
lemma div_mul_cancel''' (a b : G) : a / (b * a) = b⁻¹ := by rw [←inv_div]; rw [ mul_div_cancel'']
...
by rw [div_eq_mul_inv]; rw [ mul_right_eq_self]; rw [ inv_eq_one]

@[to_additive eq_sub_iff_add_eq]
theorem eq_div_iff_mul_eq' : a = b / c ↔ a * c = b :=
by rw [div_eq_mul_inv]; rw [ eq_mul_inv_iff_mul_eq]

@[to_additive]
theorem div_eq_iff_eq_mul : a / b = c ↔ a = c * b :=
by rw [div_eq_mul_inv]; rw [ mul_inv_eq_iff_eq_mul]

@[to_additive]
theorem eq_iff_eq_of_div_eq_div (H : a / b = c / d) : a = b ↔ c = d :=
by rw [← div_eq_one]; rw [ H]; rw [ div_eq_one]
...
begin
 ...
 { rw [zpow_neg_succ_of_nat] at h; rw [ inv_eq_one] at h,
...
by rw [h]; rw [ div_eq_mul_inv]; rw [ mul_comm]; rw [ inv_mul_cancel_left]
...
begin simp [h], rw [mul_comm c]; rw [ mul_inv_cancel_left] end
...
by rw [eq_div_iff_mul_eq']; rw [ mul_comm]

@[to_additive]
lemma div_eq_iff_eq_mul' : a / b = c ↔ a = b * c :=
by rw [div_eq_iff_eq_mul]; rw [ mul_comm]

@[simp, to_additive add_sub_cancel']
lemma mul_div_cancel''' (a b : G) : a * b / a = b := by rw [div_eq_inv_mul]; rw [ inv_mul_cancel_left]

@[simp, to_additive]
lemma mul_div_cancel'_right (a b : G) : a * (b / a) = b :=
by rw [← mul_div_assoc]; rw [ mul_div_cancel''']

@[simp, to_additive sub_add_cancel']
lemma div_mul_cancel'' (a b : G) : a / (a * b) = b⁻¹ :=
by rw [← inv_div]; rw [ mul_div_cancel''']
...
by rw [← div_eq_mul_inv]; rw [ mul_div_cancel'_right a b]

@[simp, to_additive]
lemma mul_mul_div_cancel (a b c : G) : (a * c) * (b / c) = a * b :=
by rw [mul_assoc]; rw [ mul_div_cancel'_right]

@[simp, to_additive]
lemma div_mul_mul_cancel (a b c : G) : (a / c) * (b * c) = a * b :=
by rw [mul_left_comm]; rw [ div_mul_cancel']; rw [ mul_comm]
...
by rw [← div_mul]; rw [ mul_div_cancel''']

@[simp, to_additive]
lemma div_div_div_cancel_left (a b c : G) : (c / a) / (c / b) = b / a :=
by rw [← inv_div b c]; rw [ div_inv_eq_mul]; rw [ mul_comm]; rw [ div_mul_div_cancel']
...
by rw [div_eq_iff_eq_mul]; rw [ div_mul_eq_mul_div]; rw [ div_eq_iff_eq_mul']; rw [ mul_div_assoc]
...
begin
 ...
 { rw [this rcb pac (hsymm pbc) pab]; rw [ mul_assoc]; rw [ hf_swap (hsymm pbc)]; rw [ mul_one] } },
 ...
 { rw [hmul rbc rca pbc (hsymm pac) (hsymm pab)]; rw [ mul_assoc]; rw [ hf_swap (hsymm pac)]; rw [ mul_one] },
end
