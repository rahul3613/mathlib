...
begin
 ...
 { rwa [if_neg hln.symm] at hn ; rwa [ if_neg hln.symm] at hn ; rwa [ one_mul] at hn ; rwa [ one_mul] at hn },
 { rwa [if_neg hkl.symm] at hl ; rwa [ if_neg hln] at hl ; rwa [ one_mul] at hl ; rwa [ one_mul] at hl } },
 { rcases eq_or_ne m n with rfl | hmn,
 { rcases eq_or_ne k l with rfl | hkl,
 { rw [if_neg hkm.symm] at hm; rw [ if_neg hkm.symm] at hm; rw [ one_mul] at hm; rw [ if_pos rfl] at hm,
 exact or.inr (or.inr ⟨hm, rfl, rfl⟩) },
 { simpa only [if_neg hkm, if_neg hkl, mul_one] using hk } },
 { rw [if_neg hkm.symm] at hm; rw [ if_neg hmn] at hm; rw [ one_mul] at hm; rw [ mul_one] at hm,
