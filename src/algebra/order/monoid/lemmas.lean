...
iff.intro
 ...
 and.intro ‹a = 1› ‹b = 1›)
 (assume ⟨ha', hb'⟩, by rw [ha']; rw [ hb']; rw [ mul_one])
...
λ b c h, ha.injective $ by rwa [mul_comm a]; rwa [ mul_comm a]
...
by rw [mul_comm b]; rw [ mul_comm c]; rw [ ha.mul_le_mul_iff_left]
