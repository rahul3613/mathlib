...
by rw [← mul_le_mul_iff_left b]; rw [ mul_inv_cancel_left]
...
by rw [← mul_le_mul_iff_left b]; rw [ mul_one]; rw [ mul_inv_cancel_left]
...
lemma left.one_lt_inv_iff :
 1 < a⁻¹ ↔ a < 1 :=
by rw [← mul_lt_mul_iff_left a]; rw [ mul_inv_self]; rw [ mul_one]
...
by rw [← mul_lt_mul_iff_left b]; rw [ mul_inv_cancel_left]
...
by rw [← mul_lt_mul_iff_left b]; rw [ mul_one]; rw [ mul_inv_cancel_left]
...
by rw [← mul_le_mul_iff_right b]; rw [ one_mul]; rw [ inv_mul_cancel_right]
...
lemma right.inv_lt_one_iff :
 a⁻¹ < 1 ↔ 1 < a :=
by rw [← mul_lt_mul_iff_right a]; rw [ inv_mul_self]; rw [ one_mul]
...
by rw [← mul_lt_mul_iff_right b]; rw [ inv_mul_cancel_right]
...
by rw [← mul_lt_mul_iff_right b]; rw [ inv_mul_cancel_right]; rw [ one_mul]

@[to_additive]
lemma lt_mul_inv_iff_lt : 1 < a * b⁻¹ ↔ b < a :=
by rw [← mul_lt_mul_iff_right b]; rw [ one_mul]; rw [ inv_mul_cancel_right]
...
by { rw [← mul_le_mul_iff_left a]; rw [ ← mul_le_mul_iff_right b], simp }

alias neg_le_neg_iff ↔ le_of_neg_le_neg _

@[to_additive]
lemma mul_inv_le_inv_mul_iff : a * b⁻¹ ≤ d⁻¹ * c ↔ d * a ≤ c * b :=
by rw [← mul_le_mul_iff_left d]; rw [ ← mul_le_mul_iff_right b]; rw [ mul_inv_cancel_left]; rw [ mul_assoc]; rw [ inv_mul_cancel_right]
...
by { rw [← mul_lt_mul_iff_left a]; rw [ ← mul_lt_mul_iff_right b], simp }

@[to_additive neg_lt]
lemma inv_lt' : a⁻¹ < b ↔ b⁻¹ < a :=
by rw [← inv_lt_inv_iff]; rw [ inv_inv]
...
by rw [← mul_lt_mul_iff_left d]; rw [ ← mul_lt_mul_iff_right b]; rw [ mul_inv_cancel_left]; rw [ mul_assoc]; rw [ inv_mul_cancel_right]
...
by rw [inv_mul_le_iff_le_mul]; rw [ mul_comm]
...
by rw [mul_comm c]; rw [ mul_inv_le_inv_mul_iff]; rw [ mul_comm]
...
by rw [inv_mul_lt_iff_lt_mul]; rw [ mul_comm]
...
by rw [mul_comm c]; rw [ mul_inv_lt_inv_mul_iff]; rw [ mul_comm]
...
by rw [← mul_le_mul_iff_right b]; rw [ one_mul]; rw [ div_eq_mul_inv]; rw [ inv_mul_cancel_right]
...
by rw [← mul_le_mul_iff_right b]; rw [ div_eq_mul_inv]; rw [ inv_mul_cancel_right]

alias le_sub_iff_add_le ↔ add_le_of_le_sub_right le_sub_right_of_add_le

@[to_additive]
lemma div_le_iff_le_mul : a / c ≤ b ↔ a ≤ b * c :=
by rw [← mul_le_mul_iff_right c]; rw [ div_eq_mul_inv]; rw [ inv_mul_cancel_right]
...
by rw [div_eq_mul_inv]; rw [ div_eq_mul_inv]; rw [ ← mul_le_mul_iff_left a⁻¹]; rw [ inv_mul_cancel_left]; rw [ inv_mul_cancel_left]; rw [ inv_le_inv_iff]
...
by rw [inv_le_div_iff_le_mul]; rw [ mul_comm]
...
by rw [← mul_lt_mul_iff_right b]; rw [ one_mul]; rw [ div_eq_mul_inv]; rw [ inv_mul_cancel_right]
...
by rw [← mul_lt_mul_iff_right b]; rw [ div_eq_mul_inv]; rw [ inv_mul_cancel_right]

alias lt_sub_iff_add_lt ↔ add_lt_of_lt_sub_right lt_sub_right_of_add_lt

@[to_additive]
lemma div_lt_iff_lt_mul : a / c < b ↔ a < b * c :=
by rw [← mul_lt_mul_iff_right c]; rw [ div_eq_mul_inv]; rw [ inv_mul_cancel_right]
...
by rw [div_eq_mul_inv]; rw [ div_eq_mul_inv]; rw [ ← mul_lt_mul_iff_left a⁻¹]; rw [ inv_mul_cancel_left]; rw [ inv_mul_cancel_left]; rw [ inv_lt_inv_iff]

@[simp, to_additive]
lemma inv_lt_div_iff_lt_mul : a⁻¹ < b / c ↔ c < a * b :=
by rw [div_eq_mul_inv]; rw [ lt_mul_inv_iff_mul_lt]; rw [ inv_mul_lt_iff_lt_mul]
...
by rw [← cmp_mul_right' _ _ b]; rw [ one_mul]; rw [ div_mul_cancel']
