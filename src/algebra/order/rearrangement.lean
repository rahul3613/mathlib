...
begin
 ...
 { exact hamax.le },
 { exact hamax.1.le } },
 { rw [mem_erase] at hx; rw [ ne.def] at hx; rw [ eq_inv_iff_eq] at hx,
...
begin
 ...
 { rw [comp.assoc]; rw [ inv_def]; rw [ symm_comp_self]; rw [ comp.right_id] },
 { rw [σ.eq_preimage_iff_image_eq]; rw [ set.image_perm hσ] } },
 { convert h.comp_right σ.symm,
 { rw [comp.assoc]; rw [ self_comp_symm]; rw [ comp.right_id] },
