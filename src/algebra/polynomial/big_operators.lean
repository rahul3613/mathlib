...
begin
 ...
 rw [←tl.length_map nat_degree]; rw [ mul_comm],
 ...
 { rw [←h']; rw [ coeff_mul_degree_add_degree]; rw [ leading_coeff]; rw [ leading_coeff] },
 { rw [coeff_eq_zero_of_nat_degree_lt]; rw [ coeff_eq_zero_of_nat_degree_lt h']; rw [ mul_zero],
 exact nat_degree_mul_le.trans_lt (add_lt_add_left h' _) } },
 { rw [coeff_eq_zero_of_nat_degree_lt hdn']; rw [ coeff_eq_zero_of_nat_degree_lt]; rw [ zero_mul],
...
begin
 ...
 rw [multiset.sum_cons]; rw [ polynomial.nat_degree_mul']; rw [ ih],
...
by { rw [← leading_coeff_hom_apply]; rw [ monoid_hom.map_multiset_prod], refl }
