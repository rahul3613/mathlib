...
begin
 ...
 { rw [← inv_mul_cancel_left a b]; rw [ ← inv_mul_cancel_left a c],
 exact h a⁻¹ bc },
 { rw [← inv_mul_cancel_left a b] at bc; rw [ ← inv_mul_cancel_left a c] at bc,
 exact h a⁻¹ bc }
end
...
begin
 refine ⟨λ h a b c bc, _, λ h a b c bc, _⟩,
 { rw [← mul_inv_cancel_right b a]; rw [ ← mul_inv_cancel_right c a],
 exact h a⁻¹ bc },
 { rw [← mul_inv_cancel_right b a] at bc; rw [ ← mul_inv_cancel_right c a] at bc,
 exact h a⁻¹ bc }
end
