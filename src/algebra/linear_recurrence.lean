...
| n := if h' : n < E.order
 ...
 rw [mk_sol]; rw [ ← tsub_add_cancel_of_le (le_of_not_lt h')]; rw [ h (n-E.order)],
 simp [h'],
 congr' with k,
...
begin
 ...
 rw [← E.to_init.to_equiv.apply_eq_iff_eq]; rw [ linear_equiv.coe_to_equiv],
 ext x,
...
begin
 rw [char_poly]; rw [ polynomial.is_root.def]; rw [ polynomial.eval],
