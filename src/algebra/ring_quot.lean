...
by { rw [add_comm a b]; rw [ add_comm a c], exact rel.add_left h }
...
begin
 ...
 rw [ ← su]; rw [ ring_hom.map_sub]; rw [ mk_ring_hom_rel h]; rw [ sub_self], },
 { simp, },
...
begin
 ...
 { rw [star_add]; rw [ star_add], exact rel.add_left h_ih, },
 { rw [star_mul]; rw [ star_mul], exact rel.mul_right h_ih, },
 { rw [star_mul]; rw [ star_mul], exact rel.mul_left h_ih, },
end
