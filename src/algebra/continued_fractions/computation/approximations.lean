...
by { rw [denom_eq_conts_b]; rw [ nth_cont_eq_succ_nth_cont_aux], exact zero_le_of_continuants_aux_b }
...
begin
 ...
 { suffices : 1 / |denom'| = 1 / denom', by rwa [abs_div]; rwa [ (abs_neg_one_pow n)],
 have : 0 < denom', by
