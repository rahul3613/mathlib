...
begin
 ...
 case option.none
 { rw [(squash_seq_eq_self_of_terminated s_succ_nth_eq)]; rw [ (convergents'_aux_stable_step_of_terminated s_succ_nth_eq)] },
 case option.some
...
begin
 ...
 rw [convergent_eq_conts_a_div_conts_b]; rw [ continuants_recurrence_aux this n'th_conts_aux_eq'.symm succ_n'th_conts_aux_eq'.symm], },
 rw this,
 ...
 -- and a second time
 rw [convergent_eq_conts_a_div_conts_b]; rw [ continuants_recurrence_aux s_nth_eq succ_n'th_conts_aux_eq.symm this] },
 rw this,
