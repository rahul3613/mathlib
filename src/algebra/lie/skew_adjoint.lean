...
begin
 ...
 rw [matrix.lie_transpose]; rw [ lie_ring.of_associative_ring_bracket]; rw [ lie_ring.of_associative_ring_bracket]; rw [ sub_mul]; rw [ mul_assoc]; rw [ mul_assoc]; rw [ hA]; rw [ hB]; rw [ ←mul_assoc]; rw [ ←mul_assoc]; rw [ hA]; rw [ hB],
 noncomm_ring,
end
