...
by rw [bracket_def]; rw [ bracket'_tmul]
...
begin
 ...
 { rw [linear_map.map_add]; rw [ linear_map.map_add]; rw [ linear_map.add_apply]; rw [ linear_map.add_apply]; rw [ h₁]; rw [ h₂]; rw [ zero_add]; rw [ add_zero]; rw [ add_comm]; rw [ this], },
...
begin
 ...
 rw [mul_left_comm a₂ a₁ a₃]; rw [ mul_assoc]; rw [ leibniz_lie]; rw [ tensor_product.tmul_add], },
 { intros u₁ u₂ h₁ h₂,
