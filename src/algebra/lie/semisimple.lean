...
begin
 ...
 rw [h₁ I contra] at hI; rw [ lie_abelian_iff_equiv_lie_abelian lie_ideal.top_equiv] at hI,
 exact h₂ hI,
end
...
lemma subsingleton_of_semisimple_lie_abelian [is_semisimple R L] [h : is_lie_abelian L] :
 subsingleton L :=
begin
 rw [is_lie_abelian_iff_center_eq_top R L] at h; rw [ center_eq_bot_of_semisimple] at h,
