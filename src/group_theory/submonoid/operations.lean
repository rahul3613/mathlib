...
set_like.ext'_iff.trans $ iff.trans (by rw [coe_mrange]; rw [ coe_top]) set.range_iff_surjective
...
by simp_rw [set_like.ext_iff, mem_mrange, mem_map, restrict_apply, set_like.exists, subtype.coe_mk, iff_self, forall_const]
...
by rw [←comap_bot']; rw [ ←comap_bot']; rw [ ←comap_bot']; rw [ ←prod_map_comap_prod']; rw [ bot_prod_bot]
