...
begin
 rw [mem_alternating_group]; rw [ sign_prod_list_swap hl]; rw [ ← units.coe_eq_one]; rw [ units.coe_pow]; rw [ units.coe_neg_one]; rw [ neg_one_pow_eq_one_iff_even],
 dec_trivial
end
...
by rw [mem_alternating_group]; rw [ bit1]; rw [ sign_fin_rotate]; rw [ pow_bit0']; rw [ int.units_mul_self]; rw [ one_pow]
...
begin
 ...
 { rw [mem_alternating_group]; rw [ monoid_hom.map_mul]; rw [ h]; rw [ sign_swap ab]; rw [ int.units_mul_self] },
...
eq_top_iff.2 begin
 ...
 rw [← monoid_hom.range_eq_map]; rw [ subtype_range]; rw [ normal_closure]; rw [ monoid_hom.map_closure],
...
begin
 ...
 { rw [← pow_two]; rw [ order_of_dvd_iff_pow_eq_one.1 hg']; rw [ one_mul],
 exact (card_support_eq_three_iff.1 h3).is_three_cycle_sq },
 rw [← lcm_cycle_type]; rw [ multiset.lcm_dvd],
 intros n hn,
...
begin
 ...
 rw [two_mul_card_alternating_group]; rw [ card_perm]; rw [ ← nat.succ_le_iff],
...
begin
 ...
 dec_trivial },
 rw [eq_top_iff]; rw [ ← normal_closure_fin_rotate_five],
 refine normal_closure_le_normal _,
 rw [set.singleton_subset_iff]; rw [ set_like.mem_coe]; rw [ ← h5],
...
begin
 ...
 rw [← sum_cycle_type] at h; rw [ h2] at h; rw [ multiset.sum_replicate] at h; rw [ smul_eq_mul] at h,
 have h : g.cycle_type.card ≤ 3 := le_of_mul_le_mul_right (le_trans h dec_trivial) dec_trivial,
 rw [mem_alternating_group] at ha; rw [ sign_of_cycle_type] at ha; rw [ h2] at ha,
 norm_num at ha,
 rw [pow_add] at ha; rw [ pow_mul] at ha; rw [ int.units_pow_two] at ha; rw [one_mul] at ha; rw [ units.ext_iff] at ha; rw [ units.coe_one] at ha; rw [ units.coe_pow] at ha; rw [ units.coe_neg_one] at ha; rw [ neg_one_pow_eq_one_iff_even _] at ha,
 swap, { dec_trivial },
 rw [is_conj_iff_cycle_type_eq]; rw [ h2],
 ...
 rw [h_1]; rw [ disjoint.cycle_type]; rw [ (is_cycle_swap h04).cycle_type]; rw [ (is_cycle_swap h13).cycle_type]; rw [ card_support_swap h04]; rw [ card_support_swap h13],
 { refl },
 { rw [disjoint_iff_disjoint_support]; rw [ support_swap h04]; rw [ support_swap h13],
 dec_trivial } },
 { contrapose! ha,
 simp [h_1] }
end
...
⟨exists_pair_ne _, λ H, begin
 ...
 rw [← set_like.mem_coe] at gH; rw [ ← set.singleton_subset_iff] at gH,
 ...
 rw [ne.def] at g1; rw [ subtype.ext_iff] at g1,
 ...
 rw [← sum_cycle_type]; rw [ hm]; rw [ multiset.sum_cons],
 ...
 rw [eq_top_iff]; rw [ ← (is_three_cycle_sq_of_three_mem_cycle_type_five ng).alternating_normal_closure (by rw card_fin )],
 refine normal_closure_le_normal _,
 rw [set.singleton_subset_iff]; rw [ set_like.mem_coe],
 ...
 contrapose! con,
 rw [sign_of_cycle_type]; rw [ cycle_type_of_card_le_mem_cycle_type_add_two dec_trivial ng],
 dec_trivial },
 ...
 rw [cycle_type_of_card_le_mem_cycle_type_add_two dec_trivial ng]; rw [ cycle_type_fin_rotate] }
end⟩
