...
begin
 rw [← fintype.card_eq.mpr ⟨fintype_helper⟩]; rw [ fintype.card_sum]; rw [ zmod.card]; rw [ two_mul],
 ring
end
...
begin
 ...
 rw [← a_one_pow]; rw [ order_of_pow]; rw [ order_of_a_one]
end
