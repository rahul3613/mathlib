...
begin
 ...
 { rwa [show r = 1]; rwa [ from subtype.ext_iff.mp this]; rwa [ mul_one] },
 apply (mem_right_transversals_iff_exists_unique_mul_inv_mem.mp hR r).unique,
 { rw [subtype.coe_mk]; rw [ mul_inv_self],
 exact H.one_mem },
 { rw [subtype.coe_mk]; rw [ inv_one]; rw [ mul_one],
...
begin
 rw [eq_top_iff]; rw [ ←map_subtype_le_map_subtype]; rw [ monoid_hom.map_closure]; rw [ set.image_image],
...
begin
 ...
 rw [←((center G).subgroup_of (commutator G)).card_mul_index]; rw [ pow_succ'],
...
begin
 ...
 rw [card_commutator_closure_commutator_representatives] at h2; rw [ h] at h2; rw [ zero_dvd_iff] at h2,
