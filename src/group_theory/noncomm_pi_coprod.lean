...
begin
 ...
 rw [supr_subtype'] at hxp; rw [ ← noncomm_pi_coprod_range] at hxp,
 ...
 { rw [← hgf]; rw [ ← fintype.card_pi], exact (order_of_map_dvd _ _).trans order_of_dvd_card_univ },
 change f = 1, rw [← pow_one f]; rw [ ← order_of_dvd_iff_pow_eq_one],
