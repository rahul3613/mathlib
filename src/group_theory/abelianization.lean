...
begin
 rw [←subgroup.centralizer_univ]; rw [ ←subgroup.coe_top]; rw [ ←subgroup.commutator_eq_bot_iff_le_centralizer],
...
begin
 rw [commutator_eq_closure G]; rw [ ←image_commutator_set_closure_commutator_representatives]; rw [ ←monoid_hom.map_closure]; rw [ ←commutator_eq_closure],
 exact nat.card_congr (equiv.set.image _ _ (subtype_injective _)),
end
