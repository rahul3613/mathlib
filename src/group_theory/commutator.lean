...
by rw [commutator_element_def]; rw [ mul_inv_eq_one]; rw [ mul_inv_eq_iff_eq_mul]
...
begin
 ...
 rw [mem_bot]; rw [ commutator_element_eq_one_iff_mul_comm]; rw [ eq_comm],
end
...
begin
 simp_rw [commutator_eq_bot_iff_le_centralizer, commutator_le, mem_centralizer_iff_commutator_eq_one, ←commutator_element_def] at h1 h2 ⊢,
 intros x hx y hy z hz,
 transitivity x * z * ⁅y, ⁅z⁻¹, x⁻¹⁆⁆⁻¹ * z⁻¹ * y * ⁅x⁻¹, ⁅y⁻¹, z⁆⁆⁻¹ * y⁻¹ * x⁻¹,
 { group },
 { rw [h1 _ (H₂.inv_mem hy) _ hz _ (H₁.inv_mem hx)]; rw [ h2 _ (H₃.inv_mem hz) _ (H₁.inv_mem hx) _ hy],
 group },
end
