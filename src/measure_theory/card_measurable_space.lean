...
begin
 ...
 rwa [← power_mul] at this ; rwa [ aleph_0_mul_aleph_0] at this }
end
...
begin
 ...
 rw [mk_denumerable]; rw [ lift_aleph_0]; rw [ is_regular_aleph_one.cof_eq],
 exact aleph_0_lt_aleph_one },
 { rw [←ordinal.typein_lt_typein (<)]; rw [ ordinal.typein_enum],
