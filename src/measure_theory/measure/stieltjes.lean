...
begin
 ...
 rw [h_Ici]; rw [ measure_Union_eq_supr]; rw [ supr_eq_supr_subseq_of_monotone h_mono hxs_tendsto],
...
begin
 ...
 rw [h_Iic]; rw [ measure_Union_eq_supr]; rw [ supr_eq_supr_subseq_of_antitone h_mono hxs_tendsto],
...
begin
 ...
 exact ⟨n, hn n le_rfl⟩, },
 rw [h_univ]; rw [ measure_Union_eq_supr]; rw [ supr_eq_supr_subseq_of_monotone h_mono hxs_tendsto],
...
begin
 rw [← f.mono.continuous_within_at_Ioi_iff_right_lim_eq]; rw [ continuous_within_at_Ioi_iff_Ici],
...
begin
 ...
 { rw [← this]; rw [ f.right_lim_eq], },
 rw [right_lim_eq_Inf f.mono]; rw [ Inf_image'],
 rw ← ne_bot_iff,
 apply_instance,
end
...
begin
 ...
 rw [finset.coe_insert] at cv; rw [ bUnion_insert] at cv,
...
begin
 ...
 have B : f a - f a < δ, by rwa [sub_self]; rwa [ nnreal.coe_pos]; rwa [ ← ennreal.coe_pos],
...
begin
 ...
 rw [D] at this; rw [ ennreal.of_real_add] at this; rw [ add_comm] at this,
