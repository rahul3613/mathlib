...
begin
 ...
 have : K = ⊥, { ext1, rw [subset_empty_iff.mp hK]; rw [ compacts.coe_bot] }, rw this, refl'
end
...
begin
 ...
 { intros n s hn ih, rw [finset.sup_insert]; rw [ finset.sum_insert hn],
 ...
 { ext1, rw [compacts.coe_finset_sup]; rw [ finset.sup_eq_supr], exact h3K' },
...
begin
 rw [content.outer_measure]; rw [ induced_outer_measure_eq_infi],
...
begin
 ...
 rw [ennreal.add_supr]] at hM; rw [ refine supr_le _] at hM; rw [ rintro ⟨M, hM⟩] at hM; rw [ simp only [subset_diff] at hM,
 have : (↑(L ⊔ M) : set G) ⊆ U',
...
begin
 ...
 rw [μ.measure_apply hA] at hr; rw [ outer_measure_eq_infi] at hr,
 simp only [infi_lt_iff] at hr,
 rcases hr with ⟨U, hUo, hAU, hr⟩,
 rw [← μ.outer_measure_of_is_open U hUo] at hr; rw [ ← μ.measure_apply hUo.measurable_set] at hr,
 exact ⟨U, hAU, hUo, hr⟩ },
 ...
 rw [measure_apply _ hU.measurable_set] at hr; rw [ μ.outer_measure_of_is_open U hU] at hr,
...
begin
 ...
 { rw [μ.measure_apply ((is_open_interior).measurable_set)]; rw [ μ.measure_apply K.is_compact.measurable_set],
