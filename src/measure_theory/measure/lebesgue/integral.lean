...
begin
 ...
 rw [volume_region_between_eq_lintegral f_int.ae_measurable g_int.ae_measurable hs]; rw [ integral_congr_ae h]; rw [ lintegral_congr_ae]; rw [ lintegral_coe_eq_integral _ ((integrable_congr h).mp (g_int.sub f_int))],
 simpa only,
end
