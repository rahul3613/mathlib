...
by rw [← coe_fn_comp_to_finite_measure_eq_coe_fn]; rw [ finite_measure.ennreal_coe_fn_eq_coe_fn_to_measure]; rw [ coe_comp_to_finite_measure_eq_coe]
...
begin
 ...
 by rw [univ_eq_empty_iff.mpr (not_nonempty_iff.mp maybe_empty)]; rw [ measure_empty],
...
begin
 rw [←finite_measure.mass_nonzero_iff]; rw [ μ.mass_to_finite_measure],
 exact one_ne_zero,
end
...
begin
 ...
 intros s s_mble,
 rw [μ.self_eq_mass_mul_normalize s]; rw [ coe_fn_smul_apply]; rw [ smul_eq_mul]; rw [ probability_measure.coe_fn_comp_to_finite_measure_eq_coe_fn],
end
...
begin
 rw [μ.coe_normalize_eq_of_nonzero nonzero]; rw [ average],
 congr,
...
begin
 ...
 rw [μ.normalize.to_finite_measure.smul_test_against_nn_apply μ.mass f]; rw [ smul_eq_mul],
end
...
begin
 rw [probability_measure.tendsto_nhds_iff_to_finite_measures_tendsto_nhds]; rw [ tendsto_iff_forall_test_against_nn_tendsto],
