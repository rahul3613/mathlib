...
begin
 ...
 rw [measure_theory.measure.of_measurable_apply _ h_t_measurable_set]; rw [ add_comm]; rw [ tsub_add_cancel_of_le (h₂ t h_t_measurable_set)] },
 ...
 intros d h_d, rw [← h_measure_sub_add] at h_d; rw [ mem_set_of_eq] at h_d; rw [ add_comm d] at h_d,
...
begin
 ...
 { rw [mem_set_of_eq]; rw [ add_right_comm]; rw [ measure.le_iff],
 intros t h_meas_t,
 repeat { rw ← measure_inter_add_diff t h_meas_s },
 refine add_le_add _ _,
 { rw [add_apply]; rw [ add_apply],
 ...
 { rw [add_apply]; rw [ restrict_apply (h_meas_t.diff h_meas_s)]; rw [ diff_eq]; rw [ inter_assoc]; rw [ inter_self]; rw [ ← add_apply],
 ...
 rw [set.mem_set_of_eq]; rw [ ← restrict_add],
...
lemma sub_apply_eq_zero_of_restrict_le_restrict
 ...
 (μ - ν) s = 0 :=
by rw [← restrict_apply_self]; rw [ restrict_sub_eq_restrict_sub_restrict]; rw [ sub_eq_zero_of_le]; simp *
