...
begin
 ...
 rw [← measure_inter_not_convergent_seq_eq_zero hfg n]; rw [ inter_Inter],
...
begin
 ...
 { rw [gt_iff_lt]; rw [ ennreal.of_real_pos],
...
begin
 ...
 rw [ennreal.tsum_mul_left]; rw [ ← ennreal.of_real_tsum_of_nonneg]; rw [ inv_eq_one_div]; rw [ tsum_geometric_two]; rw [ ← ennreal.of_real_mul (half_pos hε).le]; rw [ div_mul_cancel ε two_ne_zero],
 { exact le_rfl },
...
begin
 rw [Union_not_convergent_seq]; rw [ ← inter_Union],
