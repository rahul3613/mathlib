...
begin
 ...
 rw [integrable_on]; rw [ integrable_congr hfg_restrict.symm],
...
begin
 ...
 { intros s hs hμs,
 rw [integrable_on]; rw [ integrable_congr (ae_restrict_of_ae (Lp.coe_fn_sub f g))],
...
begin
 ...
 rw [integrable_on]; rw [ restrict_trim hm _ hs],
 ...
 { intros s hs hμs,
 rw trim_measurable_set_eq hm hs at hμs,
 rw [restrict_trim hm _ hs]; rw [ ← integral_trim hm hfm.strongly_measurable_mk]; rw [ ← integral_trim hm hgm.strongly_measurable_mk]; rw [ integral_congr_ae (ae_restrict_of_ae hfm.ae_eq_mk.symm)]; rw [ integral_congr_ae (ae_restrict_of_ae hgm.ae_eq_mk.symm)],
...
begin
 ...
 { rw [measure.restrict_restrict (hm _ h_meas_nonneg_g)]; rw [ measure.restrict_restrict h_meas_nonneg_f]; rw [ hgf _ (@measurable_set.inter α m _ _ h_meas_nonneg_g hs) ((measure_mono (set.inter_subset_right _ _)).trans_lt (lt_top_iff_ne_top.mpr hμs))]; rw [ ← measure.restrict_restrict (hm _ h_meas_nonneg_g)]; rw [ ← measure.restrict_restrict h_meas_nonneg_f],
 exact set_integral_le_nonneg (hm _ h_meas_nonneg_g) hf hfi, },
 { rw [measure.restrict_restrict (hm _ h_meas_nonpos_g)]; rw [ measure.restrict_restrict h_meas_nonpos_f]; rw [ hgf _ (@measurable_set.inter α m _ _ h_meas_nonpos_g hs) ((measure_mono (set.inter_subset_right _ _)).trans_lt (lt_top_iff_ne_top.mpr hμs))]; rw [ ← measure.restrict_restrict (hm _ h_meas_nonpos_g)]; rw [ ← measure.restrict_restrict h_meas_nonpos_f],
...
lemma lintegral_nnnorm_le_of_forall_fin_meas_integral_eq (hm : m ≤ m0) {f g : α → ℝ}
 ...
 ∫⁻ x in s, ‖g x‖₊ ∂μ ≤ ∫⁻ x in s, ‖f x‖₊ ∂μ :=
begin
 rw [← of_real_integral_norm_eq_lintegral_nnnorm hfi]; rw [ ← of_real_integral_norm_eq_lintegral_nnnorm hgi]; rw [ ennreal.of_real_le_of_real_iff],
