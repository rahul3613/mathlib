...
begin
 ...
 ... = ∫⁻ (x : α), f x ∂μ + ε : by rw [add_assoc]; rw [ ennreal.add_halves] },
end
...
begin
 ...
 ... = ennreal.to_real (∫⁻ (a : α), f a ∂μ) + δ :
 by rw [ennreal.to_real_add int_f_ne_top ennreal.coe_ne_top]; rw [ ennreal.coe_to_real]
...
begin
 ...
 ... = ∫⁻ x, g x ∂μ + ε : by rw [add_assoc]; rw [ ennreal.add_halves]
end
