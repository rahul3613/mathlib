...
by { rw [nhds_within]; rw [ principal_singleton]; rw [ inf_eq_right.2 (pure_le_nhds a)], apply_instance }
...
begin
 rw [has_fderiv_within_at]; rw [ nhds_within_prod_eq],
 have := integral_sub_integral_sub_linear_is_o_of_tendsto_ae hf hmeas_a hmeas_b ha hb
...
begin
 ...
 begin
 rw [interval_integral.integral_of_le hu.1.le]; rw [ ← integral_Icc_eq_integral_Ioc],
 ...
 rwa [← smul_eq_mul] at this ; rwa [ sub_smul_slope] at this },
...
begin
 ...
 rw [← g.interval_integral_comp_comm f'int]; rw [ g.map_sub],
...
begin
 ...
 rw [integral_symm]; rw [ integral_eq_sub_of_has_deriv_right_of_le hab hcont hderiv hint.symm]; rw [ neg_sub] }
end
...
begin
 ...
 { rw [continuous_on_update_iff]; rw [ continuous_on_update_iff]; rw [ Icc_diff_right]; rw [ Ico_diff_left],
...
begin
 ...
 { rw [← integral_Ioc_eq_integral_Ioo]; rw [ ← interval_integral.integral_of_le hab.le],
...
begin
 rw [hf.image_uIcc] at hg1; rw [ ←interval_integrable_iff'] at hg1,
...
begin
 rw [integral_comp_smul_deriv'' hf hff' hf' hg']; rw [ integral_eq_sub_of_has_deriv_right hg hgg' (hg'.mono _).interval_integrable],
