...
begin
 ...
 { intro i,
 rw [integrable_on]; rw [ measure.restrict_restrict (hφ.measurable i)],
 exact hfi i },
 refine hφ.integrable_of_integral_norm_bounded I hfi (h.mp _),
 filter_upwards [ha.eventually (eventually_le_at_bot b)] with i hai,
 rw [interval_integral.integral_of_le hai]; rw [ measure.restrict_restrict (hφ.measurable i)],
 exact id
end
...
begin
 ...
 { intro i,
 rw [integrable_on]; rw [ measure.restrict_restrict (hφ.measurable i)]; rw [ inter_comm],
 exact hfi i },
 refine hφ.integrable_of_integral_norm_bounded I hfi (h.mp _),
 filter_upwards [hb.eventually (eventually_ge_at_top a)] with i hbi,
 rw [interval_integral.integral_of_le hbi]; rw [ measure.restrict_restrict (hφ.measurable i)]; rw [ inter_comm],
 exact id
end
...
begin
 ...
 rw [←integral_indicator (this a)]; rw [ ←integral_indicator (this $ b * a)],
