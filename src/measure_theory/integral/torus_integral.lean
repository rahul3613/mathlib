...
begin
 rw [torus_integrable]; rw [ torus_map_zero_radius],
...
begin
 ...
 (Icc_prod_eq _ _),
 rw [torus_integral]; rw [ ← hem.map_eq]; rw [ set_integral_map_equiv]; rw [ heπ]; rw [ measure.volume_eq_prod]; rw [ set_integral_prod]; rw [ circle_integral_def_Icc],
 ...
 rwa [← hem.integrable_on_comp_preimage e.measurable_embedding] at this ; rwa [ heπ] at this }
end
