...
begin
 ...
 rw [category.assoc]; rw [ category.assoc]; rw [ associator_inv_naturality_assoc]; rw [ associator_inv_naturality_assoc]; rw [ ←tensor_id_comp_id_tensor g]; rw [ category.assoc]; rw [ category.assoc]; rw [ category.assoc]; rw [ category.assoc]; rw [ id_tensor_comp_tensor_id_assoc]; rw [ ←left_unitor_naturality]; rw [ tensor_id_comp_id_tensor_assoc],
end
...
begin
 ...
 rw [category.assoc]; rw [ category.assoc]; rw [ associator_naturality_assoc]; rw [ associator_naturality_assoc]; rw [ ←id_tensor_comp_tensor_id _ g]; rw [ category.assoc]; rw [ category.assoc]; rw [ category.assoc]; rw [ category.assoc]; rw [ tensor_id_comp_id_tensor_assoc]; rw [ ←right_unitor_naturality]; rw [ id_tensor_comp_tensor_id_assoc],
end
...
begin
 ...
 category.assoc],
 symmetry, iterate 5 { transitivity, rw [←category.id_comp g]; rw [ tensor_comp] },
 rw ←category.assoc,
 symmetry, iterate 2 { transitivity, rw ←category.assoc }, apply eq_whisker,
 repeat { rw ←id_tensor_comp }, congr' 1,
 rw [←id_tensor_comp_tensor_id (λ_ Xᘁ).hom g]; rw [ id_tensor_right_unitor_inv]; rw [ category.assoc]; rw [ category.assoc]; rw [ right_unitor_inv_naturality_assoc]; rw [ ←associator_naturality_assoc]; rw [ tensor_id]; rw [ tensor_id_comp_id_tensor_assoc]; rw [ ←associator_naturality_assoc],
 slice_rhs 2 3 { rw [←tensor_comp]; rw [ tensor_id]; rw [ category.comp_id]; rw [ ←category.id_comp (η_ Y Yᘁ)]; rw [ tensor_comp] },
 ...
 slice_rhs 5 7 { rw [←comp_tensor_id]; rw [ ←comp_tensor_id]; rw [ evaluation_coevaluation]; rw [ comp_tensor_id] },
 rw associator_inv_naturality_assoc,
 slice_rhs 4 5 { rw [←tensor_comp]; rw [ left_unitor_naturality]; rw [ tensor_comp] },
 repeat { rw category.assoc },
 rw [triangle_assoc_comp_right_inv_assoc]; rw [ ←left_unitor_tensor_assoc]; rw [ left_unitor_naturality_assoc]; rw [ unitors_equal]; rw [ ←category.assoc]; rw [ ←category.assoc], simp
end
...
begin
 ...
 rw [←tensor_id_comp_id_tensor g (ρ_ (ᘁX)).hom]; rw [ left_unitor_inv_tensor_id]; rw [ category.assoc]; rw [ category.assoc]; rw [ left_unitor_inv_naturality_assoc]; rw [ ←associator_inv_naturality_assoc]; rw [ tensor_id]; rw [ id_tensor_comp_tensor_id_assoc]; rw [ ←associator_inv_naturality_assoc],
 slice_rhs 2 3 { rw [←tensor_comp]; rw [ tensor_id]; rw [ category.comp_id]; rw [ ←category.id_comp (η_ (ᘁY) Y)]; rw [ tensor_comp] },
 ...
 slice_rhs 5 7 { rw [←id_tensor_comp]; rw [ ←id_tensor_comp]; rw [ coevaluation_evaluation]; rw [ id_tensor_comp ]},
 rw associator_naturality_assoc,
 slice_rhs 4 5 { rw [←tensor_comp]; rw [ right_unitor_naturality]; rw [ tensor_comp] },
 repeat { rw category.assoc },
 rw [triangle_assoc_comp_left_inv_assoc]; rw [ ←right_unitor_tensor_assoc]; rw [ right_unitor_naturality_assoc]; rw [ ←unitors_equal]; rw [ ←category.assoc]; rw [ ←category.assoc], simp
end
...
{ to_fun := λ f, (λ_ _).inv ≫ (η_ _ _ ⊗ 𝟙 _) ≫ (α_ _ _ _).hom ≫ (𝟙 _ ⊗ f),
 ...
 slice_lhs 5 6 { rw [tensor_id]; rw [ id_tensor_comp_tensor_id]; rw [ ←tensor_id_comp_id_tensor], },
 ...
 slice_lhs 4 7 { rw c, },
 slice_lhs 3 5 { rw [←comp_tensor_id]; rw [ ←comp_tensor_id]; rw [ coevaluation_evaluation], },
 ...
 slice_lhs 2 3 { rw [tensor_id]; rw [ tensor_id_comp_id_tensor]; rw [ ←id_tensor_comp_tensor_id], },
 ...
 slice_lhs 5 8 { rw c, },
 slice_lhs 4 6 { rw [←comp_tensor_id]; rw [ ←comp_tensor_id]; rw [ evaluation_coevaluation], },
 simp only [left_unitor_conjugation],
 coherence,
 end, }
...
{ to_fun := λ f, (ρ_ _).inv ≫ (𝟙 _ ⊗ η_ _ _) ≫ (α_ _ _ _).inv ≫ (f ⊗ 𝟙 _),
 ...
 slice_lhs 2 3 { rw [tensor_id]; rw [ id_tensor_comp_tensor_id]; rw [ ←tensor_id_comp_id_tensor], },
 ...
 slice_lhs 5 8 { rw c, },
 slice_lhs 4 6 { rw [←id_tensor_comp]; rw [ ←id_tensor_comp]; rw [ coevaluation_evaluation], },
 simp only [right_unitor_conjugation],
 coherence,
 end, }
...
begin
 ...
 conv_rhs { rw [←id_tensor_comp_tensor_id]; rw [ comp_tensor_id]; rw [ comp_tensor_id], },
 simp, coherence,
end
...
begin
 ...
 conv_rhs { rw [←tensor_id_comp_id_tensor]; rw [ id_tensor_comp]; rw [ id_tensor_comp], },
...
begin
 ...
 slice_lhs 3 4 { rw [tensor_id]; rw [ tensor_id_comp_id_tensor]; rw [ ←id_tensor_comp_tensor_id], },
...
{ evaluation := (𝟙 Y ⊗ i.hom) ≫ ε_ _ _,
 ...
 slice_lhs 2 3 { rw [associator_naturality], },
 slice_lhs 3 4 { rw [tensor_id]; rw [ tensor_id_comp_id_tensor]; rw [ ←id_tensor_comp_tensor_id], },
 slice_lhs 4 5 { rw [tensor_id_comp_id_tensor]; rw [ ←id_tensor_comp_tensor_id], },
 slice_lhs 2 3 { rw [←associator_naturality], },
 slice_lhs 1 2 { rw [tensor_id]; rw [ tensor_id_comp_id_tensor]; rw [ ←id_tensor_comp_tensor_id], },
...
{ evaluation := (i.hom ⊗ 𝟙 X) ≫ ε_ _ _,
 ...
 slice_lhs 3 4 { rw [associator_inv_naturality], },
 slice_lhs 4 5 { rw [tensor_id]; rw [ id_tensor_comp_tensor_id]; rw [ ←tensor_id_comp_id_tensor], },
...
{ hom := @right_adjoint_mate C _ _ X X ⟨Y₂⟩ ⟨Y₁⟩ (𝟙 X),
 ...
 hom_inv_id' := by rw [←comp_right_adjoint_mate]; rw [ category.comp_id]; rw [ right_adjoint_mate_id],
 inv_hom_id' := by rw [←comp_right_adjoint_mate]; rw [ category.comp_id]; rw [ right_adjoint_mate_id] }
...
{ hom := @left_adjoint_mate C _ _ Y Y ⟨X₂⟩ ⟨X₁⟩ (𝟙 Y),
 ...
 hom_inv_id' := by rw [←comp_left_adjoint_mate]; rw [ category.comp_id]; rw [ left_adjoint_mate_id],
 inv_hom_id' := by rw [←comp_left_adjoint_mate]; rw [ category.comp_id]; rw [ left_adjoint_mate_id] }
