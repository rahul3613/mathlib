...
{ hom := ⟨f.hom⟩,
 ...
 { hom := f.inv,
 left_act_hom' := begin
 rw [←(cancel_mono f.hom)]; rw [ category.assoc]; rw [ category.assoc]; rw [ iso.inv_hom_id]; rw [ category.comp_id]; rw [ f_left_act_hom]; rw [ ←category.assoc]; rw [ ←id_tensor_comp]; rw [ iso.inv_hom_id]; rw [ monoidal_category.tensor_id]; rw [ category.id_comp],
 end,
 right_act_hom' := begin
 rw [←(cancel_mono f.hom)]; rw [ category.assoc]; rw [ category.assoc]; rw [ iso.inv_hom_id]; rw [ category.comp_id]; rw [ f_right_act_hom]; rw [ ←category.assoc]; rw [ ←comp_tensor_id]; rw [ iso.inv_hom_id]; rw [ monoidal_category.tensor_id]; rw [ category.id_comp],
 end },
 hom_inv_id' := begin
...
colim_map
 ...
 slice_rhs 4 5 { rw [←tensor_comp]; rw [ middle_assoc]; rw [ tensor_comp]; rw [ comp_tensor_id] },
 coherence,
 end
 begin
 dsimp,
 ...
 slice_lhs 3 4 { rw [tensor_id]; rw [ id_tensor_comp_tensor_id] },
 slice_rhs 4 6 { rw iso.inv_hom_id_assoc },
 slice_rhs 3 4 { rw [tensor_id]; rw [ tensor_id_comp_id_tensor] },
 end)
...
begin
 ...
 dsimp [X],
 slice_lhs 1 2 { rw [id_tensor_comp_tensor_id]; rw [ ←tensor_id_comp_id_tensor] },
 slice_lhs 2 3 { rw id_tensor_π_act_left },
 slice_lhs 1 2 { rw [←monoidal_category.tensor_id]; rw [ associator_inv_naturality] },
 slice_lhs 2 3 { rw [←comp_tensor_id]; rw [ one_act_left] },
...
begin
 ...
 slice_lhs 2 3 { rw id_tensor_π_act_left },
 slice_lhs 1 2 { rw [←monoidal_category.tensor_id]; rw [ associator_inv_naturality] },
 slice_lhs 2 3 { rw [←comp_tensor_id]; rw [ left_assoc]; rw [ comp_tensor_id]; rw [ comp_tensor_id] },
 slice_rhs 1 2 { rw [←monoidal_category.tensor_id]; rw [ associator_naturality] },
 slice_rhs 2 3 { rw [←id_tensor_comp]; rw [ id_tensor_π_act_left]; rw [ id_tensor_comp]; rw [ id_tensor_comp] },
...
colim_map
 ...
 slice_lhs 2 3 { rw [tensor_id]; rw [ tensor_id_comp_id_tensor] },
 slice_rhs 3 4 { rw associator_inv_naturality },
 slice_rhs 2 4 { rw iso.hom_inv_id_assoc },
 slice_rhs 2 3 { rw [tensor_id]; rw [ id_tensor_comp_tensor_id] },
 end
 begin
 dsimp,
 slice_lhs 1 1 { rw comp_tensor_id },
 slice_lhs 2 3 { rw associator_naturality },
 slice_lhs 3 4 { rw [←id_tensor_comp]; rw [ middle_assoc]; rw [ id_tensor_comp] },
 slice_rhs 4 6 { rw iso.inv_hom_id_assoc },
...
begin
 ...
 dsimp [X],
 slice_lhs 1 2 { rw [tensor_id_comp_id_tensor]; rw [ ←id_tensor_comp_tensor_id] },
 slice_lhs 2 3 { rw π_tensor_id_act_right },
 slice_lhs 1 2 { rw [←monoidal_category.tensor_id]; rw [ associator_naturality] },
 slice_lhs 2 3 { rw [←id_tensor_comp]; rw [ act_right_one] },
...
begin
 ...
 slice_lhs 2 3 { rw π_tensor_id_act_right },
 slice_lhs 1 2 { rw [←monoidal_category.tensor_id]; rw [ associator_naturality] },
 slice_lhs 2 3 { rw [←id_tensor_comp]; rw [ right_assoc]; rw [ id_tensor_comp]; rw [ id_tensor_comp] },
 slice_rhs 1 2 { rw [←monoidal_category.tensor_id]; rw [ associator_inv_naturality] },
 slice_rhs 2 3 { rw [←comp_tensor_id]; rw [ π_tensor_id_act_right]; rw [ comp_tensor_id]; rw [ comp_tensor_id] },
...
begin
 ...
 dsimp [X],
 slice_lhs 1 2 { rw [←comp_tensor_id]; rw [ id_tensor_π_act_left]; rw [ comp_tensor_id]; rw [ comp_tensor_id] },
 slice_lhs 3 4 { rw π_tensor_id_act_right },
 slice_lhs 2 3 { rw associator_naturality },
 slice_lhs 3 4 { rw [monoidal_category.tensor_id]; rw [ tensor_id_comp_id_tensor] },
 slice_rhs 1 2 { rw associator_naturality },
 slice_rhs 2 3 { rw [←id_tensor_comp]; rw [ π_tensor_id_act_right]; rw [ id_tensor_comp]; rw [ id_tensor_comp] },
 slice_rhs 4 5 { rw id_tensor_π_act_left },
 slice_rhs 3 4 { rw associator_inv_naturality },
 slice_rhs 4 5 { rw [monoidal_category.tensor_id]; rw [ id_tensor_comp_tensor_id] },
 coherence,
end
...
{ hom :=
 ...
 (by rw [←tensor_comp]; rw [ ←tensor_comp]; rw [ hom.right_act_hom]; rw [ category.id_comp]; rw [ category.comp_id])
 begin
 slice_lhs 2 3 { rw [←tensor_comp]; rw [ hom.left_act_hom]; rw [ category.id_comp] },
 slice_rhs 1 2 { rw associator_naturality },
 slice_rhs 2 3 { rw [←tensor_comp]; rw [ category.comp_id] },
 end),
 left_act_hom' := begin
 refine (cancel_epi ((tensor_left _).map (coequalizer.π _ _))).1 _,
 dsimp,
 slice_lhs 1 2 { rw tensor_Bimod.id_tensor_π_act_left },
 slice_lhs 3 4 { rw [ι_colim_map]; rw [ parallel_pair_hom_app_one] },
 slice_lhs 2 3 { rw [←tensor_comp]; rw [ hom.left_act_hom]; rw [ category.id_comp] },
 slice_rhs 1 2 { rw [←id_tensor_comp]; rw [ ι_colim_map]; rw [ parallel_pair_hom_app_one]; rw [ id_tensor_comp] },
 ...
 slice_lhs 3 4 { rw [ι_colim_map]; rw [ parallel_pair_hom_app_one] },
 slice_lhs 2 3 { rw [←tensor_comp]; rw [ category.id_comp]; rw [ hom.right_act_hom] },
 slice_rhs 1 2 { rw [←comp_tensor_id]; rw [ ι_colim_map]; rw [ parallel_pair_hom_app_one]; rw [ comp_tensor_id] },
...
coequalizer.desc
 ...
 slice_lhs 1 2 { rw associator_naturality },
 slice_lhs 2 3 { rw [monoidal_category.tensor_id]; rw [ tensor_id_comp_id_tensor]; rw [ ←id_tensor_comp_tensor_id] },
 slice_lhs 3 4 { rw coequalizer.condition },
 slice_lhs 2 3 { rw [←monoidal_category.tensor_id]; rw [ associator_naturality] },
 slice_lhs 3 4 { rw [←id_tensor_comp]; rw [ tensor_Bimod.id_tensor_π_act_left]; rw [ id_tensor_comp] },
...
coequalizer.desc
 ...
 slice_lhs 1 2 { rw [←comp_tensor_id]; rw [ tensor_Bimod.π_tensor_id_act_right]; rw [ comp_tensor_id]; rw [ comp_tensor_id] },
 slice_lhs 3 5 { rw π_tensor_id_preserves_coequalizer_inv_desc },
 slice_lhs 2 3 { rw associator_naturality },
 slice_lhs 3 4 { rw [←id_tensor_comp]; rw [ coequalizer.condition]; rw [ id_tensor_comp]; rw [ id_tensor_comp] },
 slice_rhs 1 2 { rw associator_naturality },
 slice_rhs 2 3 { rw [monoidal_category.tensor_id]; rw [ tensor_id_comp_id_tensor]; rw [ ←id_tensor_comp_tensor_id] },
 slice_rhs 3 5 { rw π_tensor_id_preserves_coequalizer_inv_desc },
 slice_rhs 2 3 { rw [←monoidal_category.tensor_id]; rw [ associator_naturality] },
 coherence,
 end
...
begin
 ...
 slice_rhs 1 2 { rw [←id_tensor_comp]; rw [ coequalizer.π_desc]; rw [ id_tensor_comp] },
 refine (cancel_epi ((tensor_right _ ⋙ tensor_left _).map (coequalizer.π _ _))).1 _,
 dsimp, dsimp [tensor_Bimod.X],
 slice_lhs 1 2 { rw associator_inv_naturality },
 slice_lhs 2 3 { rw [←comp_tensor_id]; rw [ tensor_Bimod.id_tensor_π_act_left]; rw [ comp_tensor_id]; rw [ comp_tensor_id] },
 slice_lhs 4 6 { rw π_tensor_id_preserves_coequalizer_inv_desc },
 slice_lhs 3 4 { rw associator_naturality },
 slice_lhs 4 5 { rw [monoidal_category.tensor_id]; rw [ tensor_id_comp_id_tensor] },
 slice_rhs 1 3 { rw [←id_tensor_comp]; rw [ ←id_tensor_comp]; rw [ π_tensor_id_preserves_coequalizer_inv_desc]; rw [ id_tensor_comp]; rw [ id_tensor_comp] },
 slice_rhs 3 4 { erw tensor_Bimod.id_tensor_π_act_left P (Q.tensor_Bimod L) },
 slice_rhs 2 3 { erw associator_inv_naturality },
 slice_rhs 3 4 { erw [monoidal_category.tensor_id]; erw [ id_tensor_comp_tensor_id] },
 coherence,
end
...
begin
 ...
 slice_lhs 1 2 { rw tensor_Bimod.π_tensor_id_act_right },
 slice_lhs 3 4 { rw coequalizer.π_desc },
 slice_rhs 1 2 { rw [←comp_tensor_id]; rw [ coequalizer.π_desc]; rw [ comp_tensor_id] },
 refine (cancel_epi ((tensor_right _ ⋙ tensor_right _).map (coequalizer.π _ _))).1 _,
 dsimp, dsimp [tensor_Bimod.X],
 slice_lhs 1 2 { rw associator_naturality },
 slice_lhs 2 3 { rw [monoidal_category.tensor_id]; rw [ tensor_id_comp_id_tensor]; rw [ ←id_tensor_comp_tensor_id] },
 slice_lhs 3 5 { rw π_tensor_id_preserves_coequalizer_inv_desc },
 slice_lhs 2 3 { rw [←monoidal_category.tensor_id]; rw [ associator_naturality] },
 slice_rhs 1 3 { rw [←comp_tensor_id]; rw [ ←comp_tensor_id]; rw [ π_tensor_id_preserves_coequalizer_inv_desc]; rw [ comp_tensor_id]; rw [ comp_tensor_id] },
 slice_rhs 3 4 { erw tensor_Bimod.π_tensor_id_act_right P (Q.tensor_Bimod L) },
 slice_rhs 2 3 { erw associator_naturality },
 dsimp,
 slice_rhs 3 4 { rw [←id_tensor_comp]; rw [ tensor_Bimod.π_tensor_id_act_right]; rw [ id_tensor_comp]; rw [ id_tensor_comp] },
 coherence,
end
...
coequalizer.desc
 ...
 dsimp, dsimp [tensor_Bimod.X],
 slice_lhs 1 2 { rw associator_inv_naturality },
 rw [←(iso.inv_hom_id_assoc (α_ _ _ _) (𝟙 P.X ⊗ Q.act_right))]; rw [ comp_tensor_id],
 slice_lhs 3 4 { rw [←comp_tensor_id]; rw [ category.assoc]; rw [ ←tensor_Bimod.π_tensor_id_act_right]; rw [ comp_tensor_id] },
 slice_lhs 4 5 { rw coequalizer.condition },
 slice_lhs 3 4 { rw associator_naturality },
 slice_lhs 4 5 { rw [monoidal_category.tensor_id]; rw [ tensor_id_comp_id_tensor] },
 slice_rhs 1 2 { rw id_tensor_comp },
 slice_rhs 2 3 { rw associator_inv_naturality },
 slice_rhs 3 4 { rw [monoidal_category.tensor_id]; rw [ id_tensor_comp_tensor_id] },
 coherence,
 end
...
coequalizer.desc
 ...
 slice_lhs 1 2 { rw [←monoidal_category.tensor_id]; rw [ associator_inv_naturality] },
 slice_lhs 2 3 { rw [←comp_tensor_id]; rw [ coequalizer.condition]; rw [ comp_tensor_id]; rw [ comp_tensor_id] },
 slice_rhs 1 2 { rw [←monoidal_category.tensor_id]; rw [ associator_naturality] },
 slice_rhs 2 3 { rw [←id_tensor_comp]; rw [ tensor_Bimod.id_tensor_π_act_left]; rw [ id_tensor_comp]; rw [ id_tensor_comp] },
...
coequalizer.desc P.act_left (by { dsimp, rw [category.assoc]; rw [ left_assoc] })
...
begin
 ...
 slice_lhs 2 3 { rw [id_tensor_comp_tensor_id]; rw [ ←tensor_id_comp_id_tensor] },
 slice_lhs 3 3 { rw ←(iso.inv_hom_id_assoc (α_ R.X R.X P.X) (𝟙 R.X ⊗ P.act_left)) },
 slice_lhs 4 6 { rw [←category.assoc]; rw [ ←coequalizer.condition] },
 slice_lhs 2 3 { rw [←monoidal_category.tensor_id]; rw [ associator_inv_naturality] },
 slice_lhs 3 4 { rw [←comp_tensor_id]; rw [ Mon_.one_mul] },
...
begin
 dsimp [hom, inv],
 slice_lhs 3 4 { rw coequalizer.π_desc },
 rw [one_act_left]; rw [ iso.inv_hom_id],
end
...
begin
 ...
 slice_rhs 1 2 { rw [←id_tensor_comp]; rw [ coequalizer.π_desc] },
...
begin
 ...
 slice_rhs 1 2 { rw [←comp_tensor_id]; rw [ coequalizer.π_desc] },
...
coequalizer.desc P.act_right
 (by { dsimp, rw [category.assoc]; rw [ right_assoc]; rw [ iso.hom_inv_id_assoc] })
...
begin
 ...
 slice_lhs 2 3 { rw [tensor_id_comp_id_tensor]; rw [ ←id_tensor_comp_tensor_id] },
 slice_lhs 3 4 { rw coequalizer.condition },
 slice_lhs 2 3 { rw [←monoidal_category.tensor_id]; rw [ associator_naturality] },
 slice_lhs 3 4 { rw [←id_tensor_comp]; rw [ Mon_.mul_one] },
 slice_rhs 1 2 { rw category.comp_id },
 coherence,
end
...
begin
 dsimp [hom, inv],
 slice_lhs 3 4 { rw coequalizer.π_desc },
 rw [act_right_one]; rw [ iso.inv_hom_id],
end
...
by rw [←tensor_comp]; rw [ category.comp_id]
...
begin
 ...
 ext, dsimp,
 slice_lhs 1 2 { rw [ι_colim_map]; rw [ parallel_pair_hom_app_one] },
 ...
 slice_rhs 3 4 { rw [id_tensor_comp_tensor_id]; rw [ ←tensor_id_comp_id_tensor] },
 slice_rhs 4 4 { rw ←(iso.inv_hom_id_assoc (α_ X.X X.X N.X) (𝟙 X.X ⊗ N.act_left)) },
 slice_rhs 5 7 { rw [←category.assoc]; rw [ ←coequalizer.condition] },
 slice_rhs 3 4 { rw [←monoidal_category.tensor_id]; rw [ associator_inv_naturality] },
 slice_rhs 4 5 { rw [←comp_tensor_id]; rw [ Mon_.one_mul] },
 have :
...
begin
 ...
 slice_rhs 3 4 { rw [ι_colim_map]; rw [ parallel_pair_hom_app_one] },
 slice_rhs 2 3 { rw [←id_tensor_comp]; rw [ ι_colim_map]; rw [ parallel_pair_hom_app_one] },
 ...
 slice_rhs 2 3 { rw associator_inv_naturality },
 slice_rhs 1 3 { rw [iso.hom_inv_id_assoc]; rw [ monoidal_category.tensor_id] },
 slice_lhs 1 2 { rw [tensor_id_comp_id_tensor]; rw [ ←id_tensor_comp_tensor_id] },
 dunfold tensor_Bimod.X,
 simp only [category.assoc],
end
...
begin
 ...
 slice_rhs 3 4 { rw [tensor_id_comp_id_tensor]; rw [ ←id_tensor_comp_tensor_id] },
 slice_rhs 4 5 { rw coequalizer.condition },
 slice_rhs 3 4 { rw [←monoidal_category.tensor_id]; rw [ associator_naturality] },
 slice_rhs 4 5 { rw [←id_tensor_comp]; rw [ Mon_.mul_one] },
 have :
...
begin
 ...
 slice_rhs 3 4 { rw [ι_colim_map]; rw [ parallel_pair_hom_app_one] },
 slice_rhs 2 3 { rw [←comp_tensor_id]; rw [ ι_colim_map]; rw [ parallel_pair_hom_app_one] },
 slice_rhs 3 4 { rw coequalizer.π_desc },
 dsimp [associator_Bimod.hom_aux],
 slice_rhs 2 2 { rw comp_tensor_id },
 slice_rhs 3 5 { rw π_tensor_id_preserves_coequalizer_inv_desc },
 slice_rhs 2 3 { rw associator_naturality },
 slice_rhs 1 3 { rw [iso.inv_hom_id_assoc]; rw [ monoidal_category.tensor_id] },
 slice_lhs 1 2 { rw [id_tensor_comp_tensor_id]; rw [ ←tensor_id_comp_id_tensor] },
 dunfold tensor_Bimod.X,
 simp only [category.assoc],
end
...
begin
 ...
 refine (cancel_epi ((tensor_right _).map (coequalizer.π _ _))).1 _,
 rw tensor_right_map,
 slice_lhs 1 2 { rw [←comp_tensor_id]; rw [ ι_colim_map]; rw [ parallel_pair_hom_app_one] },
 slice_rhs 1 3 { rw π_tensor_id_preserves_coequalizer_inv_desc },
 slice_rhs 3 4 { rw [ι_colim_map]; rw [ parallel_pair_hom_app_one] },
 slice_rhs 2 3 { rw [←id_tensor_comp]; rw [ ι_colim_map]; rw [ parallel_pair_hom_app_one] },
...
begin
 ...
 ext, dsimp,
 slice_lhs 1 2 { rw [ι_colim_map]; rw [ parallel_pair_hom_app_one] },
 slice_lhs 2 3 { rw [ι_colim_map]; rw [ parallel_pair_hom_app_one] },
 slice_lhs 1 2 { rw id_tensor_comp_tensor_id },
 slice_rhs 1 2 { rw [ι_colim_map]; rw [ parallel_pair_hom_app_one] },
 slice_rhs 2 3 { rw [ι_colim_map]; rw [ parallel_pair_hom_app_one] },
...
begin
 ...
 refine (cancel_epi ((tensor_right _).map (coequalizer.π _ _))).1 _,
 dsimp,
 slice_lhs 1 2 { rw [←comp_tensor_id]; rw [ coequalizer.π_desc] },
 slice_rhs 1 3 { rw π_tensor_id_preserves_coequalizer_inv_desc },
 slice_rhs 3 4 { rw coequalizer.π_desc },
 refine (cancel_epi ((tensor_right _ ⋙ tensor_right _).map (coequalizer.π _ _))).1 _,
 dsimp,
 slice_lhs 1 2 { rw [←comp_tensor_id]; rw [ π_tensor_id_preserves_coequalizer_inv_desc]; rw [ comp_tensor_id]; rw [ comp_tensor_id ]},
 slice_lhs 3 5 { rw π_tensor_id_preserves_coequalizer_inv_desc },
 dunfold tensor_Bimod.X,
 slice_lhs 2 3 { rw associator_naturality },
 slice_lhs 5 6 { rw [ι_colim_map]; rw [ parallel_pair_hom_app_one] },
 slice_lhs 4 5 { rw [←id_tensor_comp]; rw [ coequalizer.π_desc] },
 slice_lhs 3 4 { rw [←id_tensor_comp]; rw [ π_tensor_id_preserves_coequalizer_inv_desc]; rw [ id_tensor_comp]; rw [ id_tensor_comp] },
 slice_rhs 1 2 { rw associator_naturality },
 slice_rhs 2 3 { rw [monoidal_category.tensor_id]; rw [ tensor_id_comp_id_tensor]; rw [ ←id_tensor_comp_tensor_id] },
 slice_rhs 3 5 { rw π_tensor_id_preserves_coequalizer_inv_desc },
 slice_rhs 2 3 { rw [←monoidal_category.tensor_id]; rw [ associator_naturality] },
...
begin
 ...
 slice_lhs 3 4 { rw [ι_colim_map]; rw [ parallel_pair_hom_app_one] },
 dsimp [left_unitor_Bimod.hom],
 slice_lhs 2 3 { rw [←id_tensor_comp]; rw [ coequalizer.π_desc] },
 slice_rhs 1 2 { rw [←comp_tensor_id]; rw [ coequalizer.π_desc] },
