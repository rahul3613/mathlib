...
{ tensor_obj := λ X Y, e.functor.obj (e.inverse.obj X ⊗ e.inverse.obj Y),
 ...
 simp only [←e.functor.map_comp],
 congr' 2,
 slice_lhs 4 5 { rw [←comp_tensor_id]; rw [ iso.hom_inv_id_app], dsimp, rw [tensor_id], },
 simp only [category.id_comp, category.assoc],
 slice_lhs 5 6 { rw [←id_tensor_comp]; rw [ iso.hom_inv_id_app], dsimp, rw [tensor_id], },
 simp only [category.id_comp, category.assoc],
 slice_rhs 2 3 { rw [id_tensor_comp_tensor_id]; rw [ ←tensor_id_comp_id_tensor], },
 slice_rhs 1 2 { rw [←tensor_id]; rw [ ←associator_naturality], },
 slice_rhs 3 4 { rw [←tensor_id]; rw [ associator_naturality], },
 ...
 dsimp, rw [tensor_id]; rw [ tensor_id], },
 simp only [category.id_comp, category.assoc],
 end,
 ...
 congr' 2,
 rw [e.inverse.map_id]; rw [ id_tensor_comp_tensor_id_assoc]; rw [ ←tensor_id_comp_id_tensor_assoc]; rw [ left_unitor_naturality],
 end,
 ...
 simp only [functor.comp_map, ←e.functor.map_comp_assoc],
 congr' 2,
 rw [e.inverse.map_id]; rw [ tensor_id_comp_id_tensor_assoc]; rw [ ←id_tensor_comp_tensor_id_assoc]; rw [ right_unitor_naturality],
 end,
 ...
 slice_lhs 2 3 { rw [id_tensor_comp_tensor_id]; rw [ ←tensor_id_comp_id_tensor]; rw [ ←tensor_id], },
 simp only [category.assoc],
 slice_lhs 3 4 { rw [associator_naturality], },
 conv_lhs { simp only [comp_tensor_id], },
 slice_lhs 3 4 { rw [←comp_tensor_id]; rw [ iso.hom_inv_id_app], dsimp, rw [tensor_id], },
 simp only [category.id_comp, category.assoc],
 slice_lhs 2 3 { rw [associator_naturality], },
 simp only [category.assoc],
 congr' 2,
 slice_lhs 1 1 { rw [←tensor_id_comp_id_tensor], },
 slice_lhs 2 3 { rw [←id_tensor_comp]; rw [ tensor_id_comp_id_tensor], },
 slice_lhs 1 2 { rw [tensor_id_comp_id_tensor], },
 conv_rhs { congr, skip, rw [←id_tensor_comp_tensor_id]; rw [ id_tensor_comp], },
 simp only [category.assoc],
 slice_rhs 1 2 { rw [←id_tensor_comp]; rw [ iso.hom_inv_id_app], dsimp, rw [tensor_id],},
 simp only [category.id_comp, category.assoc],
...
{ to_functor := e.functor,
 ...
 simp only [←e.functor.map_comp],
 congr' 1,
 rw [←tensor_comp]; rw [ iso.hom_inv_id_app]; rw [ iso.hom_inv_id_app]; rw [ ←tensor_comp],
 dsimp,
 ...
 slice_lhs 2 3 { rw [←comp_tensor_id]; rw [ iso.hom_inv_id_app], dsimp, rw [tensor_id] },
 simp only [id_comp],
 slice_rhs 2 3 { rw [←id_tensor_comp]; rw [ iso.hom_inv_id_app], dsimp, rw [tensor_id] },
 simp only [id_comp],
 conv_rhs { rw [←id_tensor_comp_tensor_id _ (e.unit_inv.app X)], },
 dsimp only [functor.comp_obj],
 slice_rhs 3 4 { rw [←id_tensor_comp]; rw [ iso.hom_inv_id_app], dsimp, rw [tensor_id] },
