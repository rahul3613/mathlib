...
begin
 ...
 rw [fork_of_kernel_fork_ι]; rw [ fork.ι_postcompose]; rw [ kernel_fork.ι_of_ι]; rw [ parallel_pair.eq_of_hom_eq_hom_app],
...
begin
 ...
 rw [cofork_of_cokernel_cofork_π]; rw [ cofork.π_precompose]; rw [ cokernel_cofork.π_of_π]; rw [ iso.symm_hom]; rw [ parallel_pair.ext_inv_app]; rw [ iso.refl_inv],
