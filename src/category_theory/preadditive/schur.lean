...
begin
 ...
 use c,
 rw [spectrum.mem_iff] at nu; rw [ is_unit.sub_iff] at nu; rw [ is_unit_iff_is_iso] at nu; rw [ is_iso_iff_nonzero] at nu; rw [ ne.def] at nu; rw [ not_not] at nu; rw [ sub_eq_zero] at nu; rw [ algebra.algebra_map_eq_smul_one] at nu,
 exact nu.symm, },
end
