...
begin
 rw [is_separator_iff_faithful_coyoneda_obj]; rw [ ← whiskering_preadditive_coyoneda]; rw [ functor.comp_obj]; rw [ whiskering_right_obj_obj],
...
begin
 rw [is_separator_iff_faithful_preadditive_coyoneda]; rw [ preadditive_coyoneda_obj_2],
...
begin
 rw [is_coseparator_iff_faithful_yoneda_obj]; rw [ ← whiskering_preadditive_yoneda]; rw [ functor.comp_obj]; rw [ whiskering_right_obj_obj],
 exact ⟨λ h, by exactI faithful.of_comp _ (forget AddCommGroup), λ h, by exactI faithful.comp _ _⟩
end
...
begin
 rw [is_coseparator_iff_faithful_preadditive_yoneda]; rw [ preadditive_yoneda_obj_2],
 exact ⟨λ h, by exactI faithful.of_comp _ (forget₂ _ AddCommGroup.{v}),
 λ h, by exactI faithful.comp _ _⟩
end
