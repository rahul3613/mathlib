...
begin
 ...
 erw [whisker_right_comp]; erw [ category.assoc],
 slice_lhs 2 3 { rw plus_comp_iso_whisker_right },
 rw [category.assoc]; rw [ ← J.plus_map_comp]; rw [ whisker_right_to_plus_comp_plus_comp_iso_hom]; rw [ ← category.assoc]; rw [ whisker_right_to_plus_comp_plus_comp_iso_hom],
 refl,
end
