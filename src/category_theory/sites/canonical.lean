...
begin
 ...
 rw [op_comp] at this; rw [ functor_to_types.map_comp_apply] at this,
 rw this,
 change s _ _ = s _ _,
 simp },
 ...
 rw [op_comp]; rw [ functor_to_types.map_comp_apply]; rw [ presieve.is_sheaf_for.valid_glue _ _ _ hg],
 apply ht hg _ hf },
 { intros y hy,
 ...
 intros Z g hg,
 rw [←functor_to_types.map_comp_apply]; rw [ ←op_comp]; rw [ hy _ (presieve.bind_comp _ _ hg)]; rw [ hU.valid_glue _ _ hf]; rw [ ht hf _ hg] }
end
