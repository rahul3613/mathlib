...
(λ X, begin
 ...
 dsimp,
 simp only [category.assoc],
 erw [multiequalizer.lift_ι]; erw [ diagram_comp_iso_hom_ι]; erw [ diagram_comp_iso_hom_ι]; erw [ ← F.map_comp]; erw [ multiequalizer.lift_ι],
end
...
begin
 ...
 erw [multiequalizer.lift_ι]; erw [ multiequalizer.lift_ι],
 refl,
end
