...
begin
 ...
 intros Y' f hf,
 rw [presieve.is_sheaf_for.valid_glue _ _ _ hf]; rw [ ← hy _ hf],
 refl } }
end
...
{ lift := λ (E : multifork _), hP.amalgamate S (λ I, E.ι _) (λ I, E.condition _),
 ...
 { rw [← E.w (walking_multicospan.hom.fst b)]; rw [ ← (S.multifork P).w (walking_multicospan.hom.fst b)]; rw [ ← assoc],
 congr' 1,
 apply hP.amalgamate_map }
 end,
 uniq' := begin
...
begin
 ...
 rintros (a|b),
 { apply he },
 { rw [← K.w (walking_multicospan.hom.fst b)]; rw [ ← (T.multifork P).w (walking_multicospan.hom.fst b)]; rw [ ← assoc],
 congr' 1,
 apply he } }
end
...
begin
 rw [is_sheaf_iff_is_sheaf']; rw [ is_sheaf_iff_is_sheaf'],
