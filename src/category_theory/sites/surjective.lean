...
begin
 rw [image_sheaf_ι]; rw [ is_locally_surjective_iff_image_presheaf_sheafify_eq_top']; rw [ subpresheaf.eq_top_iff_is_iso],
...
begin
 ...
 refine ⟨t', _⟩,
 rw [op_comp]; rw [ F₃.map_comp]; rw [ nat_trans.comp_app]; rw [ comp_apply]; rw [ comp_apply]; rw [ ht']; rw [ elementwise_of f₂.naturality]; rw [ H.some_spec] },
...
begin
 rw [is_locally_surjective_iff_whisker_forget]; rw [ ← to_sheafify_comp_sheafify_comp_iso_inv],
 apply is_locally_surjective.comp,
 { rw [is_locally_surjective_iff_image_presheaf_sheafify_eq_top]; rw [ subpresheaf.eq_top_iff_is_iso],
