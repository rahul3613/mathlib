...
{ hom :=
 ...
 erw [category.id_comp]; erw [ ←functor_to_types.naturality],
 ...
 begin
 intros X Y f, ext, dsimp,
 rw [←functor_to_types.naturality]; rw [ functor_to_types.map_comp_apply]
 end },
 hom_inv_id' :=
 begin
 ext, dsimp,
 erw [←functor_to_types.naturality]; erw [ obj_map_id],
