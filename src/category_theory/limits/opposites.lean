...
begin
 ...
 dsimp,
 rw [← pullback_iso_unop_pushout_inv_fst]; rw [ iso.hom_inv_id_assoc],
end
...
begin
 apply quiver.hom.unop_inj,
 dsimp,
 rw [← pullback_iso_unop_pushout_inv_snd]; rw [ iso.hom_inv_id_assoc],
end
...
begin
 apply quiver.hom.unop_inj,
 dsimp,
 rw [← pushout_iso_unop_pullback_inl_hom]; rw [ category.assoc]; rw [ iso.hom_inv_id]; rw [ category.comp_id],
end
...
begin
 apply quiver.hom.unop_inj,
 dsimp,
 rw [← pushout_iso_unop_pullback_inr_hom]; rw [ category.assoc]; rw [ iso.hom_inv_id]; rw [ category.comp_id],
end
