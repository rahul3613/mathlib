...
{ obj := λ x, limit (diagram ι F x),
 ...
 intros x y z f g,
 ext j,
 erw [limit.pre_pre]; erw [ limit.pre_π]; erw [ limit.pre_π],
 congr' 1,
 tidy,
 end }
...
{ to_fun := λ f,
 ...
 intros x y ff,
 ext j,
 erw [limit.lift_pre]; erw [ limit.lift_π]; erw [ category.assoc]; erw [ limit.lift_π (cone _ f) j],
 tidy,
 end },
 left_inv := begin
 intro x,
...
{ obj := λ x, colimit (diagram ι F x),
 ...
 intro l,
 ext j,
 erw [colimit.ι_pre]; erw [ category.comp_id],
 congr' 1,
 simp,
 end,
 map_comp' := begin
 ...
 erw [colimit.pre_pre dd gg ff]; erw [ colimit.ι_pre]; erw [ colimit.ι_pre],
 congr' 1,
 simp,
 end }
...
{ to_fun := λ f,
 ...
 intros x y ff,
 ext j,
 erw [colimit.pre_desc]; erw [ ← category.assoc]; erw [ colimit.ι_desc]; erw [ colimit.ι_desc],
 tidy,
 end },
 left_inv := begin
 intro x,
