...
(preserves_cokernel.iso _ _).trans (cokernel.map_iso _ _ ((F.map_iso (image_subobject_iso _)).trans
 ...
 erw [kernel_subobject_arrow']; erw [ kernel_comparison_comp_ι]; erw [ image_subobject_arrow'],
 simp [←F.map_comp],
 end)
...
begin
 ...
 dsimp,
 rw [kernel_map_comp_preserves_kernel_iso_inv_assoc]; rw [ ←F.map_comp_assoc]; rw [ ←kernel_map_comp_kernel_subobject_iso_inv],
 any_goals { simp },
end
