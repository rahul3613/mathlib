...
{ obj := triangle.inv_rotate,
 ...
 begin
 dsimp,
 rw [neg_comp]; rw [ assoc]; rw [ comp_neg]; rw [ neg_inj]; rw [ ← functor.map_comp_assoc]; rw [ ← f.comm₃]; rw [ functor.map_comp]; rw [ assoc],
 erw [← nat_trans.naturality],
 refl,
 end,
 comm₃' := by { dsimp, erw [← f.comm₂_assoc]; erw [ assoc]; erw [ ← nat_trans.naturality], refl, }, }, }
