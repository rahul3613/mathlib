...
{ app := λ j, (adj.hom_equiv (K.obj j) Y) (t.app j),
 naturality' := λ j j' f, by { erw [← adj.hom_equiv_naturality_left]; erw [ t.naturality], dsimp, simp } }
...
{ app := λ j, (adj.hom_equiv (K.obj j) Y).symm (t.app j),
 naturality' := λ j j' f,
 begin
 erw [← adj.hom_equiv_naturality_left_symm]; erw [ ← adj.hom_equiv_naturality_right_symm]; erw [ t.naturality],
 dsimp, simp
 end }
...
{ app := λ j, (adj.hom_equiv (unop X) (K.obj j)) (t.app j),
 naturality' := λ j j' f,
 begin
 erw [← adj.hom_equiv_naturality_right]; erw [ ← t.naturality]; erw [ category.id_comp]; erw [ category.id_comp],
 refl
 end }
...
{ app := λ j, (adj.hom_equiv (unop X) (K.obj j)).symm (t.app j),
 naturality' := λ j j' f,
 begin
 erw [← adj.hom_equiv_naturality_right_symm]; erw [ ← t.naturality]; erw [ category.id_comp]; erw [ category.id_comp]
 end }
