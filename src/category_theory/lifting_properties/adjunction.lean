...
{ to_fun := λ l,
 ...
 fac_left' := by rw [← adj.hom_equiv_naturality_left]; rw [ l.fac_left],
 fac_right' := by rw [← adjunction.hom_equiv_naturality_right]; rw [ l.fac_right], },
 inv_fun := λ l,
 { l := (adj.hom_equiv _ _).symm l.l,
 fac_left' := begin
 rw [← adjunction.hom_equiv_naturality_left_symm]; rw [ l.fac_left],
 apply (adj.hom_equiv _ _).left_inv,
 end,
 fac_right' := begin
 rw [← adjunction.hom_equiv_naturality_right_symm]; rw [ l.fac_right],
 apply (adj.hom_equiv _ _).left_inv,
 end, },
 left_inv := by tidy,
 right_inv := by tidy, }
...
{ to_fun := λ l,
 { l := (adj.hom_equiv _ _).symm l.l,
 fac_left' := by rw [← adj.hom_equiv_naturality_left_symm]; rw [ l.fac_left],
 fac_right' := by rw [← adj.hom_equiv_naturality_right_symm]; rw [ l.fac_right], },
 inv_fun := λ l,
 { l := (adj.hom_equiv _ _) l.l,
 fac_left' := begin
 rw [← adj.hom_equiv_naturality_left]; rw [ l.fac_left],
 apply (adj.hom_equiv _ _).right_inv,
 end,
 fac_right' := begin
 rw [← adj.hom_equiv_naturality_right]; rw [ l.fac_right],
 apply (adj.hom_equiv _ _).right_inv,
 end, },
 left_inv := by tidy,
 right_inv := by tidy, }
