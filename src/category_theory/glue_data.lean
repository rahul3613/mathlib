...
by { rw [←category.assoc]; rw [ ←D.t_fac], simp }
...
begin
 ...
 rw [←is_iso.eq_inv_comp] at this; rw [ ←category.assoc] at this; rw [ is_iso.comp_inv_eq] at this,
 simpa using this,
end
...
nat_iso.of_components
 ...
 { erw [category.comp_id]; erw [ category.id_comp]; erw [ functor.map_id], refl },
 { erw [category.comp_id]; erw [ category.id_comp], refl },
 { erw [category.comp_id]; erw [ category.id_comp]; erw [ functor.map_comp], refl },
 { erw [category.comp_id]; erw [ category.id_comp]; erw [ functor.map_id], refl },
 end)
...
by rw [iso.comp_inv_eq]; rw [ ι_glued_iso_hom]
...
begin
 ...
 rw [e.hom_inv_id] at eq; rw [ D.ι_glued_iso_inv] at eq,
 exact ⟨i, y, eq⟩
end
