...
by rw [←comp_whisker_right]; rw [ naturality_naturality]; rw [ comp_whisker_right]; rw [ whisker_assoc]
...
by { rw [←associator_naturality_middle]; rw [ ←comp_whisker_right_assoc]; rw [ naturality_comp], simp }
...
by { rw [←associator_naturality_middle]; rw [ ←comp_whisker_right_assoc]; rw [ naturality_id], simp }
