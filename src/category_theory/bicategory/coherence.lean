...
by { induction f, refl, refl,
 case comp : _ _ _ _ _ ihf ihg { rw [normalize_aux]; rw [ ihf]; rw [ ihg], apply comp_assoc } }
```
-/
...
begin
 ...
 { rw [mk_vcomp]; rw [ bicategory.whisker_left_comp],
 ...
 { dsimp,
 rw [associator_inv_naturality_middle_assoc]; rw [ ←comp_whisker_right_assoc]; rw [ ih]; rw [ comp_whisker_right],
...
begin
 ...
 case id { refl },
 case of { refl },
 case comp : _ _ _ g _ ihf ihg { erw [ihg (f.comp g)]; erw [ ihf f]; erw [ ihg g]; erw [ comp_assoc] }
end
...
begin
 intros f g η,
 erw [left_unitor_inv_naturality_assoc]; erw [ assoc],
 congr' 1,
