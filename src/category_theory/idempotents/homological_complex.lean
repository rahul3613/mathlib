...
begin
 rw [is_idempotent_complete_iff_of_equivalence ((to_karoubi_equivalence C).map_homological_complex c)]; rw [ ← is_idempotent_complete_iff_of_equivalence (karoubi_homological_complex_equivalence C c)],
 apply_instance,
end
