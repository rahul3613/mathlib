...
{ to_fun := λ γ, inv f ≫ γ ≫ f,
 ...
 left_inv := λ γ, by simp_rw [category.assoc, comp_inv, category.comp_id, ←category.assoc, comp_inv, category.id_comp],
 right_inv := λ δ, by simp_rw [category.assoc, inv_comp, ←category.assoc, inv_comp, category.id_comp, category.comp_id],
