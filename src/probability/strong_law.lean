...
begin
 ...
 rw [← integral_map hf.ae_measurable]; rw [ interval_integral.integral_of_le]; rw [ ← integral_indicator M],
...
begin
 ...
 { rw [← integral_map hf.ae_measurable]; rw [ interval_integral.integral_of_le hA]; rw [ ← integral_indicator M],
 { simp only [indicator, zero_pow' _ hn, id.def, ite_pow] },
 { exact ((measurable_id.indicator M).pow_const n).ae_strongly_measurable } },
 { rw [← integral_map hf.ae_measurable]; rw [ interval_integral.integral_of_ge hA.le]; rw [ ← integral_indicator M'],
...
begin
 ...
 { assume a b,
 rw [of_real_set_integral_one ρ _]; rw [ measure.map_apply_of_ae_measurable hint.ae_measurable measurable_set_Ioc],
 refl },
...
begin
 ...
 rw [← interval_integral.integral_const_mul]; rw [ interval_integral.integral_of_le Ik]; rw [ interval_integral.integral_of_le Ik],
...
begin
 ...
 congr' 1 with i,
 congr' 1,
 rw [hS]; rw [ indep_fun.variance_sum],
 { assume j hj,
...
begin
 ...
 rw [← tendsto_sub_nhds_zero_iff]; rw [ ← asymptotics.is_o_one_iff ℝ],
