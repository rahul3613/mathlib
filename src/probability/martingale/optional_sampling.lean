...
begin
 ...
 rw [filter.eventually_eq]; rw [ ae_restrict_iff' (ℱ.le _ _ (hτ.measurable_set_eq i))],
...
begin
 ...
 rw [this]; rw [ ae_eq_restrict_bUnion_iff _ h_countable_range],
...
begin
 ...
 rw [hτ.measurable_set_inter_le_iff] at ht; rw [ is_stopping_time.measurable_set_min_iff hτ hσ] at ht,
 exact ht.2, },
...
begin
 ...
 rw [filter.eventually_eq] at this; rw [ ae_restrict_iff'] at this,
 ...
 { rw [is_stopping_time.measurable_space_min]; rw [ is_stopping_time.measurable_space_min]; rw [ inf_comm] },
