...
begin
 rw [← sub_nonneg]; rw [ ← integral_sub']; rw [ stopped_value_sub_eq_sum' hle hbdd],
...
begin
 ...
 ⟨j, λ x, le_rfl⟩,
 rwa [stopped_value_const] at hf; rwa [ stopped_value_piecewise_const] at hf; rwa [ integral_piecewise (𝒢.le _ _ hs) (hint _).integrable_on (hint _).integrable_on] at hf; rwa [ ← integral_add_compl (𝒢.le _ _ hs) (hint j)] at hf; rwa [ add_le_add_iff_right] at hf,
end
...
begin
 ...
 rw [ennreal.le_of_real_iff_to_real_le]; rw [ ennreal.to_real_smul],
 { exact h },
...
begin
 ...
 { rw [← ennreal.of_real_add]; rw [ ← integral_union],
 ...
 rwa [hadd] at this ; rwa [ ennreal.add_le_add_iff_right ennreal.of_real_ne_top] at this },
