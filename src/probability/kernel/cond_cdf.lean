...
begin
 ...
 { symmetry,
 rw [real.infi_of_not_bdd_below hf]; rw [ ennreal.of_real_zero]; rw [ ← ennreal.bot_eq_zero]; rw [ infi_eq_bot],
...
by rw [Iic_snd]; rw [ fst_apply hs]; rw [ restrict_apply' (measurable_set.univ.prod (measurable_set_Iic : measurable_set (Iic r)))]; rw [ ← prod_univ]; rw [ prod_inter_prod]; rw [ inter_univ]; rw [ univ_inter]
...
begin
 ...
 rw [← real.Union_Iic_rat]; rw [ prod_Union],
...
begin
 ...
 rw [← h_empty]; rw [ ← real.Inter_Iic_rat]; rw [ prod_Inter],
...
begin
 ...
 rw [this]; rw [ ← set_lintegral_with_density_eq_set_lintegral_mul _ measurable_pre_cdf _ hs],
...
begin
 ...
 rw [set_lintegral_pre_cdf_fst ρ r hs]; rw [ set_lintegral_pre_cdf_fst ρ r' hs],
...
begin
 ...
 { intros q,
 rw [coe_coe]; rw [ ← set_lintegral_pre_cdf_fst ρ _ hs],
...
begin
 ...
 { ext1 r,
 rw [← set_lintegral_univ]; rw [ set_lintegral_pre_cdf_fst ρ _ measurable_set.univ], },
...
begin
 ...
 { ext1 n,
 rw [← set_lintegral_univ]; rw [ set_lintegral_pre_cdf_fst ρ _ measurable_set.univ]; rw [ measure.Iic_snd_univ],
 norm_cast, },
 rw h_lintegral_eq,
 have h_zero_eq_measure_Inter : (0 : ℝ≥0∞) = ρ (⋂ r : ℚ, univ ×ˢ Iic (-r)),
 { suffices : (⋂ r : ℚ, Iic (-(r : ℝ))) = ∅,
 { rwa [← prod_Inter]; rwa [ this]; rwa [ prod_empty]; rwa [ measure_empty], },
 ext1 x,
 simp only [mem_Inter, mem_Iic, mem_empty_iff_false, iff_false, not_forall, not_le],
 simp_rw neg_lt,
...
begin
 ...
 intros s hs hs_fin,
 rw [set_lintegral_infi_gt_pre_cdf ρ t hs]; rw [ set_lintegral_pre_cdf_fst ρ t hs],
end
...
lemma has_cond_cdf_of_mem_cond_cdf_set {ρ : measure (α × ℝ)} {a : α} (h : a ∈ cond_cdf_set ρ) :
 has_cond_cdf ρ a :=
begin
 rw [cond_cdf_set] at h; rw [ mem_compl_iff] at h,
...
begin
 unfold cond_cdf_rat,
 split_ifs with h,
 { rw [← ennreal.zero_to_real]; rw [ ennreal.tendsto_to_real_iff],
 ...
 rw [eventually_eq]; rw [ eventually_at_bot],
...
begin
 ...
 split_ifs with h,
 { have h' := has_cond_cdf_of_mem_cond_cdf_set h,
 rw [← ennreal.one_to_real]; rw [ ennreal.tendsto_to_real_iff],
...
begin
 ...
 rw [ha]; rw [ ennreal.of_real_to_real],
...
begin
 rw [← inf_gt_cond_cdf_rat ρ a r]; rw [ cond_cdf'],
...
begin
 ...
 rw [h']; rw [ h'']; rw [ continuous_within_at],
 congr,
 exact cond_cdf'_def,
end
...
begin
 ...
 rw [function.comp_apply]; rw [ ← cond_cdf_eq_cond_cdf_rat],
...
begin
 ...
 rw ← stieltjes_function.infi_rat_gt_eq,
 congr' with q,
 rw [coe_coe]; rw [ cond_cdf_eq_cond_cdf_rat], },
 rw this,
...
begin
 ...
 rw [set_lintegral_congr_fun hs this]; rw [ set_lintegral_pre_cdf_fst ρ r hs],
...
begin
 ...
 { rw [hρ_zero]; rw [ lintegral_zero_measure],
...
by rw [← set_lintegral_univ]; rw [ set_lintegral_cond_cdf ρ _ measurable_set.univ]
...
begin
 ...
 { rw [← h]; rw [ ennreal.to_real_of_real],
...
by rw [← set_integral_cond_cdf ρ _ measurable_set.univ]; rw [ measure.restrict_univ]
...
begin
 rw [← ennreal.of_real_one]; rw [ ← sub_zero (1 : ℝ)],
...
begin
 ...
 { ext1 a,
 rw [measure_compl ht (measure_ne_top (cond_cdf ρ a).measure _)]; rw [ pi.sub_apply], },
