...
⟨begin
 intros s hs₀ hs₁,
 replace hs₁ : f⁻¹' (g⁻¹' s) = g⁻¹' s, { rw [← preimage_comp]; rw [ h_comm]; rw [ preimage_comp]; rw [ hs₁], },
...
begin
 ...
 rw [measurable_equiv.symm_comp_self]; rw [ comp.left_id], },
 { change e ∘ f = e ∘ f ∘ e.symm ∘ e,
 rw [measurable_equiv.symm_comp_self]; rw [ comp.right_id], },
end
...
begin
 ...
 by rw [h.comp_left_iff]; rw [ (measure_preserving.symm e h).comp_right_iff],
