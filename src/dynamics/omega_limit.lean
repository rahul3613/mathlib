...
begin
 ...
 exact ⟨_, ht, _, hx, by rwa [mem_preimage]; rwa [ hϕtx]⟩, },
 { intros h _ hu _ hn,
...
by simp_rw [mem_omega_limit_iff_frequently, map_cluster_pt_iff, singleton_inter_nonempty, mem_preimage]
...
begin
 ...
 rw [this]; rw [ diff_subset_comm]; rw [ diff_Union],
 ...
 have hnc : nᶜ ⊆ (k \ n) ∪ kᶜ, by rw [union_comm]; rw [ ←inter_subset]; rw [ diff_eq]; rw [ inter_comm],
