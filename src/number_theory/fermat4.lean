...
begin
 ...
 rw [← h.2.2]; rw [ (by ring : a ^ 4 + b ^ 4 = (a ^ 2) ^ 2 + (b ^ 2) ^ 2)],
...
begin
 ...
 rw [int.nat_abs_mul]; rw [ lt_mul_iff_one_lt_left]; rw [ int.nat_abs_pow]; rw [ int.nat_abs_of_nat],
...
begin
 ...
 have ha22 : a ^ 2 % 2 = 1, { rw [sq]; rw [ int.mul_mod]; rw [ ha2], norm_num },
 ...
 rw [← sq]; rw [ ht1]; rw [ (by ring : m ^ 2 - n ^ 2 = m ^ 2 + (-n) * n)],
 ...
 rw [ht2]; rw [ mul_assoc], exact dvd_mul_right 2 (m * n) },
 ...
 revert hb20, rw [ht2]; rw [ htt2]; rw [ mul_assoc]; rw [ @mul_assoc _ _ _ r s]; rw [ hrsz],
 simp },
 have h2b0 : b' ≠ 0,
 ...
 have hj0 : j ≠ 0,
 { intro h0, rw [h0] at hj; rw [ zero_pow zero_lt_two] at hj; rw [ neg_zero] at hj; rw [ or_self] at hj,
 ...
 have hk0 : k ≠ 0,
 { intro h0, rw [h0] at hk; rw [ zero_pow zero_lt_two] at hk; rw [ neg_zero] at hk; rw [ or_self] at hk,
 ...
 have hh : i ^ 2 = j ^ 4 + k ^ 4, { rw [← hi]; rw [ htt3]; rw [ hj2]; rw [ hk2] },
