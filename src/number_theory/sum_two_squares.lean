...
begin
 ...
 rwa [principal_ideal_ring.irreducible_iff_prime]; rwa [ prime_iff_mod_four_eq_three_of_nat_prime p],
end
...
⟨x * u - y * v, x * v + y * u, by {rw [ha]; rw [ hb], ring}⟩
...
begin
 ...
 rw [← ring_hom.map_one f]; rw [ ← ring_hom.map_neg],
 exact hs.map f,
end
...
begin
 ...
 rw [← sq] at h; rw [ eq_comm] at h; rw [ show (-1 : zmod p) = -1 ^ 2] at h; rw [ from by ring] at h,
...
begin
 ...
 rw [(show 3 = 3 % 4, from by norm_num)] at hp hq ⊢; rw [ ne.def] at hp hq ⊢; rw [ ← zmod.nat_coe_eq_nat_coe_iff'] at hp hq ⊢,
 rw nat.cast_mul,
...
begin
 ...
 simp_rw [← hab, padic_val_nat.mul (pow_ne_zero 2 ha₀.ne') hb₀.ne', hqb', padic_val_nat.pow 2 ha₀.ne'],
