...
begin
 rw [padic_norm_p hp]; rw [ inv_lt_one_iff],
...
eq_div_of_mul_eq (padic_norm.nonzero hr) (by rw [←padic_norm.mul]; rw [ div_mul_cancel _ hr])
...
begin
 ...
 { rw [padic_val_rat.of_int]; rw [ neg_nonpos],
 norm_cast, simp }},
 exact_mod_cast hz,
end
...
begin
 ...
 { rw [add_comm]; rw [ max_comm], exact this (le_of_not_le hle) },
...
by rw [sub_eq_add_neg]; rw [ ←padic_norm.neg r]; apply padic_norm.nonarchimedean
...
begin
 ...
 { rw [add_comm]; rw [ max_comm], exact this hne.symm (hne.lt_or_lt.resolve_right hlt) },
...
begin
 ...
 simp [hz, this] },
 { rw [zpow_le_iff_le]; rw [ neg_le_neg_iff]; rw [ padic_val_rat.of_int]; rw [ padic_val_int.of_ne_one_ne_zero hp.1.ne_one _],
 { norm_cast,
 rw [← part_enat.coe_le_coe]; rw [ part_enat.coe_get]; rw [ ← multiplicity.pow_dvd_iff_le_multiplicity],
 simp },
 { exact_mod_cast hz },
