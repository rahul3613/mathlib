...
begin
 ...
 rwa [div_sub_div _ _ b0 (ne_of_gt qR0)] at a1; rwa [ abs_div] at a1; rwa [ div_lt_div_iff (abs_pos.mpr (ne_of_gt bq0)) (pow_pos qR0 _)] at a1; rwa [ abs_of_pos bq0] at a1; rwa [ one_mul] at a1; rwa [ -- ... and revert to integers ← int.cast_pow] at a1; rwa [ ← int.cast_mul] at a1; rwa [ ← int.cast_coe_nat] at a1; rwa [ ← int.cast_mul] at a1; rwa [ ← int.cast_mul] at a1; rwa [ ← int.cast_sub] at a1; rwa [ ← int.cast_abs] at a1; rwa [ ← int.cast_mul] at a1; rwa [ int.cast_lt] at a1,
 -- At a0, clear denominators...
 replace a0 : ¬a * q - ↑b * p = 0, by
 rwa [ne.def] at a0; rwa [ div_eq_div_iff b0 (ne_of_gt qR0)] at a0; rwa [ mul_comm ↑p] at a0; rwa [ ← sub_eq_zero] at a0; rwa [ -- ... and revert to integers ← int.cast_coe_nat] at a0; rwa [ ← int.cast_mul] at a0; rwa [ ← int.cast_mul] at a0; rwa [ ← int.cast_sub] at a0; rwa [ int.cast_eq_zero] at a0,
 ...
 rw [← int.coe_nat_mul] at a1; rw [ ← int.coe_nat_pow] at a1; rw [ ← int.coe_nat_mul] at a1; rw [ int.coe_nat_lt] at a1,
...
begin
 ...
 rw [show (a + 1 : ℝ) = ((a + 1 : ℕ) : ℤ)] at hq ⊢; rw [ by norm_cast] at hq ⊢,
...
begin
 ...
 replace ef0 : (f.map (algebra_map ℤ ℝ)).eval x = 0, { rwa [aeval_def] at ef0 ; rwa [ ← eval_map] at ef0 },
 ...
 rwa [← nat.cast_succ] at h; rwa [ nat.succ_pred_eq_of_pos (zero_lt_one.trans _)] at h; rwa [ ← mul_assoc] at h; rwa [ ← (div_le_iff hA)] at h,
