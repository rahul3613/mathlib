...
begin
 ...
 right,
 rw [complex.log_im]; rw [ ← complex.of_real_nat_cast],
...
begin
 rw [← l_series_summable_iff_of_re_eq_re (complex.of_real_re z.re)]; rw [ l_series_summable]; rw [ ← summable_norm_iff]; rw [ ← real.summable_one_div_nat_rpow]; rw [ iff_iff_eq],
 by_cases h0 : z.re = 0,
 { rw [h0]; rw [ ← summable_nat_add_iff 1],
 swap, { apply_instance },
 apply congr rfl,
 ext n,
 simp [n.succ_ne_zero] },
