...
begin
 rw [ideal.minimal_primes]; rw [ ideal.minimal_primes],
 congr,
 ext p,
...
begin
 ...
 infer_instance, _⟩,
 rw [ideal.comap_comap]; rw [ ← @@is_localization.map_comp _ _ _ _ localization.is_localization _ p.prime_compl.le_comap_map _ localization.is_localization]; rw [ ← ideal.comap_comap],
 suffices : _ ≤ p,
...
begin
 ...
 { rw [ideal.mk_ker]; rw [ e], exact H.1.2 },
 ...
 rwa [ideal.comap_map_of_surjective (I^.quotient.mk^.comp f).ker^.quotient.mk ideal.quotient.mk_surjective]; rwa [ eq_comm]; rwa [ sup_eq_left] },
 refine ⟨⟨_, bot_le⟩, _⟩,
...
begin
 ...
 rw [← sup_eq_left.mpr this]; rw [ ring_hom.ker_eq_comap_bot]; rw [ ← ideal.comap_map_of_surjective f hf],
...
begin
 rw [minimal_primes]; rw [ ← ideal.comap_minimal_primes_eq_of_surjective ideal.quotient.mk_surjective]; rw [ ← ring_hom.ker_eq_comap_bot]; rw [ ideal.mk_ker],
end
