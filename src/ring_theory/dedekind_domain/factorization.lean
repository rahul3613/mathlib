...
begin
 rw [← set.finite_coe_iff]; rw [ set.coe_set_of],
...
begin
 ...
 { rw [is_dedekind_domain.height_one_spectrum.max_pow_dividing]; rw [ int.coe_nat_eq_zero.mp h_zero]; rw [ pow_zero _] },
 exact hv hv', },
...
begin
 rw mul_support,
 simp_rw [ne.def, zpow_coe_nat, ← fractional_ideal.coe_ideal_pow, fractional_ideal.coe_ideal_eq_one],
...
begin
 ...
 rw [← associates.mk_dvd_mk] at h_dvd h_not_dvd; rw [ associates.dvd_eq_le] at h_dvd h_not_dvd; rw [ associates.mk_pow] at h_dvd h_not_dvd; rw [ associates.prime_pow_dvd_iff_le h_ne_zero hv] at h_dvd h_not_dvd,
...
begin
 ...
 simp_rw [is_dedekind_domain.height_one_spectrum.max_pow_dividing, fractional_ideal.coe_ideal_pow, zpow_coe_nat],
end
