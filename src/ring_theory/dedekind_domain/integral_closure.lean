...
begin
 ...
 { rintros ⟨_, x, hx, rfl⟩,
 rw [is_unit_iff_ne_zero]; rw [ map_ne_zero_iff _ (is_integral_closure.algebra_map_injective C A L)]; rw [ subtype.coe_mk]; rw [ map_ne_zero_iff _ (no_zero_smul_divisors.algebra_map_injective A C)],
 ...
 rw [subtype.coe_mk]; rw [ ← is_scalar_tower.algebra_map_apply]; rw [ hx]; rw [ mul_comm]; rw [ submonoid.smul_def]; rw [ smul_def], },
 ...
 rw [subtype.coe_mk]; rw [ map_ne_zero_iff _ (no_zero_smul_divisors.algebra_map_injective A C)],
...
begin
 ...
 { rw [mul_smul]; rw [ algebra.smul_def]; rw [ algebra.smul_def]; rw [ mul_comm _ x'']; rw [ hx'],
 exact is_integral_mul is_integral_algebra_map x'.2 },
 { rw [mul_comm]; rw [ mul_smul]; rw [ algebra.smul_def],
...
begin
 ...
 rw [linear_map.ker_comp]; rw [ submodule.ker_of_le]; rw [ submodule.comap_bot]; rw [ linear_map.ker_cod_restrict],
...
begin
 ...
 rw [finite_dimensional.finrank_eq_card_choose_basis_index]; rw [ finite_dimensional.finrank_eq_card_basis b],
end
