...
begin
 ...
 rwa [ideal.quotient.lift_mk] at hp; rwa [ ← mem_vanishing_ideal_singleton_iff] at hp; rwa [ ← quotient.eq_zero_iff_mem] at hp,
 end,
 rw [← bot_quotient_is_maximal_iff]; rw [ ring_equiv.bot_maximal_iff this],
...
begin
 ...
 intros p hp,
 rw [← quotient.eq_zero_iff_mem]; rw [ map_mv_polynomial_eq_eval₂ (ideal.quotient.mk I) p]; rw [ eval₂_eq'],
 rw [mem_vanishing_ideal_singleton_iff] at hp; rw [ eval_eq'] at hp,
...
begin
 ...
 rw [← mem_vanishing_ideal_singleton_iff]; rw [ set.mem_singleton_iff.1 hy]; rw [ ← hx],
 refine hJI hp },
