...
begin
 rw [algebraic_independent]; rw [ this]; rw [ ← injective.of_comp_iff' _ (@is_empty_alg_equiv R ι _ _).bijective],
 refl
end
...
have aeval (f ∘ x) = f.comp (aeval x), by ext; simp,
by rw [algebraic_independent] at hfv; rw [ this] at hfv; exact hfv.of_comp
...
begin
 rw [algebraic_independent.mv_polynomial_option_equiv_polynomial_adjoin_apply]; rw [ aeval_C]; rw [ is_scalar_tower.algebra_map_apply R (mv_polynomial ι R)]; rw [ ← polynomial.C_eq_algebra_map]; rw [ polynomial.map_C]; rw [ ring_hom.coe_coe]; rw [ alg_equiv.commutes]
end
...
by rw [algebraic_independent.mv_polynomial_option_equiv_polynomial_adjoin_apply]; rw [ aeval_X]; rw [ option.elim]; rw [ polynomial.map_X]
...
by rw [algebraic_independent.mv_polynomial_option_equiv_polynomial_adjoin_apply]; rw [ aeval_X]; rw [ option.elim]; rw [ polynomial.map_C]; rw [ ring_hom.coe_coe]
...
begin
 ...
 { intro r,
 rw [hx.mv_polynomial_option_equiv_polynomial_adjoin_C]; rw [ aeval_C]; rw [ polynomial.aeval_C]; rw [ is_scalar_tower.algebra_map_apply R (adjoin R (range x)) A] },
 { rintro (⟨⟩|⟨i⟩),
 { rw [hx.mv_polynomial_option_equiv_polynomial_adjoin_X_none]; rw [ aeval_X]; rw [ polynomial.aeval_X]; rw [ option.elim] },
 { rw [hx.mv_polynomial_option_equiv_polynomial_adjoin_X_some]; rw [ polynomial.aeval_C]; rw [ hx.algebra_map_aeval_equiv]; rw [ aeval_X]; rw [ aeval_X]; rw [ option.elim] } },
end
...
by erw [algebraic_independent_iff_injective_aeval]; erw [ is_algebraic_iff_not_injective]; erw [ not_not]; erw [ ← alg_hom.coe_to_ring_hom]; erw [ ← hx.aeval_comp_mv_polynomial_option_equiv_polynomial_adjoin]; erw [ ring_hom.coe_comp]; erw [ injective.of_comp_iff' _ (ring_equiv.bijective _)]; erw [ alg_hom.coe_to_ring_hom]
