...
{ carrier := set_of is_symmetric,
 ...
 mul_mem' := λ a b ha hb e, by rw [alg_hom.map_mul]; rw [ ha]; rw [ hb],
 add_mem' := λ a b ha hb e, by rw [alg_hom.map_add]; rw [ ha]; rw [ hb] }
...
begin
 ...
 rw [finsupp.support_sum_eq_bUnion] at this; rw [ finsupp.support_sum_eq_bUnion] at this,
...
begin
 ...
 rw [degrees_def]; rw [ support_esymm]; rw [ sup_image]; rw [ this]; rw [ ←comp_sup_eq_sup_comp],
