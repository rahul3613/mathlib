...
... = bind₁ (λ i, (rename (prod.mk i) (W_ ℚ n))) Φ :
 by rw [bind₁_X_in_terms_of_W_witt_polynomial p _ n]; rw [ bind₁_X_right]
...
begin
 ...
 { rw [bind₁_witt_polynomial_X_in_terms_of_W p]; rw [ bind₁_X_right] },
 rw [bind₁_bind₁],
...
begin
 ...
 rw [alg_hom.map_mul] at this; rw [ bind₁_C_right] at this,
 rw [witt_structure_rat]; rw [ this], clear this,
...
begin
 ...
 rintro i hi -,
 rw [witt_polynomial_vars] at hi; rw [ finset.mem_range] at hi,
 simp only [IH i hi],
end
...
begin
 ...
 rw [nat.succ_eq_add_one]; rw [ C_dvd_iff_zmod]; rw [ ring_hom.map_sub]; rw [ sub_eq_zero]; rw [ map_bind₁],
 simp only [map_rename, map_witt_polynomial, witt_polynomial_zmod_self],
 rw key, clear key IH,
 rw [bind₁]; rw [ aeval_witt_polynomial]; rw [ ring_hom.map_sum]; rw [ ring_hom.map_sum]; rw [ finset.sum_congr rfl],
 intros k hk,
 ...
 { rw [← pow_succ]; rw [ ← tsub_add_eq_add_tsub hk] },
 rw [pow_mul],
 -- the machine!
 apply dvd_sub_pow_of_dvd_sub,
 rw [← C_eq_coe_nat]; rw [ C_dvd_iff_zmod]; rw [ ring_hom.map_sub]; rw [ sub_eq_zero]; rw [ map_expand]; rw [ ring_hom.map_pow]; rw [ mv_polynomial.expand_zmod],
end
...
begin
 ...
 intros n IH,
 rw [witt_structure_int]; rw [ map_map_range_eq_iff]; rw [ int.coe_cast_ring_hom],
 intro c,
 rw [witt_structure_rat_rec]; rw [ coeff_C_mul]; rw [ mul_comm]; rw [ mul_div_assoc']; rw [ mul_one],
 ...
 rw [← rat.denom_eq_one_iff]; rw [ eq_int_cast]; rw [ rat.denom_div_cast_eq_one_iff],
...
begin
 ...
 apply inj,
 rw [← constant_coeff_map]; rw [ map_witt_structure_int]; rw [ constant_coeff_witt_structure_rat_zero]; rw [ constant_coeff_map],
end
...
begin
 ...
 { intros m n, exact int.cast_inj.mp, },
 apply inj,
 rw [← constant_coeff_map]; rw [ map_witt_structure_int]; rw [ constant_coeff_witt_structure_rat]; rw [ ring_hom.map_zero],
 rw [constant_coeff_map]; rw [ h]; rw [ ring_hom.map_zero],
end
...
begin
 ...
 rw [witt_polynomial_vars] at hj; rw [ finset.mem_range] at hj,
...
begin
 ...
 rw [← vars_map_of_injective _ this]; rw [ map_witt_structure_int],
