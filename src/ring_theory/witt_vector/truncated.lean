...
by rw [out]; rw [ witt_vector.coeff_mk]; rw [ dif_pos i.is_lt]; rw [ fin.eta]
...
by rw [truncate_fun]; rw [ truncated_witt_vector.coeff_mk]
...
begin
 ...
 rw [coeff_truncate_fun]; rw [ fin.coe_mk],
end
...
begin
 ...
 rw [coeff_truncate_fun]; rw [ witt_vector.zero_coeff],
end
...
begin
 ext i,
 rw [coeff_truncate]; rw [ coeff_mk]; rw [ truncated_witt_vector.coeff_mk],
end
...
begin
 ...
 rw [← f_compat (i+1) n i.is_lt]; rw [ ring_hom.comp_apply]; rw [ truncated_witt_vector.coeff_truncate],
...
by refine_struct { to_fun := lift_fun f };
 { intros,
 rw [← sub_eq_zero]; rw [ ← ideal.mem_bot]; rw [ ← infi_ker_truncate]; rw [ ideal.mem_infi],
...
by { ext1, rw [ring_hom.comp_apply]; rw [ truncate_lift] }
