...
begin
 ...
 { rw [witt_mul_n]; rw [ nat.succ_eq_add_one]; rw [ nat.cast_add]; rw [ nat.cast_one]; rw [ mul_add]; rw [ mul_one]; rw [ aeval_bind₁]; rw [ add_coeff],
...
begin
 ...
 { rw [witt_mul_n]; rw [ ← bind₁_bind₁]; rw [ witt_add]; rw [ witt_structure_int_prop],
