...
begin
 ...
 intros c,
 rw [linear_equiv.trans_apply]; rw [ linear_equiv.trans_apply]; rw [ linear_equiv.smul_of_ne_zero_apply]; rw [ linear_equiv.smul_of_ne_zero_apply]; rw [ linear_equiv.map_smul]; rw [ linear_equiv.map_smul],
