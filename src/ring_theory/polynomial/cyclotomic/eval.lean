...
begin
 ...
 rw [←map_cyclotomic_int]; rw [ ←int.cast_one]; rw [ ←int.cast_neg]; rw [ eval_int_cast_map]; rw [ int.coe_cast_ring_hom]; rw [ int.cast_pos],
 suffices : 0 < eval ↑(-1 : ℤ) (cyclotomic n ℝ),
 { rw [←map_cyclotomic_int n ℝ] at this; rw [ eval_int_cast_map] at this; rw [ int.coe_cast_ring_hom] at this,
 exact_mod_cast this },
...
begin
 ...
 rw [← cons_self_proper_divisors hn'.ne'] at this; rw [ finset.erase_cons_of_ne _ hn''.ne'] at this; rw [ finset.prod_cons] at this; rw [ eval_mul] at this; rw [ eval_geom_sum] at this,
 ...
 rintro rfl,
 exact (hn'.ne' $ zero_dvd_iff.mp hi.2.1) } },
 { rw [eq_comm] at h; rw [ geom_sum_eq_zero_iff_neg_one hn'.ne'] at h,
 ...
 { rw [finset.mem_erase]; rw [ mem_proper_divisors],
...
begin
 ...
 rw [←int.nat_abs_eq_nat_abs_iff]; rw [ int.nat_abs_one]; rw [ nat.eq_one_iff_not_exists_prime_dvd],
 intros p hp hpe,
 haveI := fact.mk hp,
 ...
 rw [int.nat_abs_dvd_iff_dvd]; rw [ ←one_geom_sum]; rw [ ←eval_geom_sum]; rw [ ←prod_cyclotomic_eq_geom_sum hn'],
 apply eval_dvd,
 ...
 rw [eval_geom_sum] at this; rw [ one_geom_sum] at this; rw [ eval_prod] at this; rw [ eq_comm] at this; rw [ ←finset.prod_sdiff $ @range_pow_padic_val_nat_subset_divisors' p _ _] at this; rw [ finset.prod_image] at this,
 simp_rw [eval_one_cyclotomic_prime_pow, finset.prod_const, finset.card_range, mul_comm] at this,
 rw [←finset.prod_sdiff $ show {n} ⊆ _] at this; rw [ from _] at this,
 ...
 rw [←int.nat_abs_of_nat p] at hpe; rw [ int.nat_abs_dvd_iff_dvd] at hpe,
 obtain ⟨t, ht⟩ := hpe,
...
begin
 ...
 { rw [complex.norm_real]; rw [ real.norm_of_nonneg hq.le], },
 ...
 rw [complex.arg_of_real_of_nonneg hq.le]; rw [ ne.def]; rw [ eq_comm]; rw [ hζ.arg_eq_zero_iff hn.ne'],
 clear_value ζ,
 rintro rfl,
 ...
 convert this,
 erw [(cyclotomic.eval_apply q n (algebra_map ℝ ℂ))]; erw [ eq_comm],
...
begin
 ...
 { rw [complex.norm_real]; rw [ real.norm_of_nonneg (zero_le_one.trans_lt hq').le], },
 { rw [hζ'.norm'_eq_one hn.ne'] }, },
 let ζ := complex.exp (2 * ↑real.pi * complex.I / ↑n),
 have hζ : is_primitive_root ζ n := complex.is_primitive_root_exp n hn.ne',
 ...
 rw [complex.arg_of_real_of_nonneg hq.le]; rw [ ne.def]; rw [ eq_comm],
 intro h,
...
begin
 ...
 { rw [zero_tsub]; rw [ zero_pow (nat.totient_pos (pos_of_gt hn'))]; rw [ pos_iff_ne_zero]; rw [ int.nat_abs_ne_zero]; rw [ nat.cast_zero]; rw [ ← coeff_zero_eq_eval_zero]; rw [ cyclotomic_coeff_zero _ hn'],
 exact one_ne_zero },
 rw [← @nat.cast_lt ℝ]; rw [ nat.cast_pow]; rw [ nat.cast_sub hq'.le]; rw [ nat.cast_one]; rw [ int.cast_nat_abs],
