...
by rw [C_mul_X_pow_eq_monomial]; rw [ op_ring_equiv_symm_monomial]; rw [ ← C_mul_X_pow_eq_monomial]
...
by rw [leading_coeff]; rw [ coeff_op_ring_equiv]; rw [ nat_degree_op_ring_equiv]; rw [ leading_coeff]
