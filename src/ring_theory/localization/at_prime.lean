...
begin
 rw [←(algebra_map R S).map_one] at hze; rw [ ←(algebra_map R S).map_zero] at hze,
...
begin
 ...
 rw [←hrx] at hxyz; rw [ ←hry] at hxyz; rw [ ←hrz] at hxyz; rw [ ←mk'_add] at hxyz; rw [ ←mk'_mul] at hxyz; rw [ ←mk'_self S I.prime_compl.one_mem] at hxyz,
...
@[simp] lemma local_ring_hom_comp {S : Type*} [comm_semiring S]
 ...
 local_ring_hom I K (g.comp f) (by rw [hIJ]; rw [ hJK]; rw [ ideal.comap_comap f g]) =
