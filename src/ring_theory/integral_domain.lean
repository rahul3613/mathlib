...
begin
 ...
 { intros g hg,
 rw [sep_def] at hg; rw [ mem_filter] at hg,
 rw [multiset.mem_to_finset]; rw [ mem_nth_roots hn]; rw [ ← f.map_pow]; rw [ hg.2] },
...
begin
 ...
 field_simp [hg'],
 norm_cast,
 rw [add_comm]; rw [ mul_comm]; rw [ mod_by_monic_add_div f hg] },
end
...
begin
 ...
 rwa [subtype.ext_iff] at hn; rwa [ units.ext_iff] at hn; rwa [ subtype.coe_mk] at hn; rwa [ monoid_hom.coe_to_hom_units] at hn; rwa [ one_pow] at hn; rwa [ eq_comm] at hn, },
 replace hx1 : (x : R) - 1 ≠ 0,
 ...
 by rw [← pow_eq_mod_order_of]; rw [ hn]⟩)
 ... = 0 : _,
 rw [← mul_left_inj' hx1]; rw [ zero_mul]; rw [ geom_sum_mul]; rw [ coe_coe],
 norm_cast,
