...
begin
 ...
 intro h',
 wlog vyx : v y < v x,
 { refine this v h.symm _ (h.lt_or_lt.resolve_right vyx), rwa [add_comm]; rwa [ max_comm] },
...
{ carrier := {x | v x < γ},
 ...
 neg_mem' := λ x x_in, by rwa [set.mem_set_of_eq]; rwa [ map_neg] }
...
begin
 ...
 rwa [v₁.map_zero] at this; rwa [ v₂.map_zero] at this,
end
...
begin
 ...
 iterate 2 {rw [v.map_mul _ y]; rw [ v'.map_mul _ y]},
...
ideal.ext $ λ x,
begin
 rw [mem_supp_iff]; rw [ ideal.mem_comap]; rw [ mem_supp_iff],
 refl,
end
