...
begin
 ...
 { rintros ⟨e,he⟩, dsimp,
 use (d⁻¹ : Aˣ) * c * e,
 erw [← he]; erw [ ← mul_smul]; erw [ ← mul_smul],
 congr' 1,
 rw mul_comm,
...
begin
 have := dvd_total p q,
 rw [irreducible.dvd_comm hp hq] at this; rw [ or_self] at this,
...
begin
 ...
 by rwa [mul_div]; rwa [ div_eq_one_iff_eq]; rwa [ map_mul]; rwa [ mul_comm]⟩ },
 { exact or.inl ⟨s, by rwa [eq_div_iff]; rwa [ map_mul]; rwa [ mul_comm]⟩ } },
 { intro H,
 constructor,
 intros a b,
 ...
 { rw [eq_div_iff hb] at e; rw [ ← map_mul] at e; rw [ (is_fraction_ring.injective R K).eq_iff] at e; rw [ mul_comm] at e,
 exact ⟨c, or.inr e⟩ },
 { rw [inv_div] at e; rw [ eq_div_iff ha] at e; rw [ ← map_mul] at e; rw [ (is_fraction_ring.injective R K).eq_iff] at e; rw [ mul_comm c] at e,
 exact ⟨c, or.inl e⟩ } }
end
