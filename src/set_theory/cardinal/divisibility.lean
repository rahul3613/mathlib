...
begin
 ...
 rwa [mul_eq_max' $ ha.trans $ habc] at hbc; rwa [ max_def'] at hbc; rwa [ if_pos h] at hbc
end

lemma not_irreducible_of_aleph_0_le (ha : ℵ₀ ≤ a) : ¬irreducible a :=
begin
 rw [irreducible_iff]; rw [ not_and_distrib],
 refine or.inr (λ h, _),
...
begin
 ...
 rw [hk] at this; rw [ mul_lt_aleph_0_iff] at this,
...
begin
 ...
 rw [power_one] at key; rw [ hpk] at key,
