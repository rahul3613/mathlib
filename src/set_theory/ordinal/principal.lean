...
begin
 ...
 { rwa [lt_one_iff_zero] at * ; rwa [ ha] at * ; rwa [ hb] at * }
end
...
begin
 ...
 rw [←is_normal.bsup_eq.{u u} H ho']; rw [ bsup_le_iff],
...
begin
 ...
 rwa [←add_one_eq_succ]; rwa [ add_le_add_iff_left]; rwa [ one_le_iff_ne_zero] } }
end
...
begin
 ...
 { rwa [nat.cast_succ]; rwa [ add_assoc]; rwa [ one_add_of_omega_le (le_refl _)] }
end
...
begin
 ...
 { rw [opow_zero] at h; rw [ ← succ_zero] at h; rw [ lt_succ_iff] at h; rw [ ordinal.le_zero] at h,
 rw [h]; rw [ zero_add] },
 { rw opow_succ at h,
...
begin
 ...
 rw [opow_succ] at this; rw [ lt_mul_of_limit omega_is_limit] at this,
...
by rw [← ordinal.add_sub_cancel_of_le h₂]; rw [ ← add_assoc]; rw [ add_omega_opow h₁]
...
begin
 ...
 { rw mul_zero,
 exact principal_zero },
 { rw [← succ_le_iff] at hb₁'; rw [ succ_zero] at hb₁',
 intros c d hc hd,
...
begin
 ...
 { rwa [←succ_le_iff] at ha₀ ; rwa [ succ_zero] at ha₀ } },
...
begin
 by_cases b0 : b = 0, {rw [b0] at h ⊢; rw [ opow_zero] at h ⊢; rw [ opow_one] at h ⊢, exact mul_omega a0 h},
...
λ x y hx hy, begin
 ...
 rwa [←opow_add] at this; rwa [ opow_lt_opow_iff_right hb] at this
end
...
| _ ⟨b, rfl⟩ := by rw [← mul_assoc]; rw [ mul_omega a0 ha]
...
begin
 ...
 rw [←is_normal.bsup_eq.{u u} (mul_is_normal (ordinal.pos_iff_ne_zero.2 ha)) hbl]; rw [ bsup_le_iff],
 intros c hcb,
