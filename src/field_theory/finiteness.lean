...
begin
 ...
 rw [← b.mk_eq_rank'']; rw [ lt_aleph_0_iff_set_finite],
 split,
 { introI,
 ...
 rw [set.finite.coe_to_finset]; rw [ ← b.span_eq]; rw [ basis.coe_of_vector_space]; rw [ subtype.range_coe] }
end
...
by rw [finset_basis]; rw [ basis.range_reindex]; rw [ basis.range_of_vector_space]
...
begin
 ...
 { rintros ⟨s, hs⟩,
 rw [is_noetherian.iff_rank_lt_aleph_0]; rw [ ← rank_top]; rw [ ← hs],
