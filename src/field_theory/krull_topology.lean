...
{ to_filter_basis := gal_basis K L,
 ...
 { rw [subgroup.mem_carrier] at hg; rw [ intermediate_field.mem_fixing_subgroup_iff F g] at hg,
 exact hg (σ⁻¹ x) h_in_F },
 rw h_g_fix,
 change σ (σ⁻¹ x) = x,
...
{ t2 := λ f g hfg,
 ...
 rw [alg_equiv.apply_symm_apply f (g x)]; rw [ ne_comm],
 exact hx },
