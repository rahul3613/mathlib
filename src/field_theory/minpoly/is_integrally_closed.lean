...
begin
 ...
 { rw [aeval_map_algebra_map]; rw [ aeval_algebra_map_apply]; rw [ aeval]; rw [ map_zero] },
...
begin
 ...
 { rw [map_mod_by_monic _ (minpoly.monic hs)]; rw [ mod_by_monic_eq_sub_mul_div],
 ...
 rw [is_integrally_closed_eq_field_fractions _ _ hs] at this; rw [ map_dvd_map (algebra_map R K) (is_fraction_ring.injective R K) (minpoly.monic hs)] at this,
...
by ext p ; simp_rw [ring_hom.mem_ker, alg_hom.to_ring_hom_eq_coe, alg_hom.coe_to_ring_hom, is_integrally_closed_dvd_iff hs, ← ideal.mem_span_singleton]
...
begin
 rw [degree_eq_nat_degree (minpoly.ne_zero hs)]; rw [ degree_eq_nat_degree hp0],
 norm_cast,
...
begin
 ...
 { rw [(monic hs).leading_coeff]; rw [ hmo.leading_coeff] }
end
...
begin
 ...
 rw [← hP] at hP₁; rw [ minpoly.to_adjoin_apply'] at hP₁; rw [ lift_hom_mk] at hP₁; rw [ ← subalgebra.coe_eq_zero] at hP₁; rw [ aeval_subalgebra_coe] at hP₁; rw [ set_like.coe_mk] at hP₁; rw [ is_integrally_closed_dvd_iff hx] at hP₁,
 obtain ⟨Q, hQ⟩ := hP₁,
 rw [← hP]; rw [ hQ]; rw [ ring_hom.map_mul]; rw [ mk_self]; rw [ zero_mul],
end
