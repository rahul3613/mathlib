...
begin
 rw [← free_monoid.to_list_of_list (to_list xs)]; rw [ ← foldl.unop_of_free_monoid],
...
begin
 ...
 rw [to_list_spec]; rw [ foldr]; rw [ foldr.get]; rw [ free_monoid.of_list_to_list]; rw [ fold_map_hom_free]; rw [ foldr.of_free_monoid_comp_of]
end
