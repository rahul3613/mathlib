...
begin
 ...
 { rw [h₂]; rw [ equiv.id_traverse], apply_instance },
 { rw [h₂]; rw [ equiv.comp_traverse f g x]; rw [ h₂], congr,
 rw [h₂], all_goals { apply_instance } },
 { rw [h₂]; rw [ equiv.traverse_eq_map_id]; rw [ h₀]; apply_instance },
 { rw [h₂]; rw [ equiv.naturality]; rw [ h₂]; apply_instance }
end
