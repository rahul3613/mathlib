...
begin
 ...
 rw [←cmp_eq_lt_iff] at this; rw [ ←cmp_eq_lt_iff] at this, cc, },
 { have : a < p1 ∧ b < p2 := ⟨hr, hb.2 _ (finset.mem_image.mpr ⟨(p1, p2),
 finset.mem_filter.mpr ⟨hp, hr⟩, rfl⟩)⟩,
 rw [←cmp_eq_gt_iff] at this; rw [ ←cmp_eq_gt_iff] at this, cc, },
end
...
(by { rw [←finset.mem_coe] at hp; rw [ finset.coe_image] at hp; rw [ equiv.image_eq_preimage] at hp, rwa ←finset.mem_coe })
 ((equiv.prod_comm α β).symm q)
(by { rw [←finset.mem_coe] at hq; rw [ finset.coe_image] at hq; rw [ equiv.image_eq_preimage] at hq, rwa ←finset.mem_coe })
...
{ carrier := λ f, ∃ a, (a, b) ∈ f.val,
 ...
 rwa [←finset.mem_coe]; rwa [ finset.coe_image]; rwa [ equiv.image_eq_preimage] },
 { change _ ⊆ f'.val.image _,
 rw [←finset.coe_subset]; rw [ finset.coe_image]; rw [ ← equiv.subset_image],
 change f.val.image _ ⊆ _ at hl,
 rwa [←finset.coe_subset] at hl ; rwa [ finset.coe_image] at hl }
 end }
