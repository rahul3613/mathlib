...
by { rw [acc_iff_no_decreasing_seq]; rw [ not_is_empty_iff], exact ⟨⟨f, k, rfl⟩⟩ }
...
by { rw [well_founded_iff_no_descending_seq]; rw [ not_is_empty_iff], exact ⟨f⟩ }
...
begin
 ...
 { rw [set.infinite_coe_iff] at hbad; rw [ set.infinite] at hbad; rw [ not_not] at hbad,
