...
begin
 ...
 rw [e.is_lub_preimage]; rw [ e.apply_symm_apply],
 exact h y
end
...
begin
 ...
 rw [← fa.surjective.image_preimage {x | g x ≤ fb y}]; rw [ preimage_set_of_eq],
...
begin
 ...
 rw [← range_comp] at this; rw [ ← (equiv.mul_right g).surjective.range_comp _] at this,
 simpa [(∘)] using this
end
