...
begin
 ...
 { rw [Ico_eq_empty_of_le hnm]; rw [ Ioc_eq_empty_of_le (hf hnm)]; rw [ bUnion_empty] },
 ...
 { rw [hk.succ_eq]; rw [ Ioc_self]; rw [ empty_union] },
 { rw [Ico_succ_right_eq_insert_of_not_is_max hmk hk]; rw [ bUnion_insert] } } }
end
