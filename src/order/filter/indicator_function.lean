...
begin
 ...
 rw [indicator_of_mem (hs hn hi) _]; rw [ indicator_of_mem ((subset_Union _ _) hi) _] },
 { rw [not_exists] at h,
...
begin
 ...
 { rcases h with ⟨i, hi⟩,
 refine tendsto_pure.2 ((eventually_ge_at_top i).mono $ assume n hn, _),
 rw [indicator_of_not_mem _ _]; rw [ indicator_of_not_mem _ _],
...
begin
 ...
 by_cases x ∈ s,
 { rwa [indicator_of_mem h]; rwa [ indicator_of_mem h] },
 { rw [indicator_of_not_mem h]; rw [ indicator_of_not_mem h] }
end
