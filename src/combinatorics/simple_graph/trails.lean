...
begin
 ...
 { rw [nat.even_add_one]; rw [ ih]; rw [ ← not_iff_not],
...
begin
 rw [is_trail_def]; rw [ list.nodup_iff_count_le_one],
 intro e,
...
begin
 ...
 rw [← multiset.coe_countp]; rw [ multiset.countp_eq_card_filter]; rw [ ← card_incidence_finset_eq_degree],
 change multiset.card _ = _,
 congr' 1,
 convert_to _ = (ht.is_trail.edges_finset.filter (has_mem.mem x)).val,
 rw [ht.edges_finset_eq]; rw [ G.incidence_finset_eq_filter x],
end
