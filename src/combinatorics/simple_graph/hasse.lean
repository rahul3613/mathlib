...
by { ext x y, simp_rw [box_prod_adj, hasse_adj, prod.covby_iff, or_and_distrib_right, @eq_comm _ y.1, @eq_comm _ y.2, or_or_or_comm] }
...
λ a b, begin
 rw [reachable_iff_refl_trans_gen]; rw [ ←refl_trans_gen_swap],
