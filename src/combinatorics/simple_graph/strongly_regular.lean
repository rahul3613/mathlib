...
begin
 ...
 rw [nat.sub_add_cancel]; rw [ ← set.to_finset_card],
...
begin
 ...
 { change (1 + 1) with 2,
 rw [card_compl]; rw [ h.card_neighbor_finset_union_of_not_adj hne ha.2]; rw [ ← h.card], },
...
begin
 ...
 rwa [← finset.compl_union]; rwa [ card_compl]; rwa [ h.card_neighbor_finset_union_of_adj]; rwa [ ← h.card],
end
