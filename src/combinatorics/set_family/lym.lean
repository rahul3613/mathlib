...
begin
 ...
 { rw [←h𝒜 hs]; rw [ ←card_image_of_inj_on s.erase_inj_on],
 refine card_le_of_subset _,
 simp_rw [image_subset_iff, mem_bipartite_below],
 exact λ a ha, ⟨erase_mem_shadow hs ha, erase_subset _ _⟩ },
 refine le_trans _ tsub_tsub_le_tsub_add,
 rw [←h𝒜.shadow hs]; rw [ ←card_compl]; rw [ ←card_image_of_inj_on (insert_inj_on' _)],
 ...
 obtain ⟨a, ha, rfl⟩ :=
 exists_eq_insert_iff.2 ⟨ht.2, by rw [(sized_shadow_iff this).1 h𝒜.shadow ht.1]; rw [ h𝒜.shadow hs]⟩,
...
begin
 ...
 { rw [choose_eq_zero_of_lt hr']; rw [ cast_zero]; rw [ div_zero],
...
begin
 ...
 rw [sum_range_succ]; rw [ ←slice_union_shadow_falling_succ]; rw [ card_disjoint_union h𝒜.disjoint_slice_shadow_falling]; rw [ cast_add]; rw [ _root_.add_div]; rw [ add_comm],
...
begin
 ...
 { rw [tsub_self]; rw [ choose_zero_right],
 exact zero_lt_one }
end
...
begin
 ...
 { rwa [←sum_div] at this; rwa [ ←nat.cast_sum] at this; rwa [ div_le_one] at this; rwa [ cast_le] at this; rwa [ sum_card_slice] at this,
 norm_cast,
