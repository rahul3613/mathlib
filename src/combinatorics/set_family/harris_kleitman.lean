...
λ s, by { rw [mem_member_subfamily]; rw [ mem_non_member_subfamily],
...
begin
 ...
 rw [card_insert_of_not_mem hs]; rw [ ←card_member_subfamily_add_card_non_member_subfamily a 𝒜]; rw [ ←card_member_subfamily_add_card_non_member_subfamily a ℬ]; rw [ add_mul]; rw [ mul_add]; rw [ mul_add]; rw [ add_comm (_ * _)]; rw [ add_add_add_comm],
 ...
 rw [←mul_add]; rw [ ←member_subfamily_inter]; rw [ ←non_member_subfamily_inter]; rw [ card_member_subfamily_add_card_non_member_subfamily],
end
...
begin
 rw [←is_lower_set_compl] at h𝒜; rw [ ←coe_compl] at h𝒜,
 have := h𝒜.le_card_inter_finset hℬ,
 rwa [card_compl] at this; rwa [ fintype.card_finset] at this; rwa [ tsub_mul] at this; rwa [ tsub_le_iff_tsub_le] at this; rwa [ ←mul_tsub] at this; rwa [ ←card_sdiff (inter_subset_right _ _)] at this; rwa [ sdiff_inter_self_right] at this; rwa [ sdiff_compl] at this; rwa [ _root_.inf_comm] at this,
end
...
lemma is_lower_set.card_inter_le_finset
 ...
 2 ^ fintype.card α * (𝒜 ∩ ℬ).card ≤ 𝒜.card * ℬ.card :=
by { rw [inter_comm]; rw [ mul_comm 𝒜.card], exact hℬ.card_inter_le_finset h𝒜 }
...
begin
 ...
 rwa [card_compl] at this; rwa [ fintype.card_finset] at this; rwa [ tsub_mul] at this; rwa [ le_tsub_iff_le_tsub] at this; rwa [ ←mul_tsub] at this; rwa [ ←card_sdiff (inter_subset_right _ _)] at this; rwa [ sdiff_inter_self_right] at this; rwa [ sdiff_compl] at this; rwa [ _root_.inf_comm] at this,
