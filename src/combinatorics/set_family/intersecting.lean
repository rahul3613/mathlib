...
begin
 ...
 rw [two_mul]; rw [ card_disj_union]; rw [ card_map],
end
...
begin
 ...
 { rw [fintype.card]; rw [ ←this]; rw [ two_mul]; rw [ card_disj_union]; rw [ card_map] },
 rw [←coe_eq_univ]; rw [ disj_union_eq_union]; rw [ coe_union]; rw [ coe_map]; rw [ function.embedding.coe_fn_mk]; rw [ image_eq_preimage_of_inverse compl_compl compl_compl],
