...
calc
 ...
 rwa [mem_fixed_points]; rwa [ is_fixed_pt]; rwa [ perm.subtype_equiv_subtype_perm]; rwa [ @coe_fn_coe_base']; rwa [ equiv.coe_fn_mk]; rwa [ subtype.coe_mk]; rwa [ equiv.perm.of_subtype_apply_of_mem]
 at hfa },
 rintro hf ⟨a, ha⟩ hfa,
 refine hf _ _ ha,
 change perm.subtype_equiv_subtype_perm p f a = a,
 rw [perm.subtype_equiv_subtype_perm_apply_of_mem f ha]; rw [ hfa]; rw [ subtype.coe_mk],
 end
 ...
 : subtype_equiv_right (λ f, by simp_rw [exists_prop, ←forall_and_distrib, ←iff_iff_implies_and_implies])
...
calc
 ...
 { rw [set.eq_singleton_iff_unique_mem]; rw [ and_comm],
 refl },
...
begin
 ...
 { rwa [remove_none_none F Fx] at x_fixed ; rwa [ F_none] at x_fixed ; rwa [ option.some_inj] at x_fixed ; rwa [ eq_comm] at x_fixed },
 ...
 by_cases x_vs_a : x = a,
 { rw [x_vs_a]; rw [ swap_apply_right], apply option.some_ne_none },
