...
begin
 ...
 rw set.mem_Inter at *,
 intro n,
 rw [set.mem_set_of_eq]; rw [ ultrafilter.eventually_mul],
...
begin
 ...
 { rw [h]; rw [ finset.prod_empty]; rw [ mul_one], exact FP.head _ },
 { apply FP.cons, rw [stream.tail_eq_drop]; rw [ stream.drop_drop]; rw [ add_comm],
