...
begin
 ...
 { rw [nonempty_iff_ne_empty] at he; rw [ not_not] at he,
 subst s',
 simp },
end
...
begin
 ...
 ... = n : by { rw [hn]; rw [ nat.add_succ_sub_one]; rw [ add_zero], },
...
begin
 ...
 rwa [fintype.card_coe]; rwa [ card_compl_lt_iff_nonempty] },
