...
begin
 rw [multiplicative_energy]; rw [ ←finset.card_map (equiv.prod_comm _ _).to_embedding]; rw [ map_filter],
...
by rw [multiplicative_energy_comm]; rw [ multiplicative_energy_univ_left]
