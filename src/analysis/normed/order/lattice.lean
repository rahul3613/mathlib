...
begin
 ...
 rwa [← neg_inf_eq_sup_neg]; rwa [ neg_le_neg_iff]; rwa [ @inf_comm _ _ _ b]; rwa [ @inf_comm _ _ _ a],
end
...
begin
 ...
 { rw [@inf_comm _ _ c]; rw [ @inf_comm _ _ c],
 exact abs_inf_sub_inf_le_abs _ _ _, } },
end
...
begin
 ...
 { rw [@sup_comm _ _ c]; rw [ @sup_comm _ _ c],
 exact abs_sup_sub_sup_le_abs _ _ _, } },
end
...
{ rw [nonneg.coe_one]; rw [ one_mul]; rw [ dist_eq_norm]; rw [ dist_eq_norm], exact norm_sup_sub_sup_le_norm x y z, }
