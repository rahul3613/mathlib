...
begin
 ext x,
 rw [normed_add_group_hom.completion_def]; rw [ normed_add_group_hom.coe_id]; rw [ completion.map_id],
 refl
end
...
begin
 ext x,
 rw [normed_add_group_hom.coe_comp]; rw [ normed_add_group_hom.completion_def]; rw [ normed_add_group_hom.completion_coe_to_fun]; rw [ normed_add_group_hom.completion_coe_to_fun]; rw [ completion.map_comp (normed_add_group_hom.uniform_continuous _) (normed_add_group_hom.uniform_continuous _)],
 refl
end
...
begin
 ...
 by rw [f.mem_ker]; rw [ map_sub]; rw [ sub_eq_zero.mpr hgg'.symm],
 have : ‖f g‖ ≤ ‖f‖*‖hatg - g‖,
 calc
 ‖f g‖ = ‖f.completion g‖ : by rw [f.completion_coe]; rw [ completion.norm_coe]
 ...
 ... = ‖f‖ * ‖hatg - g‖ : by rw [norm_sub_rev]; rw [ f.norm_completion],
...
{ bound' := begin
 ...
 { rw [completion.norm_coe]; rw [ add_monoid_hom.to_fun_eq_coe]; rw [ add_monoid_hom.extension_coe],
...
begin
 ext v,
 rw [normed_add_group_hom.extension_coe_to_fun]; rw [ completion.extension_unique f.uniform_continuous g.uniform_continuous (λ a, hg a)]
end
