...
begin
 rw [cauchy_seq_finset_iff_vanishing]; rw [ nhds_basis_ball.forall_iff],
...
by rw [summable_iff_cauchy_seq_finset]; rw [ cauchy_seq_finset_iff_vanishing_norm]
...
begin
 ...
 { rw [tsum_eq_zero_of_not_summable hf]; rw [ norm_zero],
