...
begin
 ...
 ... = C * b 0 + C * ‖h‖ : by rw [add_comm]; rw [ mul_add] },
 ...
 ... = ∑ k in range (n+1), C*b k + C*‖h‖ : by rw [← add_assoc]; rw [ sum_range_succ']
 ... ≤ (C+ε)*‖h‖ : by { rw [add_comm]; rw [ add_mul], apply add_le_add_left this } }
end
