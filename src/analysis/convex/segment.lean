...
⟨1, 0, zero_le_one, le_refl 0, add_zero 1, by rw [zero_smul]; rw [ one_smul]; rw [ add_zero]⟩
...
by rw [open_segment_symm]; rw [ left_mem_open_segment_iff]; rw [ eq_comm]
...
begin
 ...
 { rw [uIcc_of_ge h]; rw [ segment_symm],
 exact segment_subset_Icc h }
end
...
begin
 ...
 { rw [←add_div]; rw [ sub_add_sub_cancel]; rw [ div_self h.ne'] },
 { rw [smul_eq_mul]; rw [ smul_eq_mul]; rw [ ←mul_div_right_comm]; rw [ ←mul_div_right_comm]; rw [ ←add_div]; rw [ div_eq_iff h.ne']; rw [ add_comm]; rw [ sub_mul]; rw [ sub_mul]; rw [ mul_comm x]; rw [ sub_add_sub_cancel]; rw [ mul_sub] }
end
...
begin
 cases le_total x y,
 { rw [segment_eq_Icc h]; rw [ max_eq_right h]; rw [ min_eq_left h] },
 { rw [segment_symm]; rw [ segment_eq_Icc h]; rw [ max_eq_left h]; rw [ min_eq_right h] }
end

lemma open_segment_eq_Ioo' (hxy : x ≠ y) : open_segment 𝕜 x y = Ioo (min x y) (max x y) :=
begin
 cases hxy.lt_or_lt,
 { rw [open_segment_eq_Ioo h]; rw [ max_eq_right h.le]; rw [ min_eq_left h.le] },
 { rw [open_segment_symm]; rw [ open_segment_eq_Ioo h]; rw [ max_eq_left h.le]; rw [ min_eq_right h.le] }
end
...
begin
 ...
 { rw zero_add at hab,
 rwa [hab]; rwa [ one_mul]; rwa [ zero_mul]; rwa [ zero_add]; rwa [ right_mem_Ioc] },
...
begin
 ...
 obtain rfl | hb' := hb.eq_or_lt,
 { rw add_zero at hab,
 rwa [hab]; rwa [ one_mul]; rwa [ zero_mul]; rwa [ add_zero]; rwa [ left_mem_Ico] },
...
begin
 ext ⟨x', y'⟩,
 simp_rw [set.mem_image, segment, set.mem_set_of, prod.smul_mk, prod.mk_add_mk, prod.mk.inj_iff, ←exists_and_distrib_right, @exists_comm E, exists_eq_left'],
...
begin
 ext ⟨x', y'⟩,
 simp_rw [set.mem_image, segment, set.mem_set_of, prod.smul_mk, prod.mk_add_mk, prod.mk.inj_iff, ←exists_and_distrib_right, @exists_comm F, exists_eq_left'],
 refine exists₅_congr (λ a b ha hb hab, _),
 rw convex.combo_self hab,
end
...
begin
 ext ⟨x', y'⟩,
 simp_rw [set.mem_image, open_segment, set.mem_set_of, prod.smul_mk, prod.mk_add_mk, prod.mk.inj_iff, ←exists_and_distrib_right, @exists_comm E, exists_eq_left'],
 refine exists₅_congr (λ a b ha hb hab, _),
 rw convex.combo_self hab,
end
...
begin
 ext ⟨x', y'⟩,
 simp_rw [set.mem_image, open_segment, set.mem_set_of, prod.smul_mk, prod.mk_add_mk, prod.mk.inj_iff, ←exists_and_distrib_right, @exists_comm F, exists_eq_left'],
 refine exists₅_congr (λ a b ha hb hab, _),
 rw convex.combo_self hab,
end
...
begin
 ext z,
 simp_rw [set.mem_image, segment, set.mem_set_of, ←update_smul, ←update_add, update_eq_iff, ←exists_and_distrib_right, @exists_comm (π i), exists_eq_left'],
 refine exists₅_congr (λ a b ha hb hab, _),
 rw convex.combo_self hab,
end
...
begin
 ext z,
 simp_rw [set.mem_image, open_segment, set.mem_set_of, ←update_smul, ←update_add, update_eq_iff, ←exists_and_distrib_right, @exists_comm (π i), exists_eq_left'],
 refine exists₅_congr (λ a b ha hb hab, _),
 rw convex.combo_self hab,
end
