...
λ s x hx, begin
 ...
 rw [convex_hull_nonempty_iff] at this; rw [ set.nonempty_image_iff] at this,
...
begin
 ...
 rw [hij]; rw [ set.image_singleton]; rw [ convex_hull_singleton],
...
begin
 ...
 ext,
 rw [embedding.coe_fn_mk]; rw [ comp_app]; rw [ hf],
end
...
begin
 ...
 rw ←mem_singleton,
 refine h {b} a _,
 rw [hab]; rw [ image_singleton]; rw [ coe_singleton]; rw [ convex_hull_singleton],
 exact set.mem_singleton _ },
 ...
 { rwa [mem_preimage] at this ; rwa [ ←mem_coe] at this },
 refine h _ x _,
 rwa [t.image_preimage p (hp.inj_on _)]; rwa [ filter_true_of_mem],
