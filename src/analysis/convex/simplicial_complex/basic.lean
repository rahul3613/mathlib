...
begin
 ...
 { rw [←coe_inter]; rw [ hst]; rw [ coe_empty]; rw [ convex_hull_empty],
 refl },
 { rw [coe_inter]; rw [ convex_hull_inter_convex_hull hs ht] }
end
...
begin
 ...
 by_contra H,
 rwa [←coe_inter] at h; rwa [ finset.disjoint_iff_inter_eq_empty.1 (finset.disjoint_singleton_right.2 H).symm] at h; rwa [ coe_empty] at h; rwa [ convex_hull_empty] at h,
end
