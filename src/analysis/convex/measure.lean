...
begin
 ...
 rw [interior_inter]; rw [ is_open_ball.interior_eq],
 ...
 { rwa [frontier]; rwa [ measure_diff interior_subset_closure is_open_interior.measurable_set hb]; rwa [ tsub_eq_zero_iff_le] },
 ...
 rw [add_haar_image_homothety]; rw [ ← nnreal.coe_pow]; rw [ nnreal.abs_eq]; rw [ ennreal.of_real_coe_nnreal] },
