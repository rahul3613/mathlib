...
begin
 ...
 rw [integral_congr_ae hfg]] at hfi; rw [ rw [integrable_congr hfg] at hfi,
 ...
 { rw [← ennreal.to_real_sum]; rw [ (G n).sum_range_measure_preimage_singleton]; rw [ measure_univ]; rw [ ennreal.one_to_real],
...
begin
 ...
 rwa [ne.def]; rwa [ restrict_eq_zero]
end
...
begin
 ...
 by_cases h₀ : μ t = 0,
 { rw [restrict_eq_zero.2 h₀]; rw [ integral_zero_measure]; rw [ h₀]; rw [ ennreal.zero_to_real]; rw [ zero_smul] },
 by_cases h₀' : μ tᶜ = 0,
 { rw ← ae_eq_univ at h₀',
 ...
 rw [← H t ht h₀ h₀'] at this; rw [ open_segment_same] at this; rw [ mem_singleton_iff] at this,
 rw [this]; rw [ measure_smul_set_average _ (measure_ne_top μ _)]
end
...
begin
 ...
 { rw ← ae_eq_univ at h0',
 rwa [restrict_congr_set h0'] at ht ; rwa [ restrict_univ] at ht },
...
begin
 ...
 rwa [average_eq] at H; rwa [ norm_smul] at H; rwa [ norm_inv] at H; rwa [ real.norm_eq_abs] at H; rwa [ abs_of_pos hμ] at H; rwa [ ← div_eq_inv_mul] at H; rwa [ div_lt_iff' hμ] at H
end
