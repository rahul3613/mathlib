...
by rw [insert_eq]; rw [ inner_dual_cone_union]
...
by rw [←convex_cone.coe_infi]; rw [ ←inner_dual_cone_Union]; rw [ Union_of_singleton_coe]
...
begin
 ...
 { rw [inner_dual_cone_singleton]; rw [ convex_cone.coe_comap]; rw [ convex_cone.coe_positive]; rw [ innerₛₗ_apply_coe] },
...
begin
 ...
 have mem₀ := fc.mem_closure_image (by rw [closure_Ioi (0 : ℝ)]; rw [ mem_Ici]),
...
begin
 ...
 rwa [add_sub_cancel] at hinner ; rwa [ real_inner_comm] at hinner ; rwa [ ← neg_nonneg] at hinner ; rwa [ neg_eq_neg_one_mul] at hinner ; rwa [ ← real_inner_smul_right] at hinner ; rwa [ neg_smul] at hinner ; rwa [ one_smul] at hinner ; rwa [ neg_sub] at hinner },
...
begin
 ext x,
 split,
 { rw [mem_inner_dual_cone]; rw [ ← set_like.mem_coe],
 contrapose!,
