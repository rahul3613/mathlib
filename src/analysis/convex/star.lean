...
begin
 ...
 { rw zero_add at hab,
 rwa [hab]; rwa [ one_smul]; rwa [ zero_smul]; rwa [ zero_add] },
 obtain rfl | hb := hb.eq_or_lt,
 { rw add_zero at hab,
 rwa [hab]; rwa [ one_smul]; rwa [ zero_smul]; rwa [ add_zero] },
 exact h hy ha hb hab,
end
...
begin
 ...
 intros h y hy a b ha hb hab,
 obtain rfl | ha' := ha.eq_or_lt,
 { rw [zero_add] at hab, rwa [hab]; rwa [ zero_smul]; rwa [ one_smul]; rwa [ zero_add] },
 obtain rfl | hb' := hb.eq_or_lt,
 { rw [add_zero] at hab, rwa [hab]; rwa [ zero_smul]; rwa [ one_smul]; rwa [ add_zero] },
...
begin
 ...
 obtain ⟨y', hy', rfl⟩ := hy,
 exact ⟨a • x + b • y', hs hy' ha hb hab, by rw [f.map_add]; rw [ f.map_smul]; rw [ f.map_smul]⟩,
end
...
begin
 ...
 rwa [←image_smul] at h; rwa [ image_image] at h,
end
...
⟨λ h y hy a b ha hb hab, begin
 ...
 rwa [mul_zero] at ha' ; rwa [ ←div_eq_inv_mul] at ha' },
 { have hb', from mul_le_mul_of_nonneg_left hb (inv_pos.2 hab).le,
 rwa [mul_zero] at hb' ; rwa [ ←div_eq_inv_mul] at hb' },
 { rw ←add_div,
