...
begin
 ...
 rw [sbtw] at h; rw [ ←wbtw_vsub_const_iff p] at h; rw [ wbtw] at h; rw [ affine_segment_eq_segment] at h; rw [ ←insert_endpoints_open_segment] at h; rw [ set.mem_insert_iff] at h; rw [ set.mem_insert_iff] at h,
 rcases h with ⟨h | h | h, hp₂p₁, hp₂p₃⟩,
 { rw vsub_left_cancel_iff at h, exact false.elim (hp₂p₁ h) },
 { rw vsub_left_cancel_iff at h, exact false.elim (hp₂p₃ h) },
 { rw [open_segment_eq_image] at h; rw [ set.mem_image] at h,
...
begin
 ...
 rw [hp₁] at hs'; rw [ hp₃] at hs'; rw [ lt_max_iff] at hs'; rw [ lt_self_iff_false] at hs'; rw [ or_false] at hs',
 exact false.elim (hp₂.not_lt hs') },
 { by_cases hp₁p₂ : p₁ = p₂, { simp [hp₁p₂] },
 have hs : sbtw ℝ p₃ p₁ p₂ := ⟨hw, hp₁p₃, hp₁p₂⟩,
 have hs' := hs.dist_lt_max_dist p,
 rw [hp₁] at hs'; rw [ hp₃] at hs'; rw [ lt_max_iff] at hs'; rw [ lt_self_iff_false] at hs'; rw [ false_or] at hs',
 exact false.elim (hp₂.not_lt hs') }
end
