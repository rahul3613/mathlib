...
by rw [intrinsic_frontier]; rw [ preimage_coe_affine_span_singleton]; rw [ frontier_univ]; rw [ image_empty]
...
(image_diff subtype.coe_injective _ _).symm.trans $
 by rw [closure_diff_frontier]; rw [ intrinsic_interior]
...
by rw [union_comm]; rw [ intrinsic_interior_union_intrinsic_frontier]
...
begin
 rw [intrinsic_closure]; rw [ hs.closure_eq]; rw [ image_preimage_eq_of_subset],
...
begin
 ...
 rw [intrinsic_closure]; rw [ preimage_image_eq _ subtype.coe_injective],
...
begin
 ...
 rw [intrinsic_interior]; rw [ intrinsic_interior]; rw [ ←φ.coe_to_affine_map]; rw [ ←map_span φ.to_affine_map s]; rw [ ←this]; rw [ ←function.comp.assoc]; rw [ image_comp]; rw [ image_comp]; rw [ f.symm.image_interior]; rw [ f.image_symm]; rw [ ←preimage_comp]; rw [ function.comp.assoc]; rw [ f.symm_comp_self]; rw [ affine_isometry.coe_to_affine_map]; rw [ function.comp.right_id]; rw [ preimage_comp]; rw [ φ.injective.preimage_image],
end
...
begin
 ...
 let f := ((affine_span 𝕜 s).isometry_equiv_map φ).to_homeomorph,
 have : φ.to_affine_map ∘ coe ∘ f.symm = coe := funext isometry_equiv_map.apply_symm_apply,
 rw [intrinsic_frontier]; rw [ intrinsic_frontier]; rw [ ←φ.coe_to_affine_map]; rw [ ←map_span φ.to_affine_map s]; rw [ ←this]; rw [ ←function.comp.assoc]; rw [ image_comp]; rw [ image_comp]; rw [ f.symm.image_frontier]; rw [ f.image_symm]; rw [ ←preimage_comp]; rw [ function.comp.assoc]; rw [ f.symm_comp_self]; rw [ affine_isometry.coe_to_affine_map]; rw [ function.comp.right_id]; rw [ preimage_comp]; rw [ φ.injective.preimage_image],
end
...
begin
 ...
 let f := ((affine_span 𝕜 s).isometry_equiv_map φ).to_homeomorph,
 have : φ.to_affine_map ∘ coe ∘ f.symm = coe := funext isometry_equiv_map.apply_symm_apply,
 rw [intrinsic_closure]; rw [ intrinsic_closure]; rw [ ←φ.coe_to_affine_map]; rw [ ←map_span φ.to_affine_map s]; rw [ ←this]; rw [ ←function.comp.assoc]; rw [ image_comp]; rw [ image_comp]; rw [ f.symm.image_closure]; rw [ f.image_symm]; rw [ ←preimage_comp]; rw [ function.comp.assoc]; rw [ f.symm_comp_self]; rw [ affine_isometry.coe_to_affine_map]; rw [ function.comp.right_id]; rw [ preimage_comp]; rw [ φ.injective.preimage_image],
end
...
by rw [←φ.image_symm]; rw [ ←φ.symm.image_interior]; rw [ nonempty_image_iff]
...
begin
 ...
 rw [intrinsic_interior]; rw [ nonempty_image_iff]; rw [ aux (affine_isometry_equiv.const_vsub ℝ p').symm.to_homeomorph]; rw [ convex.interior_nonempty_iff_affine_span_eq_top]; rw [ affine_isometry_equiv.coe_to_homeomorph]; rw [ ←affine_isometry_equiv.coe_to_affine_equiv]; rw [ ←comap_span]; rw [ affine_span_coe_preimage_eq_top]; rw [ comap_top],
