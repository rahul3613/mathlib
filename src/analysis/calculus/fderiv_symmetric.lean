...
begin
 ...
 -- good up to `δ`.
 rw [has_fderiv_within_at] at hx; rw [ has_fderiv_at_filter] at hx; rw [ is_o_iff] at hx,
...
begin
 ...
 assume h hpos,
 rw [← one_smul ℝ (f'' w v - f'' v w)]; rw [ smul_smul]; rw [ smul_smul],
 congr' 1,
...
begin
 ...
 by rwa [metric.is_open_ball.interior_eq]; rwa [ metric.nonempty_ball],
