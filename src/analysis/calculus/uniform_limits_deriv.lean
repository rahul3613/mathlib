...
begin
 ...
 rw [← smul_sub]; rw [ norm_smul]; rw [ norm_inv]; rw [ is_R_or_C.norm_coe_norm],
...
begin
 ...
 conv
 { congr, funext,
 rw [← abs_norm]; rw [ ← abs_inv]; rw [ ← @is_R_or_C.norm_of_real 𝕜 _ _]; rw [ is_R_or_C.of_real_inv]; rw [ ← norm_smul], },
 ...
 rw [has_fderiv_at_iff_tendsto] at this; rw [ metric.tendsto_nhds] at this,
 refine (this ε hε).mono (λ y hy, _),
 rw dist_eq_norm at hy ⊢,
 simp only [sub_zero, map_sub, norm_mul, norm_inv, norm_norm] at hy ⊢,
 rw [norm_smul]; rw [ norm_inv]; rw [ is_R_or_C.norm_coe_norm],
 exact hy, },
...
begin
 ...
 rw [seminormed_add_group.uniform_cauchy_seq_on_filter_iff_tendsto_uniformly_on_filter_zero] at hf' ⊢; rw [ metric.tendsto_uniformly_on_filter_iff] at hf' ⊢,
 intros ε hε,
