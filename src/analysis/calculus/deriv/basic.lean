...
by rw [← Ici_diff_left]; rw [ has_deriv_within_at_diff_singleton]
...
by rw [← Iic_diff_right]; rw [ has_deriv_within_at_diff_singleton]
...
begin
 ...
 { rw [deriv_within_zero_of_not_differentiable_within_at H]; rw [ deriv_within_zero_of_not_differentiable_within_at],
