...
begin
 ...
 rw [smul_smul]; rw [ this]; rw [ one_smul] }
end
...
by { rw [unique_diff_within_at_iff]; rw [ tangent_cone_univ], simp }
...
begin
 ...
 rw [linear_map.span_inl_union_inr] at this; rw [ set_like.le_def] at this,
