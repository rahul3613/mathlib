...
else by { rw [fderiv_within_zero_of_not_differentiable_within_at hf]; rw [ fderiv_within_zero_of_not_differentiable_within_at], simpa }
...
else by { rw [fderiv_within_zero_of_not_differentiable_within_at h]; rw [ fderiv_within_zero_of_not_differentiable_within_at]; rw [ neg_zero], simpa }
