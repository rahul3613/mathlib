...
begin
 ...
 { rw [← h]; rw [ ← nhds_within_Ioo_eq_nhds_within_Iio hx.1],
...
begin
 ...
 { rw [← hfa]; rw [ ← nhds_within_Ioo_eq_nhds_within_Ioi hab],
 exact ((hcf a $ left_mem_Ico.mpr hab).mono Ioo_subset_Ico_self).tendsto },
 { rw [← hga]; rw [ ← nhds_within_Ioo_eq_nhds_within_Ioi hab],
...
begin
 ...
 rwa [mul_comm] at h ; rwa [ ← neg_eq_neg_one_mul] at h ; rwa [ neg_eq_zero] at h })
...
begin
 ...
 { rw [← hfb]; rw [ ← nhds_within_Ioo_eq_nhds_within_Iio hab],
 exact ((hcf b $ right_mem_Ioc.mpr hab).mono Ioo_subset_Ioc_self).tendsto },
 { rw [← hgb]; rw [ ← nhds_within_Ioo_eq_nhds_within_Iio hab],
