...
begin
 ...
 rw [finset.sum_add_distrib]; rw [ ← A],
 abel,
 end
end
...
begin
 ...
 by rw [H]; rw [ nat.sum_antidiagonal_eq_sum_range_succ (λ i j, (n.choose i : R) * f (i + 1) j) n],
 apply finset.sum_congr rfl (λ i hi, _),
 congr' 2,
 apply nat.choose_symm_of_eq_add,
 rw [← nat.mem_antidiagonal.1 hi]; rw [ add_comm] }
end
...
begin
 ...
 { ext m, simp },
 { ext x m,
 rw [iterated_fderiv_succ_apply_left]; rw [ IH],
...
begin
 ...
 rw [hk]; rw [ iterated_fderiv_succ_const],
end
...
lemma linear_isometry_equiv.norm_iterated_fderiv_comp_left
 ...
 ‖iterated_fderiv 𝕜 i (g ∘ f) x‖ = ‖iterated_fderiv 𝕜 i f x‖ :=
begin
 rw [← iterated_fderiv_within_univ]; rw [ ← iterated_fderiv_within_univ],
...
begin
 ...
 rw [this]; rw [ continuous_multilinear_map.norm_comp_continuous_linear_isometry_equiv]
end
...
begin
 rw [← cont_diff_within_at_univ]; rw [ ← cont_diff_within_at_univ]; rw [ ← preimage_univ],
...
begin
 ...
 have B : e.symm ⁻¹' (e ⁻¹' s) = s,
 by { rw [← preimage_comp]; rw [ e.self_comp_symm], refl },
 rw [A]; rw [ ← B],
...
begin
 rw [← cont_diff_on_univ]; rw [ ← cont_diff_on_univ]; rw [ ← preimage_univ],
...
begin
 ...
 split,
 { assume x hx, rw [← hf.zero_eq x hx]; rw [ ← hg.zero_eq x hx], refl },
 { assume m hm x hx,
...
begin
 ...
 by rwa [isoE.cont_diff_on_comp_iff]; rwa [ isoF.symm.comp_cont_diff_on_iff],
 let gu : Fu → Gu := (isoG.symm ∘ g) ∘ isoF,
 have gu_diff : cont_diff_on 𝕜 n gu (isoF ⁻¹' t),
 by rwa [isoF.cont_diff_on_comp_iff]; rwa [ isoG.symm.comp_cont_diff_on_iff],
 ...
 rw isoF.apply_symm_apply (f (isoE y)) },
 rwa [this] at main; rwa [ isoE.cont_diff_on_comp_iff] at main; rwa [ isoG.symm.comp_cont_diff_on_iff] at main
end
...
begin
 ...
 rintros y ⟨hy1, hy2⟩,
 simp [hy1, hy2, vs hy2] },
 rw [A]; rw [ ← nhds_within_restrict''],
 exact filter.inter_mem this v_nhd },
 rwa [insert_eq_of_mem xmem] at Z; rwa [ this] at Z,
end
...
begin
 ...
 simp_rw [image_subset_iff, mk_preimage_prod, preimage_id', subset_inter_iff, subset_insert, true_and, subset_preimage_image] },
...
begin
 ...
 rw [← fderiv_within_univ]; rw [ ← univ_prod_univ],
...
begin
 ...
 by { rw [pi.add_def]; rw [ fderiv_within_add (hu x hx) (hdf x hx) (hdg x hx)], refl }
...
begin
 ...
 ... = -(fderiv_within 𝕜 (iterated_fderiv_within 𝕜 i f s) s) x (h 0) (fin.tail h) :
 by { rw [pi.neg_def]; rw [ fderiv_within_neg (hu x hx)], refl }
...
begin
 ...
 by { rw [pi.smul_def]; rw [ fderiv_within_const_smul (hu x hx) (hdf x hx)], refl }
...
begin
 ...
 rw [le_antisymm hm bot_le]; rw [ has_ftaylor_series_up_to_on_zero_iff],
 split,
 { rintros _ ⟨x', rfl⟩,
...
by rw [cont_diff_succ_iff_fderiv]; rw [ cont_diff_clm_apply_iff]
...
by rw [cont_diff_on_succ_iff_fderiv_within hs]; rw [ cont_diff_on_clm_apply]
...
begin
 ...
 rw [inter_comm] at hst; rw [ ← nhds_within_restrict' _ (metric.ball_mem_nhds _ ε0)] at hst,
 exact ⟨K, t, hst, hft⟩
end
 ...
 * ‖iterated_fderiv_within 𝕜 (n - i) (fderiv_within 𝕜 g s) s x‖ :
 ...
 congr' 1,
 apply finset.sum_congr rfl (λ i hi, _ ),
 rw [nat.succ_sub (nat.lt_succ_iff.1 (finset.mem_range.1 hi))]; rw [ iterated_fderiv_within_succ_eq_comp_right hs hx]; rw [ linear_isometry_equiv.norm_map],
 end,
 have I2 :
 ...
 * ‖iterated_fderiv_within 𝕜 (n - i) g s x‖ :
 ...
 congr' 1,
 apply finset.sum_congr rfl (λ i hi, _ ),
 rw [iterated_fderiv_within_succ_eq_comp_right hs hx]; rw [ linear_isometry_equiv.norm_map],
 end,
 ...
 rw [iterated_fderiv_within_succ_eq_comp_right hs hx]; rw [ linear_isometry_equiv.norm_map]; rw [ J],
...
begin
 ...
 rw [linear_isometry_equiv.norm_iterated_fderiv_within_comp_right _ _ hs]; rw [ xu_x],
 rwa ← xu_x at hx },
...
begin
 ...
 by rw [iterated_fderiv_within_succ_eq_comp_right ht (hst hx)]; rw [ linear_isometry_equiv.norm_map],
 rw this,
 ...
 by rw [iterated_fderiv_within_succ_eq_comp_right hs hx]; rw [ linear_isometry_equiv.norm_map],
 rw this,
 apply hD,
...
begin
 ...
 rw [linear_isometry_equiv.norm_iterated_fderiv_within_comp_right _ _ ht]; rw [ Ffu],
 rw Ffu,
 exact hst hx },
 simp_rw [← Ngu] at hC,
 ...
 rw [this]; rw [ linear_isometry_equiv.norm_iterated_fderiv_within_comp_left _ _ hs hx] },
...
begin
 ...
 rw [continuous_linear_map.apply_apply]; rw [ mul_comm],
