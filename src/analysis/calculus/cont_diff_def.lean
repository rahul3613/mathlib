...
begin
 ...
 rw [continuous_on_congr this]; rw [ linear_isometry_equiv.comp_continuous_on_iff],
 exact H.1
end
...
begin
 ...
 { rw [← cont_diff_within_at_insert]; rw [ cont_diff_within_at_succ_iff_has_fderiv_within_at]; rw [ insert_eq_of_mem (mem_insert _ _)],
...
by rw [iterated_fderiv_within_zero_eq_comp]; rw [ linear_isometry_equiv.norm_map]
...
by rw [iterated_fderiv_within_succ_eq_comp_left]; rw [ linear_isometry_equiv.norm_map]
...
begin
 ...
 { rw [iterated_fderiv_within_succ_eq_comp_left]; rw [ iterated_fderiv_within_zero_eq_comp]; rw [ iterated_fderiv_within_zero_apply]; rw [ function.comp_apply]; rw [ linear_isometry_equiv.comp_fderiv_within _ (hs x hx)],
 refl },
 ...
 (init m) (m (last (n + 1))) :
 by { rw [iterated_fderiv_within_succ_apply_left]; rw [ tail_init_eq_init_tail], refl } }
end
...
begin
 ...
 rw [(ihn hy).fderiv_within_eq_nhds]; rw [ fderiv_within_congr_set' _ hy] }
end
...
begin
 ...
 { rw [h.zero_eq' hx]; rw [ iterated_fderiv_within_zero_eq_comp] },
 ...
 rw [iterated_fderiv_within_succ_eq_comp_left]; rw [ function.comp_apply]; rw [ this.fderiv_within (hs x hx)],
...
begin
 ...
 rw [← this]; rw [ ← has_fderiv_within_at_inter (is_open.mem_nhds o_open xo)],
...
begin
 ...
 rw [← inter_assoc]; rw [ nhds_within_inter_of_mem']; rw [ ← diff_eq_compl_inter]; rw [ insert_diff_of_mem]; rw [ diff_eq_compl_inter],
...
begin
 intros x hx,
 rw [cont_diff_within_at_succ_iff_has_fderiv_within_at]; rw [ insert_eq_of_mem hx],
...
by rwa [cont_diff_at]; rwa [ ← cont_diff_within_at_inter hx]; rwa [ univ_inter]
...
theorem cont_diff_at_succ_iff_has_fderiv_at {n : ℕ} :
 ...
 ∧ cont_diff_at 𝕜 n f' x) :=
begin
 rw [← cont_diff_within_at_univ]; rw [ cont_diff_within_at_succ_iff_has_fderiv_within_at],
...
begin
 rw [← cont_diff_on_univ]; rw [ continuous_iff_continuous_on_univ],
...
by rw [iterated_fderiv_zero_eq_comp]; rw [ linear_isometry_equiv.norm_map]
...
by rw [iterated_fderiv_succ_eq_comp_left]; rw [ linear_isometry_equiv.norm_map]
...
begin
 ...
 { ext x, simp },
 { ext x m,
 rw [iterated_fderiv_succ_apply_left]; rw [ iterated_fderiv_within_succ_apply_left]; rw [ IH]; rw [ fderiv_within_univ] }
end
...
begin
 ...
 { assume x hx,
 rw [iterated_fderiv_succ_eq_comp_left]; rw [ iterated_fderiv_within_succ_eq_comp_left],
 dsimp,
 congr' 1,
...
begin
 rw [← iterated_fderiv_within_univ]; rw [ ← iterated_fderiv_within_univ]; rw [ ← fderiv_within_univ],
...
by rw [iterated_fderiv_succ_eq_comp_right]; rw [ linear_isometry_equiv.norm_map]

@[simp] lemma iterated_fderiv_one_apply (m : (fin 1) → E) :
 (iterated_fderiv 𝕜 1 f x : ((fin 1) → E) → F) m
 = (fderiv 𝕜 f x : E → F) (m 0) :=
by { rw [iterated_fderiv_succ_apply_right]; rw [ iterated_fderiv_zero_apply], refl }
...
begin
 split,
 { rw [← cont_diff_on_univ]; rw [ ← has_ftaylor_series_up_to_on_univ_iff]; rw [ ← ftaylor_series_within_univ],
