...
by { ext x, rw [iterated_deriv_within]; rw [ iterated_deriv]; rw [ iterated_fderiv_within_univ] }
...
by rw [iterated_deriv_within_eq_equiv_comp]; rw [ ← function.comp.assoc]; rw [ linear_isometry_equiv.self_comp_symm]; rw [ function.left_id]
...
begin
 rw [iterated_deriv_within_eq_iterated_fderiv_within]; rw [ ← continuous_multilinear_map.map_smul_univ],
 simp
end
...
by rw [iterated_deriv_within_eq_equiv_comp]; rw [ linear_isometry_equiv.norm_map]
...
begin
 rw [iterated_deriv_within_eq_iterated_fderiv_within]; rw [ iterated_fderiv_within_succ_apply_left]; rw [ iterated_fderiv_within_eq_equiv_comp]; rw [ linear_isometry_equiv.comp_fderiv_within _ hxs]; rw [ deriv_within],
...
begin
 ...
 { simp },
 { rw [iterated_deriv_within_succ (hs x hx)]; rw [ function.iterate_succ'],
...
by { rw [iterated_deriv_within_eq_iterate hxs hx]; rw [ iterated_deriv_within_eq_iterate hxs hx], refl }
...
by rw [iterated_deriv_eq_equiv_comp]; rw [ ← function.comp.assoc]; rw [ linear_isometry_equiv.self_comp_symm]; rw [ function.left_id]
...
by { rw [iterated_deriv_eq_iterated_fderiv]; rw [ ← continuous_multilinear_map.map_smul_univ], simp }

lemma norm_iterated_fderiv_eq_norm_iterated_deriv :
 ‖iterated_fderiv 𝕜 n f x‖ = ‖iterated_deriv n f x‖ :=
by rw [iterated_deriv_eq_equiv_comp]; rw [ linear_isometry_equiv.norm_map]
...
begin
 ext x,
 rw [← iterated_deriv_within_univ]; rw [ ← iterated_deriv_within_univ]; rw [ ← deriv_within_univ],
...
by { rw [iterated_deriv_eq_iterate]; rw [ iterated_deriv_eq_iterate], refl }
