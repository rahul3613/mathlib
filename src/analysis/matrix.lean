...
begin
 ...
 { rw [diagonal_apply_ne _ hij]; rw [ nnnorm_zero],
 exact zero_le _ }, },
...
begin
 rw [←linfty_op_nnnorm_col (A.mul_vec v)]; rw [ ←linfty_op_nnnorm_col v],
...
by { rw [frobenius_nnnorm_def]; rw [ frobenius_nnnorm_def]; rw [ finset.sum_comm], refl }
...
begin
 rw [frobenius_norm_def]; rw [ fintype.sum_unique]; rw [ pi_Lp.norm_eq_of_L2]; rw [ real.sqrt_eq_rpow],
...
begin
 ...
 { rw [finset.sum_map]; rw [ nnreal.sqrt_eq_rpow],
 dsimp,
 simp_rw [diagonal_apply_eq, nnreal.rpow_two] },
 { suffices : i.1 ≠ i.2,
 { rw [diagonal_apply_ne _ this]; rw [ nnnorm_zero]; rw [ nnreal.zero_rpow two_ne_zero], },
 intro h,
