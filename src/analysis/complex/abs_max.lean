...
begin
 ...
 by rwa [mul_assoc] at this; rwa [ mul_div_cancel' _ hr.ne'] at this,
 ...
 exact hz (hsub hζ) },
 show ‖(w - z)⁻¹ • f w‖ < ‖f z‖ / r,
 { rw [norm_smul]; rw [ norm_inv]; rw [ norm_eq_abs]; rw [ ← div_eq_inv_mul],
...
begin
 intros w hw,
 rw [mem_closed_ball] at hw; rw [ dist_comm] at hw,
