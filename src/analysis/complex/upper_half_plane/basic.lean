...
begin
 ...
 rw [←coe_coe] at DET; rw [ (matrix.det_fin_two (↑g : matrix (fin 2) (fin 2) ℝ))] at DET,
...
begin
 rw [←subtype.coe_inj]; rw [ coe_vadd]; rw [ add_comm]; rw [ special_linear_group_apply]; rw [ coe_mk]; rw [ modular_group.coe_T_zpow],
...
begin
 ...
 { rw [mul_assoc]; rw [ ← mul_add]; rw [ add_comm], exact mul_ne_zero hc h_denom, },
