...
begin
 ...
 apply univ_mem',
 intro x,
 rw [mem_set_of_eq]; rw [ div_mul_cancel],
 rwa [ne.def]; rwa [ norm_eq_zero]
end
...
begin
 ...
 rw [is_O_const_mul_left_iff cne0]; rw [ is_O_norm_left],
end
...
begin
 ...
 rw [is_O_const_mul_right_iff cne0]; rw [ is_O_norm_right]
end
...
(h.neg_right.right_le_sub_of_lt_1 hc).neg_right.of_neg_left.congr rfl (λ x, rfl)
 (λ x, by rw [neg_sub]; rw [ sub_neg_eq_add])
...
begin
 ...
 rw [is_O_with] at hC; rw [ eventually_cofinite] at hC,
...
by rw [← nat.cofinite_eq_at_top]; rw [ is_O_cofinite_iff h]
