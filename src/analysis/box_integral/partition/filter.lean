...
begin
 ...
 λ hD, _, λ hD, _⟩,
 { rw [prepartition.distortion_bUnion_tagged]; rw [ finset.sup_le_iff],
 exact λ J hJ, (h J hJ).3 hD },
 { refine ⟨_, _, hc hD⟩,
 rw [π.Union_compl]; rw [ ← π.Union_bUnion_partition hp], refl }
end
...
begin
 ...
 rw [mem_set_of_eq] at hπ; rw [ prepartition.Union_top] at hπ,
