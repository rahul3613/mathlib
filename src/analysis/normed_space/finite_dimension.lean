...
begin
 ...
 rw [lipschitz_extension_constant]; rw [ ← mul_assoc],
...
{ continuous_to_fun :=
 ...
 simp_rw [linear_map.coe_comp, linear_equiv.coe_to_linear_map, function.comp_app, linear_map.coe_to_continuous_linear_map', linear_equiv.pi_ring_symm_apply],
...
begin
 ...
 { rw [mem_interior_iff_mem_nhds] at hx'; rw [ metric.nhds_basis_closed_ball.mem_iff] at hx',
 ...
 rw [metric.inf_dist_zero_of_mem_closure hx'.2]; rw [ dist_self] },
end
