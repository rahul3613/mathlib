...
begin
 ...
 have hφ₃ : φ x₀ = 1,
 { rw [←submodule.coe_mk x₀ (submodule.mem_span_singleton_self _)]; rw [ hφ₁]; rw [ linear_pmap.mk_span_singleton'_apply_self] },
 have hφ₄ : ∀ x ∈ s, φ x < 1,
 ...
 { rw [gauge_smul_of_nonneg h.le]; rw [ smul_eq_mul]; rw [ le_mul_iff_one_le_right h],
...
begin
 ...
 by rw [vadd_eq_add]; rw [ sub_add_sub_cancel']; rw [ sub_self]⟩,
