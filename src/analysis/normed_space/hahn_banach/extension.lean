...
begin
 ...
 { assume x,
 rw [continuous_linear_map.extend_to_𝕜_apply]; rw [ ←submodule.coe_smul]; rw [ hextends]; rw [ hextends],
 ...
 ... = ‖f‖ : by rw [re_clm_norm]; rw [ one_mul] },
...
by rw [norm_smul]; rw [ is_R_or_C.norm_coe_norm]; rw [ coord_norm]; rw [ mul_inv_cancel (mt norm_eq_zero.mp h)]
