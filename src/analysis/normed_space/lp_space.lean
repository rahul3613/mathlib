...
by dsimp [mem_ℓp]; rw [if_neg ennreal.top_ne_zero]; rw [ if_pos rfl]
...
begin
 ...
 rwa [h] at this ; rwa [ real.zero_rpow hp.ne'] at this },
...
by rw [lp.ext_iff]; rw [ coe_fn_zero]
...
begin
 ...
 simp_rw [←coe_nnnorm, ←_root_.coe_nnnorm, ←nnreal.coe_rpow, ←nnreal.coe_mul, nnreal.has_sum_coe] at hRHS hLHS,
...
begin
 ...
 rwa [inv_smul_smul₀ hc] at this; rwa [ norm_inv] at this; rwa [ mul_inv_cancel_left₀ (norm_ne_zero_iff.mpr hc)] at this,
end
...
protected lemma single_apply_self (p) (i : α) (a : E i) :
 lp.single p i a i = a :=
by rw [lp.single_apply]; rw [ dif_pos rfl]

protected lemma single_apply_ne (p) (i : α) (a : E i) {j : α} (hij : j ≠ i) :
 lp.single p i a j = 0 :=
by rw [lp.single_apply]; rw [ dif_neg hij]
...
begin
 ...
 have := lp.has_sum_norm hp' f,
 rw [has_sum] at this ⊢; rw [ metric.tendsto_nhds] at this ⊢,
 intros ε hε,
