...
begin
 ...
 { rw [pi_Lp.norm_eq_card]; rw [ lp.norm_eq_card_dsupport], refl },
 { rw [pi_Lp.norm_eq_csupr]; rw [ lp.norm_eq_csupr], refl },
 { rw [pi_Lp.norm_eq_sum h]; rw [ lp.norm_eq_tsum_rpow h]; rw [ tsum_fintype], refl },
end
