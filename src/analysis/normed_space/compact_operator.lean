...
⟨σ₁₂ c • K, hK.image $ continuous_id.const_smul (σ₁₂ c),
 by rw [image_subset_iff]; rw [ preimage_smul_setₛₗ _ _ _ f this.is_unit]; exact hrS c hc.le⟩
...
(by rwa [normed_space.is_vonN_bounded_iff]; rwa [ ← metric.bounded_iff_is_bounded])
...
begin
 ...
 rwa [mem_map]; rwa [ preimage_smul_setₛₗ _ _ _ f this]; rwa [ set_smul_mem_nhds_zero_iff (inv_ne_zero hcnz)],
 apply_instance },
...
begin
 ...
 refine ⟨T, hT, _⟩,
 rw [image_subset_iff] at ⊢ hTv; rw [ preimage_Union₂] at ⊢ hTv,
 intros x hx,
 specialize hTv hx,
 rw [mem_Union₂] at ⊢ hTv,
