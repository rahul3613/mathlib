...
begin
 ...
 ... = dist (e x) (e z) + dist x z : by rw [hx]; rw [ dist_comm]
 ...
 { intro e,
 dsimp [f],
 rw [dist_point_reflection_fixed]; rw [ ← e.dist_eq]; rw [ e.apply_symm_apply]; rw [ dist_point_reflection_self_real]; rw [ dist_comm] },
...
begin
 ...
 rwa [← eq_symm_apply] at hm; rwa [ to_isometry_equiv_symm] at hm; rwa [ point_reflection_symm] at hm; rwa [ coe_to_isometry_equiv] at hm; rwa [ coe_to_isometry_equiv] at hm; rwa [ point_reflection_self] at hm; rwa [ symm_apply_eq] at hm; rwa [ point_reflection_fixed_iff] at hm
end
