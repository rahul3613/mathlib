...
begin
 ...
 rwa [←nnreal.div_lt_iff (mul_pos ha ha).ne']; rwa [ div_eq_mul_inv]; rwa [ mul_inv]; rwa [ ←mul_assoc] } },
end
...
begin
 rw [←Sup_unit_ball_eq_nnnorm]; rw [ ←nnnorm_star]; rw [ ←@op_nnnorm_mul 𝕜 E]; rw [ ←Sup_unit_ball_eq_nnnorm],
 congr' 1,
