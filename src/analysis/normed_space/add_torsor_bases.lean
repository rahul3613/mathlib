...
begin
 ...
 { rw [b.convex_hull_eq_nonneg_coord]; rw [ set_of_forall], refl },
 ext,
...
begin
 ...
 { refine λ y, hεu _,
 simp only [f],
 rw [metric.mem_closed_ball]; rw [ line_map_apply]; rw [ dist_vadd_left]; rw [ norm_smul]; rw [ real.norm_eq_abs]; rw [ dist_eq_norm_vsub V y q]; rw [ abs_div]; rw [ abs_of_pos ε0]; rw [ abs_of_nonneg (norm_nonneg _)]; rw [ div_mul_comm],
 ...
 { rw [affine_span_eq_affine_span_line_map_units (ht₁ hq) w]; rw [ ht₃], },
end
...
begin
 ...
 { rw [hb] at this; rw [ subtype.range_coe_subtype] at this; rw [ set_of_mem_eq] at this,
 refine this.mono _,
 mono* },
...
by rw [← interior_convex_hull_nonempty_iff_affine_span_eq_top]; rw [ hs.convex_hull_eq]
