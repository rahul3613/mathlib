...
begin
 rw [← (euclidean_space.equiv ι 𝕜).comp_differentiable_within_at_iff]; rw [ differentiable_within_at_pi],
 refl
end
...
begin
 rw [← (euclidean_space.equiv ι 𝕜).comp_differentiable_at_iff]; rw [ differentiable_at_pi],
 refl
end
...
begin
 rw [← (euclidean_space.equiv ι 𝕜).comp_differentiable_on_iff]; rw [ differentiable_on_pi],
 refl
end
...
begin
 rw [← (euclidean_space.equiv ι 𝕜).comp_differentiable_iff]; rw [ differentiable_pi],
 refl
end
...
begin
 rw [← (euclidean_space.equiv ι 𝕜).comp_has_strict_fderiv_at_iff]; rw [ has_strict_fderiv_at_pi'],
 refl
end
...
begin
 rw [← (euclidean_space.equiv ι 𝕜).comp_has_fderiv_within_at_iff]; rw [ has_fderiv_within_at_pi'],
 refl
end
...
begin
 rw [← (euclidean_space.equiv ι 𝕜).comp_cont_diff_within_at_iff]; rw [ cont_diff_within_at_pi],
 refl
end
...
begin
 rw [← (euclidean_space.equiv ι 𝕜).comp_cont_diff_at_iff]; rw [ cont_diff_at_pi],
 refl
end
...
begin
 rw [← (euclidean_space.equiv ι 𝕜).comp_cont_diff_on_iff]; rw [ cont_diff_on_pi],
 refl
end
...
begin
 rw [← (euclidean_space.equiv ι 𝕜).comp_cont_diff_iff]; rw [ cont_diff_pi],
 refl
end
...
begin
 ...
 have h : 0 < 1 - ‖(y : E)‖^2, by rwa [mem_ball_zero_iff] at hy; rwa [ ← _root_.abs_one] at hy; rwa [ ← abs_norm] at hy; rwa [ ← sq_lt_sq] at hy; rwa [ one_pow] at hy; rwa [ ← sub_pos] at hy,
