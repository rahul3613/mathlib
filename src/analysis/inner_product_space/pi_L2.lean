...
by { rw [euclidean_space.single]; rw [ pi_Lp.equiv_symm_apply]; rw [ ← pi.single_apply i a j] }
...
begin
 simp_rw [orthonormal_iff_ite, euclidean_space.inner_single_left, map_one, one_mul, euclidean_space.single_apply],
 intros i j,
 refl,
end
...
by rw [← b.repr_symm_single i]; rw [ linear_isometry_equiv.apply_symm_apply]

protected lemma repr_apply_apply (b : orthonormal_basis ι 𝕜 E) (v : E) (i : ι) :
 b.repr v i = ⟪b i, v⟫ :=
begin
 classical,
 rw [← b.repr.inner_map_map (b i) v]; rw [ b.repr_self i]; rw [ euclidean_space.inner_single_left],
...
begin
 ...
 intros i j,
 rw [← b.repr.inner_map_map (b i) (b j)]; rw [ b.repr_self i]; rw [ b.repr_self j]; rw [ euclidean_space.inner_single_left]; rw [ euclidean_space.single_apply]; rw [ map_one]; rw [ one_mul],
end
...
by {rw [← basis.equiv_fun_apply]; rw [ orthonormal_basis.coe_to_basis_repr]; rw [ linear_isometry_equiv.coe_to_linear_equiv]}
...
begin
 ...
 convert this,
 ext i,
 rw [smul_hom_class.map_smul]; rw [ b.repr_apply_apply]; rw [ mul_comm],
 refl,
end
...
begin
 ...
 convert key,
 { rw [← v.equiv_fun.symm_apply_apply x]; rw [ v.equiv_fun_symm_apply] },
 { rw [← v.equiv_fun.symm_apply_apply y]; rw [ v.equiv_fun_symm_apply] }
end
...
by classical; rw [orthonormal_basis.mk]; rw [ _root_.basis.coe_to_orthonormal_basis]; rw [ basis.coe_mk]
...
begin
 ...
 rw coe_of_repr,
 dsimp,
 rw [← b.repr_symm_single]; rw [ linear_isometry_equiv.pi_Lp_congr_left_symm]; rw [ euclidean_space.pi_Lp_congr_left_single],
end
...
by { classical,
 rw [orthonormal_basis.repr_apply_apply]; rw [ b.repr_apply_apply]; rw [ orthonormal_basis.coe_reindex] }
...
begin
 ...
 norm_cast at this,
 rwa [← sqrt_norm_sq_eq_norm]; rwa [ sqrt_eq_one],
end
...
begin
 ...
 rwa [real.norm_eq_abs] at this ; rwa [ abs_eq (zero_le_one : (0 : ℝ) ≤ 1)] at this },
