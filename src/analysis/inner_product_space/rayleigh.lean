...
begin
 ...
 ext y,
 simp_rw [_root_.bit0, continuous_linear_map.comp_apply, continuous_linear_map.add_apply, innerSL_apply, fderiv_inner_clm_apply, id.def, continuous_linear_map.prod_apply, continuous_linear_map.id_apply, hT.apply_clm x₀ y, real_inner_comm _ x₀],
end
