...
begin
 ...
 apply if_neg,
 rw [ray_eq_iff]; rw [ same_ray_comm],
 intros h,
 simpa using
...
begin
 ...
 { symmetry,
 rw [e.to_basis.orientation_ne_iff_eq_neg]; rw [ h₁] },
 rw [o.volume_form_robust e h₁]; rw [ (-o).volume_form_robust_neg e h₂],
end
...
begin
 ...
 { rw [o.volume_form_robust (b.adjust_to_orientation o) (b.orientation_adjust_to_orientation o)]; rw [ b.abs_det_adjust_to_orientation] },
end
...
begin
 ...
 rw [o.volume_form_robust' b]; rw [ hb]; rw [ finset.abs_prod],
