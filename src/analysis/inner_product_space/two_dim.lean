...
begin
 rw [o.area_form_to_volume_form]; rw [ o.abs_volume_form_apply_of_pairwise_orthogonal],
...
{ norm_map' := λ x, begin
 ...
 rw [← real_inner_self_eq_norm_mul_norm]; rw [ o.inner_right_angle_rotation_aux₁_left],
...
begin
 ...
 rw [o.inner_right_angle_rotation_aux₁_right]; rw [ ← o.inner_right_angle_rotation_aux₁_left]; rw [ this]; rw [ inner_neg_right],
end
...
by rw [← o.inner_comp_right_angle_rotation]; rw [ o.inner_right_angle_rotation_right]; rw [ neg_neg]

@[simp] lemma area_form_right_angle_rotation_right (x y : E) : ω x (J y) = ⟪x, y⟫ :=
by rw [← o.inner_right_angle_rotation_left]; rw [ o.inner_comp_right_angle_rotation]
...
begin
 ...
 rw [real_inner_comm]; rw [ area_form_swap],
 simp,
end
...
begin
 ...
 rw [real_inner_comm a x]; rw [ o.area_form_swap x a],
...
begin
 rw [← complex.area_form]; rw [ ← hf]; rw [ o.area_form_map],
 simp,
end
...
lemma right_angle_rotation_map_complex (f : E ≃ₗᵢ[ℝ] ℂ)
 ...
 f (J x) = I * f x :=
begin
 rw [← complex.right_angle_rotation]; rw [ ← hf]; rw [ o.right_angle_rotation_map],
 simp,
end
...
begin
 rw [← complex.kahler]; rw [ ← hf]; rw [ o.kahler_map],
 simp,
end
