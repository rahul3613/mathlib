...
begin
 ...
 change _ ⊆ σ _ • _,
 rw [set.image_subset_iff]; rw [ preimage_smul_setₛₗ _ _ _ f this.is_unit],
...
begin
 ...
 { rw [mem_preimage] at hnr; rw [ mem_ball_zero_iff] at hnr; rw [ lt_inv (norm_pos_iff.mpr this) r_pos] at hnr; rw [ ← norm_inv] at hnr,
 rw [mem_preimage]; rw [ pi.smul_apply']; rw [ ← set.mem_inv_smul_set_iff₀ this],
...
begin
 rw [metric.nhds_basis_ball.is_vonN_bounded_basis_iff]; rw [ ← ball_norm_seminorm 𝕜 E],
...
begin
 rw [← metric.bounded_iff_is_bounded]; rw [ metric.bounded_iff_subset_ball (0 : E)],
 split,
 { intros h,
 ...
 rw [← ball_norm_seminorm 𝕜 E] at hρball; rw [ seminorm.smul_ball_zero (norm_pos_iff.1 $ hρ.trans ha)] at hρball; rw [ ball_norm_seminorm] at hρball; rw [ mul_one] at hρball,
...
by rw [normed_space.is_vonN_bounded_iff]; rw [ ←metric.bounded_iff_is_bounded]; rw [ bounded_iff_forall_norm_le]
