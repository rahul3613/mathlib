...
begin
 ...
 rw [finset.set_bUnion_insert]; rw [ absorbs_union]; rw [ hi],
 split; intro h,
...
begin
 ...
 (by rwa [mem_preimage]; rwa [ zero_smul]),
...
begin
 ...
 { rw [←image_smul]; rw [ image_union],
 apply union_subset_union,
 { rw [image_zero]; rw [ smul_zero],
 refl },
...
begin
 ...
 have := h _ ha.le,
 rwa [zero_subset] at this; rwa [ zero_mem_smul_set_iff] at this,
...
begin
 ...
 rw [show a = -((1 - a) / 2) + (a - -1)/2]; rw [ by ring]; rw [ add_smul]; rw [ neg_smul]; rw [ ←smul_neg],
