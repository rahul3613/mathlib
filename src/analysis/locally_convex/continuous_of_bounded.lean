...
⟨f, begin
 ...
 rw [continuous_at_def]; rw [ f.map_zero],
 intros U hU,
...
begin
 ...
 rw [norm_inv]; rw [ ←nat.cast_one]; rw [ ←nat.cast_add]; rw [ is_R_or_C.norm_nat_cast]; rw [ nat.cast_add]; rw [ nat.cast_one]; rw [ inv_le h' zero_lt_one],
 simp },
 intros n hn,
 ...
 rw [continuous_at] at h; rw [ map_zero] at h; rw [ bE'.tendsto_iff (nhds_basis_balanced 𝕜' F)] at h,
 push_neg at h,
 ...
 intros n,
 by_cases h : n = 0,
 { rw [h]; rw [ nat.cast_zero]; rw [ zero_smul],
