...
begin
 ...
 rw [set.mem_singleton_iff.mp hx]; rw [ map_zero]; rw [ linear_map.zero_apply]; rw [ norm_zero],
 exact zero_le_one,
end
...
begin
 ...
 by rw [B.map_smul]; rw [ linear_map.smul_apply]; rw [ algebra.id.smul_eq_mul]; rw [ norm_mul]; rw [ norm_inv]; rw [ mul_inv_cancel_left₀ hc.ne']
