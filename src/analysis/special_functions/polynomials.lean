...
begin
 ...
 rw [tendsto_const_mul_pow_at_top_iff] at this; rw [ ← pos_iff_ne_zero] at this; rw [ nat_degree_pos_iff_degree_pos] at this,
...
begin
 ...
 { rw [tendsto_const_mul_pow_nhds_iff hP] at this; rw [ nat_degree_eq_zero_iff_degree_le_zero] at this,
 exact this.symm } },
...
begin
 ...
 { rw [leading_coeff_eq_zero.1 hP0]; rw [ degree_zero],
 ...
 { rw [sub_lt_iff_lt_add] at h; rw [ zero_add] at h; rw [ int.coe_nat_lt] at h,
