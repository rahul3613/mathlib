...
begin
 ...
 rw [cpow_sub _ _ A]; rw [ cpow_one]; rw [ mul_div_left_comm]; rw [ mul_smul]; rw [ mul_smul]; rw [ ← smul_add],
...
begin
 ...
 { rw [add_sub_cancel]; rw [ id.def]; rw [ mul_one]; rw [ mul_comm]; rw [ mul_div_cancel _ hr] },
 { rw [id.def]; rw [ of_real_re], exact or.inl hx } },
 { -- harder case : `x < 0`
 ...
 conv_rhs { rw [mul_assoc]; rw [ mul_comm]; rw [ mul_div_cancel _ hr] } },
 ...
 rw [real_smul]; rw [ of_real_neg 1]; rw [ of_real_one], ring },
 ...
 { simp },
 { left, rwa [id.def]; rwa [ of_real_re]; rwa [ neg_pos] } },
end
...
begin
 ...
 simp_rw [rpow_sub_one hp.ne, smul_add, ← add_assoc, smul_smul, ← add_smul, ← mul_assoc, mul_comm (cos _), ← rpow_def_of_neg hp],
...
begin
 ...
 rw [cont_diff_succ_iff_deriv]; rw [ deriv_rpow_const' h1],
