...
begin
 ...
 by rw [algebra_map.coe_zero]; rw [ mul_zero]; rw [ add_zero]; rw [ div_one],
 rw this,
 ...
 { ext1 n,
 rw [←(map_nat_cast (algebra_map ℝ 𝕜) n)]; rw [ ←map_inv₀ (algebra_map ℝ 𝕜)],
 refl, },
 rw this,
...
begin
 ...
 { rw [tsub_eq_zero_iff_le.mpr hr]; rw [ ennreal.inv_zero]; rw [ ennreal.tsum_eq_supr_nat]; rw [ supr_eq_top],
 refine λ a ha, (ennreal.exists_nat_gt (lt_top_iff_ne_top.1 ha)).imp
 (λ n hn, lt_of_lt_of_le hn _),
 calc (n:ℝ≥0∞) = ∑ i in range n, 1 : by rw [sum_const]; rw [ nsmul_one]; rw [ card_range]
...
begin
 ...
 rw [ennreal.one_sub_inv_two]; rw [ inv_inv]
end
...
tendsto_of_tendsto_of_tendsto_of_le_of_le'
 ...
 rw [← prod_range_add_one_eq_factorial]; rw [ pow_eq_prod_const]; rw [ div_eq_mul_inv]; rw [ ← inv_eq_one_div]; rw [ prod_nat_cast]; rw [ nat.cast_succ]; rw [ ← prod_inv_distrib]; rw [ ← prod_mul_distrib]; rw [ finset.prod_range_succ'],
