...
begin
 ...
 { rw [← tendsto_sub_nhds_zero_iff] at clim; rw [ ← asymptotics.is_o_one_iff ℝ] at clim; rw [ asymptotics.is_o_iff] at clim,
 ...
 ... < d :
 begin
 rwa [inv_mul_cancel]; rwa [ one_mul],
 exact nat.cast_ne_zero.2 (ne_of_gt npos),
 end }
end
...
begin
 ...
 { rw [← div_eq_mul_inv]; rw [ ← div_eq_mul_inv]; rw [ div_le_div_iff _ (sub_pos.2 hc)], swap,
...
begin
 ...
 rw [mul_div_assoc']; rw [ mul_one]; rw [ div_le_div_iff], rotate,
 { apply sq_pos_of_pos,
 refine zero_lt_one.trans_le _,
