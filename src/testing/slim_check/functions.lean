...
begin
 ...
 erw [← option.mem_def]; erw [ mem_lookup_iff] at h₃,
...
begin
 ...
 rw h at hx,
 contradiction, },
 { rwa [list.apply_id_eq_self] at h; rwa [ list.apply_id_eq_self] at h; assumption },
end
...
begin
 ...
 { rw [← h₀]; rw [ ← h₁]; rw [ list.to_finmap'], clear h₀ h₁ xs₀ xs₁ hperm hnodup,
 induction xs,
 case list.nil
 ...
 { rwa [← h₀]; rwa [ hxs]; rwa [ hperm.nodup_iff], },
 { rwa [← hxs] at hperm; rwa [ h₀] at hperm; rwa [ h₁] at hperm, },
end
