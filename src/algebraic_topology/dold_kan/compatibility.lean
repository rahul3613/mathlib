...
begin
 ...
 erw [nat_trans.id_app]; erw [ nat_trans.id_app],
 ...
 dsimp,
 rw [comp_id]; rw [ eA.functor_unit_iso_comp]; rw [ e'.functor.map_id]; rw [ id_comp]; rw [ hF.inv_hom_id_app_assoc],
end
...
begin
 ...
 is_equivalence.of_equivalence],
 erw [nat_trans.id_app]; erw [ id_comp]; erw [ G.map_id]; erw [ comp_id]; erw [ comp_id],
