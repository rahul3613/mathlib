...
begin
 ...
 { rw [Q_is_eventually_constant (show n+1≤q, by linarith)]; rw [ hq],
 congr,
 ext,
 have hx := x.is_lt,
 ...
 rw [Q_eq]; rw [ homological_complex.sub_f_apply]; rw [ homological_complex.comp_f]; rw [ hq],
 symmetry,
 conv_rhs { rw [sub_eq_add_neg]; rw [ add_comm], },
