...
begin
 ...
 erw [Γ₀.obj.map_mono_on_summand_id_assoc]; erw [ Γ₀.obj.termwise.map_mono_δ₀]; erw [ splitting.ι_π_summand_eq_id]; erw [ comp_id], },
 { intros i hi,
 dsimp,
 simp only [preadditive.zsmul_comp, preadditive.comp_zsmul, assoc],
 erw [Γ₀.obj.map_mono_on_summand_id_assoc]; erw [ Γ₀.obj.termwise.map_mono_eq_zero]; erw [ zero_comp]; erw [ zsmul_zero],
 { intro h,
...
begin
 ext1,
 dsimp [N₁Γ₀],
 erw [id_comp]; erw [ comp_id]; erw [ comp_id],
 refl,
end
