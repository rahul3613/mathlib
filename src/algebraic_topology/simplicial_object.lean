...
{ obj := λ X,
 ...
 ext,
 dsimp,
 rw [category.comp_id]; rw [ category.comp_id]; rw [ ← F.map_comp]; rw [ ← F.map_comp]; rw [ ← nat_trans.comp_app],
 erw η.w,
 refl,
 end } }
...
{ obj := λ X,
 ...
 ext,
 dsimp,
 rw [category.id_comp]; rw [ category.id_comp]; rw [ ← F.map_comp]; rw [ ← F.map_comp]; rw [ ← nat_trans.comp_app],
 erw ← η.w,
 refl,
 end } }
