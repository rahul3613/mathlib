...
begin
 ...
 { rw [angle_eq_angle_of_angle_eq_pi_of_angle_eq_pi hbpd hapc]; rw [ angle_comm] },
 ...
 { rwa [angle_comm]; rwa [ angle_eq_angle_of_angle_eq_pi_of_angle_eq_pi], rwa angle_comm },
 all_goals { field_simp [mul_comm, hmul] } },
 have h₃ : dist d p = dist a p * dist c p / dist b p, { field_simp [mul_comm, hmul] },
 have h₄ : ∀ x y : ℝ, x * (y * x) = x * x * y := λ x y, by rw [mul_left_comm]; rw [ mul_comm],
