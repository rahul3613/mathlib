...
begin
 ...
 { by_cases hv : v = 0, { simp [hv] },
 rwa [sphere.second_inter] at hp ; rwa [ eq_comm] at hp ; rwa [ eq_vadd_iff_vsub_eq] at hp ; rwa [ vsub_self] at hp ; rwa [ eq_comm] at hp ; rwa [ smul_eq_zero] at hp ; rwa [ or_iff_left hv] at hp ; rwa [ div_eq_zero_iff] at hp ; rwa [ inner_self_eq_zero] at hp ; rwa [ or_iff_left hv] at hp ; rwa [ mul_eq_zero] at hp ; rwa [ or_iff_right (by norm_num : (-2 : ℝ) ≠ 0)] at hp },
 { rw [sphere.second_inter]; rw [ hp]; rw [ mul_zero]; rw [ zero_div]; rw [ zero_smul]; rw [ zero_vadd] }
end
...
begin
 ...
 { rcases h with h | h,
 { rwa h },
 { rwa [h]; rwa [ sphere.second_inter_mem] } },
 { rw [affine_subspace.mem_mk'_iff_vsub_mem] at hp'; rw [ submodule.mem_span_singleton] at hp',
 rcases hp' with ⟨r, hr⟩,
...
by rw [←neg_one_smul ℝ v]; rw [ s.second_inter_smul p v (by norm_num : (-1 : ℝ) ≠ 0)]
...
begin
 ...
 intro he,
 rw [eq_comm] at he; rw [ sphere.second_inter_eq_self_iff] at he; rw [ ←neg_neg (p' -ᵥ p)] at he; rw [ inner_neg_left] at he; rw [ neg_vsub_eq_vsub_rev] at he; rw [ neg_eq_zero] at he; rw [ eq_comm] at he,
...
begin
 ...
 { rintro h,
 rw [h] at hp'; rw [ mem_sphere.1 ((sphere.second_inter_mem _).2 hp)] at hp',
