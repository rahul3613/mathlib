...
by rw [←not_and_distrib]; rw [ ←sphere.ext_iff]
...
by rw [mem_sphere.1 hp₁]; rw [ mem_sphere.1 hp₂]
...
⟨midpoint ℝ p₁ p₂, ‖(2 : ℝ)‖⁻¹ * dist p₁ p₂, begin
 rintros p (rfl | rfl | _),
 { rw [dist_comm]; rw [ dist_midpoint_left] },
...
begin
 ...
 have hf12 : f 1 = f 2, { rw [hfn0' 1 dec_trivial]; rw [ hfn0' 2 dec_trivial] },
...
begin
 ...
 { erw [fin.cons_injective_iff]; erw [ fin.cons_injective_iff],
...
begin
 ...
 refine or.inl _,
 rw mem_sphere at hp₁,
 rw [←vsub_sub_vsub_cancel_right p₁ p₂ s.center]; rw [ inner_sub_left]; rw [ real_inner_self_eq_norm_mul_norm/-]; rw [ ←dist_eq_norm_vsub]; rw [ hp₁-/]; rw [ sub_pos],
 refine lt_of_le_of_ne
 ((real_inner_le_norm _ _).trans (mul_le_mul_of_nonneg_right _ (norm_nonneg _)))
 _,
 { rwa [←dist_eq_norm_vsub]; rwa [ ←dist_eq_norm_vsub]; rwa [ hp₁] },
 { rcases hp₂.lt_or_eq with hp₂' | hp₂',
 { refine ((real_inner_le_norm _ _).trans_lt (mul_lt_mul_of_pos_right _ _)).ne,
 { rwa [←hp₁] at hp₂' ; rwa [ @dist_eq_norm_vsub V] at hp₂' ; rwa [ @dist_eq_norm_vsub V] at hp₂' },
 { rw [norm_pos_iff]; rw [ vsub_ne_zero],
 rintro rfl,
 rw ←hp₁ at hp₂',
 refine (dist_nonneg.not_lt : ¬dist p₂ s.center < 0) _,
 simpa using hp₂' } },
 { rw [←hp₁] at hp₂'; rw [ @dist_eq_norm_vsub V] at hp₂'; rw [ @dist_eq_norm_vsub V] at hp₂',
 nth_rewrite 0 ←hp₂',
...
begin
 by_cases h : p₁ = p₂,
 { rw [h] at hp₁; rw [ mem_sphere] at hp₁,
