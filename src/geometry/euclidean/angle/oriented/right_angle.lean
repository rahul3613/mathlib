...
begin
 ...
 rw [o.oangle_eq_angle_of_sign_eq_one hs]; rw [ inner_product_geometry.angle_add_eq_arccos_of_inner_eq_zero (o.inner_eq_zero_of_oangle_eq_pi_div_two h)]
end
...
begin
 have hs : (o.oangle x (x + y)).sign = 1,
 { rw [oangle_sign_add_right]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [o.oangle_eq_angle_of_sign_eq_one hs]; rw [ inner_product_geometry.angle_add_eq_arcsin_of_inner_eq_zero (o.inner_eq_zero_of_oangle_eq_pi_div_two h) (or.inl (o.left_ne_zero_of_oangle_eq_pi_div_two h))]
end
...
begin
 have hs : (o.oangle x (x + y)).sign = 1,
 { rw [oangle_sign_add_right]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [o.oangle_eq_angle_of_sign_eq_one hs]; rw [ inner_product_geometry.angle_add_eq_arctan_of_inner_eq_zero (o.inner_eq_zero_of_oangle_eq_pi_div_two h) (o.left_ne_zero_of_oangle_eq_pi_div_two h)]
end
...
begin
 have hs : (o.oangle x (x + y)).sign = 1,
 { rw [oangle_sign_add_right]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [o.oangle_eq_angle_of_sign_eq_one hs]; rw [ real.angle.cos_coe]; rw [ inner_product_geometry.cos_angle_add_of_inner_eq_zero (o.inner_eq_zero_of_oangle_eq_pi_div_two h)]
end
...
begin
 have hs : (o.oangle x (x + y)).sign = 1,
 { rw [oangle_sign_add_right]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [o.oangle_eq_angle_of_sign_eq_one hs]; rw [ real.angle.sin_coe]; rw [ inner_product_geometry.sin_angle_add_of_inner_eq_zero (o.inner_eq_zero_of_oangle_eq_pi_div_two h) (or.inl (o.left_ne_zero_of_oangle_eq_pi_div_two h))]
end
...
begin
 have hs : (o.oangle x (x + y)).sign = 1,
 { rw [oangle_sign_add_right]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [o.oangle_eq_angle_of_sign_eq_one hs]; rw [ real.angle.tan_coe]; rw [ inner_product_geometry.tan_angle_add_of_inner_eq_zero (o.inner_eq_zero_of_oangle_eq_pi_div_two h)]
end
...
begin
 have hs : (o.oangle x (x + y)).sign = 1,
 { rw [oangle_sign_add_right]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [o.oangle_eq_angle_of_sign_eq_one hs]; rw [ real.angle.cos_coe]; rw [ inner_product_geometry.cos_angle_add_mul_norm_of_inner_eq_zero (o.inner_eq_zero_of_oangle_eq_pi_div_two h)]
end
...
begin
 have hs : (o.oangle x (x + y)).sign = 1,
 { rw [oangle_sign_add_right]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [o.oangle_eq_angle_of_sign_eq_one hs]; rw [ real.angle.sin_coe]; rw [ inner_product_geometry.sin_angle_add_mul_norm_of_inner_eq_zero (o.inner_eq_zero_of_oangle_eq_pi_div_two h)]
end
...
begin
 have hs : (o.oangle x (x + y)).sign = 1,
 { rw [oangle_sign_add_right]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [o.oangle_eq_angle_of_sign_eq_one hs]; rw [ real.angle.tan_coe]; rw [ inner_product_geometry.tan_angle_add_mul_norm_of_inner_eq_zero (o.inner_eq_zero_of_oangle_eq_pi_div_two h) (or.inl (o.left_ne_zero_of_oangle_eq_pi_div_two h))]
end
...
begin
 have hs : (o.oangle x (x + y)).sign = 1,
 { rw [oangle_sign_add_right]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [o.oangle_eq_angle_of_sign_eq_one hs]; rw [ real.angle.cos_coe]; rw [ inner_product_geometry.norm_div_cos_angle_add_of_inner_eq_zero (o.inner_eq_zero_of_oangle_eq_pi_div_two h) (or.inl (o.left_ne_zero_of_oangle_eq_pi_div_two h))]
end
...
begin
 have hs : (o.oangle x (x + y)).sign = 1,
 { rw [oangle_sign_add_right]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [o.oangle_eq_angle_of_sign_eq_one hs]; rw [ real.angle.sin_coe]; rw [ inner_product_geometry.norm_div_sin_angle_add_of_inner_eq_zero (o.inner_eq_zero_of_oangle_eq_pi_div_two h) (or.inr (o.right_ne_zero_of_oangle_eq_pi_div_two h))]
end
...
begin
 have hs : (o.oangle x (x + y)).sign = 1,
 { rw [oangle_sign_add_right]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [o.oangle_eq_angle_of_sign_eq_one hs]; rw [ real.angle.tan_coe]; rw [ inner_product_geometry.norm_div_tan_angle_add_of_inner_eq_zero (o.inner_eq_zero_of_oangle_eq_pi_div_two h) (or.inr (o.right_ne_zero_of_oangle_eq_pi_div_two h))]
end
...
begin
 ...
 rw [o.oangle_eq_angle_of_sign_eq_one hs]; rw [ inner_product_geometry.angle_sub_eq_arccos_of_inner_eq_zero (o.inner_rev_eq_zero_of_oangle_eq_pi_div_two h)]
end
...
begin
 have hs : (o.oangle y (y - x)).sign = 1,
 { rw [oangle_sign_sub_right_swap]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [o.oangle_eq_angle_of_sign_eq_one hs]; rw [ inner_product_geometry.angle_sub_eq_arcsin_of_inner_eq_zero (o.inner_rev_eq_zero_of_oangle_eq_pi_div_two h) (or.inl (o.right_ne_zero_of_oangle_eq_pi_div_two h))]
end
...
begin
 have hs : (o.oangle y (y - x)).sign = 1,
 { rw [oangle_sign_sub_right_swap]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [o.oangle_eq_angle_of_sign_eq_one hs]; rw [ inner_product_geometry.angle_sub_eq_arctan_of_inner_eq_zero (o.inner_rev_eq_zero_of_oangle_eq_pi_div_two h) (o.right_ne_zero_of_oangle_eq_pi_div_two h)]
end
...
begin
 have hs : (o.oangle y (y - x)).sign = 1,
 { rw [oangle_sign_sub_right_swap]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [o.oangle_eq_angle_of_sign_eq_one hs]; rw [ real.angle.cos_coe]; rw [ inner_product_geometry.cos_angle_sub_of_inner_eq_zero (o.inner_rev_eq_zero_of_oangle_eq_pi_div_two h)]
end
...
begin
 have hs : (o.oangle y (y - x)).sign = 1,
 { rw [oangle_sign_sub_right_swap]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [o.oangle_eq_angle_of_sign_eq_one hs]; rw [ real.angle.sin_coe]; rw [ inner_product_geometry.sin_angle_sub_of_inner_eq_zero (o.inner_rev_eq_zero_of_oangle_eq_pi_div_two h) (or.inl (o.right_ne_zero_of_oangle_eq_pi_div_two h))]
end
...
begin
 have hs : (o.oangle y (y - x)).sign = 1,
 { rw [oangle_sign_sub_right_swap]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [o.oangle_eq_angle_of_sign_eq_one hs]; rw [ real.angle.tan_coe]; rw [ inner_product_geometry.tan_angle_sub_of_inner_eq_zero (o.inner_rev_eq_zero_of_oangle_eq_pi_div_two h)]
end
...
begin
 have hs : (o.oangle y (y - x)).sign = 1,
 { rw [oangle_sign_sub_right_swap]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [o.oangle_eq_angle_of_sign_eq_one hs]; rw [ real.angle.cos_coe]; rw [ inner_product_geometry.cos_angle_sub_mul_norm_of_inner_eq_zero (o.inner_rev_eq_zero_of_oangle_eq_pi_div_two h)]
end
...
begin
 have hs : (o.oangle y (y - x)).sign = 1,
 { rw [oangle_sign_sub_right_swap]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [o.oangle_eq_angle_of_sign_eq_one hs]; rw [ real.angle.sin_coe]; rw [ inner_product_geometry.sin_angle_sub_mul_norm_of_inner_eq_zero (o.inner_rev_eq_zero_of_oangle_eq_pi_div_two h)]
end
...
begin
 have hs : (o.oangle y (y - x)).sign = 1,
 { rw [oangle_sign_sub_right_swap]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [o.oangle_eq_angle_of_sign_eq_one hs]; rw [ real.angle.tan_coe]; rw [ inner_product_geometry.tan_angle_sub_mul_norm_of_inner_eq_zero (o.inner_rev_eq_zero_of_oangle_eq_pi_div_two h) (or.inl (o.right_ne_zero_of_oangle_eq_pi_div_two h))]
end
...
begin
 have hs : (o.oangle y (y - x)).sign = 1,
 { rw [oangle_sign_sub_right_swap]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [o.oangle_eq_angle_of_sign_eq_one hs]; rw [ real.angle.cos_coe]; rw [ inner_product_geometry.norm_div_cos_angle_sub_of_inner_eq_zero (o.inner_rev_eq_zero_of_oangle_eq_pi_div_two h) (or.inl (o.right_ne_zero_of_oangle_eq_pi_div_two h))]
end
...
begin
 have hs : (o.oangle y (y - x)).sign = 1,
 { rw [oangle_sign_sub_right_swap]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [o.oangle_eq_angle_of_sign_eq_one hs]; rw [ real.angle.sin_coe]; rw [ inner_product_geometry.norm_div_sin_angle_sub_of_inner_eq_zero (o.inner_rev_eq_zero_of_oangle_eq_pi_div_two h) (or.inr (o.left_ne_zero_of_oangle_eq_pi_div_two h))]
end
...
begin
 have hs : (o.oangle y (y - x)).sign = 1,
 { rw [oangle_sign_sub_right_swap]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [o.oangle_eq_angle_of_sign_eq_one hs]; rw [ real.angle.tan_coe]; rw [ inner_product_geometry.norm_div_tan_angle_sub_of_inner_eq_zero (o.inner_rev_eq_zero_of_oangle_eq_pi_div_two h) (or.inr (o.left_ne_zero_of_oangle_eq_pi_div_two h))]
end
...
begin
 ...
 { rw [o.oangle_smul_right_of_neg _ _ hr]; rw [ o.oangle_neg_right h]; rw [ o.oangle_rotation_self_right h]; rw [ ←sub_eq_zero]; rw [ add_comm]; rw [ sub_neg_eq_add]; rw [ ←real.angle.coe_add]; rw [ ←real.angle.coe_add]; rw [ add_assoc]; rw [ add_halves]; rw [ ←two_mul]; rw [ real.angle.coe_two_pi],
 simpa using h },
 rw [←neg_inj] at ha; rw [ ←oangle_neg_orientation_eq_neg] at ha; rw [ neg_neg] at ha,
 rw [←neg_inj]; rw [ oangle_rev]; rw [ ←oangle_neg_orientation_eq_neg]; rw [ neg_inj]; rw [ oangle_rev]; rw [ (-o).oangle_add_right_eq_arctan_of_oangle_eq_pi_div_two ha]; rw [ norm_smul]; rw [ linear_isometry_equiv.norm_map]; rw [ mul_div_assoc]; rw [ div_self (norm_ne_zero_iff.2 h)]; rw [ mul_one]; rw [ real.norm_eq_abs]; rw [ abs_of_neg hr]; rw [ real.arctan_neg]; rw [ real.angle.coe_neg]; rw [ neg_neg] },
 { rw [zero_smul]; rw [ add_zero]; rw [ oangle_self]; rw [ real.arctan_zero]; rw [ real.angle.coe_zero] },
 { have ha : o.oangle x (r • o.rotation (π / 2 : ℝ) x) = (π / 2 : ℝ),
 { rw [o.oangle_smul_right_of_pos _ _ hr]; rw [ o.oangle_rotation_self_right h] },
 rw [o.oangle_add_right_eq_arctan_of_oangle_eq_pi_div_two ha]; rw [ norm_smul]; rw [ linear_isometry_equiv.norm_map]; rw [ mul_div_assoc]; rw [ div_self (norm_ne_zero_iff.2 h)]; rw [ mul_one]; rw [ real.norm_eq_abs]; rw [ abs_of_pos hr] }
end
...
begin
 ...
 rw [←neg_inj]; rw [ oangle_rev]; rw [ ←oangle_neg_orientation_eq_neg]; rw [ neg_inj]; rw [ ←neg_neg ((π / 2 : ℝ) : real.angle)]; rw [ ←rotation_neg_orientation_eq_neg]; rw [ add_comm],
...
by rw [o.oangle_add_right_smul_rotation_pi_div_two h]; rw [ real.angle.tan_coe]; rw [ real.tan_arctan]
...
lemma tan_oangle_add_left_smul_rotation_pi_div_two {x : V} (h : x ≠ 0) (r : ℝ) :
 ...
 r⁻¹ :=
by rw [o.oangle_add_left_smul_rotation_pi_div_two h]; rw [ real.angle.tan_coe]; rw [ real.tan_arctan]
...
begin
 have hs : (∡ p₂ p₃ p₁).sign = 1, { rw [oangle_rotate_sign]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
...
begin
 have hs : (∡ p₂ p₃ p₁).sign = 1, { rw [oangle_rotate_sign]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [oangle_eq_angle_of_sign_eq_one hs]; rw [ angle_eq_arcsin_of_angle_eq_pi_div_two (angle_eq_pi_div_two_of_oangle_eq_pi_div_two h) (or.inl (left_ne_of_oangle_eq_pi_div_two h))]
end
...
begin
 have hs : (∡ p₃ p₁ p₂).sign = 1, { rw [←oangle_rotate_sign]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [oangle_eq_angle_of_sign_eq_one hs]; rw [ angle_comm]; rw [ angle_eq_arcsin_of_angle_eq_pi_div_two (angle_rev_eq_pi_div_two_of_oangle_eq_pi_div_two h) (or.inr (left_ne_of_oangle_eq_pi_div_two h))]; rw [ dist_comm p₁ p₃]
end
...
begin
 have hs : (∡ p₂ p₃ p₁).sign = 1, { rw [oangle_rotate_sign]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [oangle_eq_angle_of_sign_eq_one hs]; rw [ angle_eq_arctan_of_angle_eq_pi_div_two (angle_eq_pi_div_two_of_oangle_eq_pi_div_two h) (right_ne_of_oangle_eq_pi_div_two h)]
end
...
begin
 have hs : (∡ p₃ p₁ p₂).sign = 1, { rw [←oangle_rotate_sign]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [oangle_eq_angle_of_sign_eq_one hs]; rw [ angle_comm]; rw [ angle_eq_arctan_of_angle_eq_pi_div_two (angle_rev_eq_pi_div_two_of_oangle_eq_pi_div_two h) (left_ne_of_oangle_eq_pi_div_two h)]
end
...
begin
 have hs : (∡ p₂ p₃ p₁).sign = 1, { rw [oangle_rotate_sign]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [oangle_eq_angle_of_sign_eq_one hs]; rw [ real.angle.sin_coe]; rw [ sin_angle_of_angle_eq_pi_div_two (angle_eq_pi_div_two_of_oangle_eq_pi_div_two h) (or.inl (left_ne_of_oangle_eq_pi_div_two h))]
end
...
begin
 have hs : (∡ p₃ p₁ p₂).sign = 1, { rw [←oangle_rotate_sign]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [oangle_eq_angle_of_sign_eq_one hs]; rw [ angle_comm]; rw [ real.angle.sin_coe]; rw [ sin_angle_of_angle_eq_pi_div_two (angle_rev_eq_pi_div_two_of_oangle_eq_pi_div_two h) (or.inr (left_ne_of_oangle_eq_pi_div_two h))]; rw [ dist_comm p₁ p₃]
end
...
begin
 have hs : (∡ p₂ p₃ p₁).sign = 1, { rw [oangle_rotate_sign]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [oangle_eq_angle_of_sign_eq_one hs]; rw [ real.angle.tan_coe]; rw [ tan_angle_mul_dist_of_angle_eq_pi_div_two (angle_eq_pi_div_two_of_oangle_eq_pi_div_two h) (or.inr (right_ne_of_oangle_eq_pi_div_two h))]
end
...
begin
 have hs : (∡ p₃ p₁ p₂).sign = 1, { rw [←oangle_rotate_sign]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [oangle_eq_angle_of_sign_eq_one hs]; rw [ angle_comm]; rw [ real.angle.tan_coe]; rw [ tan_angle_mul_dist_of_angle_eq_pi_div_two (angle_rev_eq_pi_div_two_of_oangle_eq_pi_div_two h) (or.inr (left_ne_of_oangle_eq_pi_div_two h))]
end
...
begin
 have hs : (∡ p₂ p₃ p₁).sign = 1, { rw [oangle_rotate_sign]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [oangle_eq_angle_of_sign_eq_one hs]; rw [ real.angle.cos_coe]; rw [ dist_div_cos_angle_of_angle_eq_pi_div_two (angle_eq_pi_div_two_of_oangle_eq_pi_div_two h) (or.inr (right_ne_of_oangle_eq_pi_div_two h))]
end
...
begin
 have hs : (∡ p₃ p₁ p₂).sign = 1, { rw [←oangle_rotate_sign]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [oangle_eq_angle_of_sign_eq_one hs]; rw [ angle_comm]; rw [ real.angle.cos_coe]; rw [ dist_comm p₁ p₃]; rw [ dist_div_cos_angle_of_angle_eq_pi_div_two (angle_rev_eq_pi_div_two_of_oangle_eq_pi_div_two h) (or.inr (left_ne_of_oangle_eq_pi_div_two h))]
end
...
begin
 have hs : (∡ p₂ p₃ p₁).sign = 1, { rw [oangle_rotate_sign]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [oangle_eq_angle_of_sign_eq_one hs]; rw [ real.angle.sin_coe]; rw [ dist_div_sin_angle_of_angle_eq_pi_div_two (angle_eq_pi_div_two_of_oangle_eq_pi_div_two h) (or.inl (left_ne_of_oangle_eq_pi_div_two h))]
end
...
begin
 have hs : (∡ p₃ p₁ p₂).sign = 1, { rw [←oangle_rotate_sign]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [oangle_eq_angle_of_sign_eq_one hs]; rw [ angle_comm]; rw [ real.angle.sin_coe]; rw [ dist_comm p₁ p₃]; rw [ dist_div_sin_angle_of_angle_eq_pi_div_two (angle_rev_eq_pi_div_two_of_oangle_eq_pi_div_two h) (or.inl (right_ne_of_oangle_eq_pi_div_two h))]
end
...
begin
 have hs : (∡ p₂ p₃ p₁).sign = 1, { rw [oangle_rotate_sign]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [oangle_eq_angle_of_sign_eq_one hs]; rw [ real.angle.tan_coe]; rw [ dist_div_tan_angle_of_angle_eq_pi_div_two (angle_eq_pi_div_two_of_oangle_eq_pi_div_two h) (or.inl (left_ne_of_oangle_eq_pi_div_two h))]
end
...
begin
 have hs : (∡ p₃ p₁ p₂).sign = 1, { rw [←oangle_rotate_sign]; rw [ h]; rw [ real.angle.sign_coe_pi_div_two] },
 rw [oangle_eq_angle_of_sign_eq_one hs]; rw [ angle_comm]; rw [ real.angle.tan_coe]; rw [ dist_div_tan_angle_of_angle_eq_pi_div_two (angle_rev_eq_pi_div_two_of_oangle_eq_pi_div_two h) (or.inl (right_ne_of_oangle_eq_pi_div_two h))]
end
