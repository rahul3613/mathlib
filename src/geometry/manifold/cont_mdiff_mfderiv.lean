...
begin
 ...
 simp_rw [function.comp, uncurry, ext_chart_at_prod, local_equiv.prod_coe_symm, model_with_corners.range_prod] at hf ⊢,
 ...
 { simp_rw [cont_mdiff_at_iff_source_of_mem_source (mem_chart_source G x₀), cont_mdiff_within_at_iff_cont_diff_within_at, function.comp],
 exact this },
 have : cont_mdiff_at J 𝓘(𝕜, E →L[𝕜] E') m
 ...
 rw [(ext_chart_at I (g x₂)).left_inv hx]; rw [ (ext_chart_at I' (f x₂ (g x₂))).left_inv h2x] },
 ...
 { exact λ x _, mem_range_self _ },
 { simp_rw [written_in_ext_chart_at, function.comp_apply, (ext_chart_at I (g x₂)).left_inv (mem_ext_chart_source I (g x₂))] },
...
begin
 ...
 simp only [hq] with mfld_simps },
 rw [this]; rw [ tangent_map_chart_symm]; rw [ hDl],
 { simp only [hq] with mfld_simps,
...
begin
 ...
 = (v, 0),
 { rw [fderiv_within_eq_fderiv]; rw [ differentiable_at.fderiv_prod],
 { simp },
