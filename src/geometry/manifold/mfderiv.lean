...
{ is_local :=
 ...
 rw [differentiable_within_at_prop]; rw [ differentiable_within_at_prop]; rw [ this],
 symmetry,
...
begin
 ...
 rw [nhds_within_inter]; rw [ nhds_within_inter]; rw [ nhds_within_ext_chart_at_target_eq]
end
...
begin
 rw [unique_mdiff_within_at]; rw [ ext_chart_at_preimage_inter_eq],
...
begin
 rw [has_mfderiv_within_at]; rw [ has_mfderiv_within_at]; rw [ ext_chart_at_preimage_inter_eq]; rw [ has_fderiv_within_at_inter']; rw [ continuous_within_at_inter' h],
...
by rwa [← univ_inter s] at h; rwa [ has_mfderiv_within_at_inter hs] at h; rwa [ has_mfderiv_within_at_univ] at h
...
begin
 rw [mdifferentiable_within_at]; rw [ mdifferentiable_within_at]; rw [ ext_chart_at_preimage_inter_eq]; rw [ differentiable_within_at_inter]; rw [ continuous_within_at_inter ht],
...
begin
 ...
 rwa [this] at h; rwa [ mdifferentiable_within_at_inter hs] at h; rwa [ mdifferentiable_within_at_univ] at h,
end
...
by rw [mfderiv_within]; rw [ mfderiv_within]; rw [ ext_chart_at_preimage_inter_eq]; rw [ mdifferentiable_within_at_inter ht]; rw [ fderiv_within_inter (ext_chart_at_preimage_mem_nhds I x ht)]
...
mdifferentiable_within_at_univ.symm.trans $
 ...
 by rw [continuous_within_at_univ]; rw [ set.preimage_univ]; rw [ set.univ_inter]
...
begin
 ...
 rw [← mfderiv_within_univ]; rw [ ← mfderiv_within_univ],
...
begin
 ...
 rw [← has_fderiv_within_at_inter' this] at hf ⊢; rw [ ← ext_chart_at_preimage_inter_eq] at hf ⊢,
...
by rw [← has_mfderiv_within_at_univ]; rw [ has_mfderiv_within_at_iff_has_fderiv_within_at]; rw [ has_fderiv_within_at_univ]
...
begin
 rw [← mfderiv_within_univ]; rw [ ← fderiv_within_univ],
...
begin
 ...
 rw [mfderiv_id]; rw [ mfderiv_const]; rw [ continuous_linear_map.inl]
end
...
begin
 ...
 rw [mfderiv_id]; rw [ mfderiv_const]; rw [ continuous_linear_map.inr]
end
...
begin
 ...
 rw [mfderiv_comp_of_eq hf ((mdifferentiable_at_fst I I').prod_mk (mdifferentiable_at_const _ _)) rfl]; rw [ mfderiv_comp_of_eq hf ((mdifferentiable_at_const _ _).prod_mk (mdifferentiable_at_snd I I')) rfl]; rw [ ← continuous_linear_map.comp_add]; rw [ (mdifferentiable_at_fst I I').mfderiv_prod (mdifferentiable_at_const (I.prod I') I')]; rw [ (mdifferentiable_at_const (I.prod I') I).mfderiv_prod (mdifferentiable_at_snd I I')]; rw [ mfderiv_fst]; rw [ mfderiv_snd]; rw [ mfderiv_const]; rw [ mfderiv_const],
 symmetry,
...
begin
 ...
 { rw [if_neg hf]] at hf; rw [ rw [← mdifferentiable_at_neg] at hf, rw [if_neg hf, neg_zero] },
end
...
begin
 ...
 rw [inter_comm] at B; rw [ differentiable_within_at_inter] at B,
...
{ inv_fun := (mfderiv I' I e.symm (e x)),
 ...
 conv_rhs { rw [← this]; rw [ ← he.symm_comp_deriv hx] },
 refl
 end,
 right_inv := λy, begin
 have : (continuous_linear_map.id 𝕜 _ :
 tangent_space I' (e x) →L[𝕜] tangent_space I' (e x)) y = y := rfl,
 conv_rhs { rw [← this]; rw [ ← he.comp_symm_deriv (e.map_source hx)] },
 rw e.left_inv hx,
 refl
 end,
 .. mfderiv I I' e x }
...
begin
 ...
 rw [← A]; rw [ mem_inter_iff]; rw [ and.congr_right_iff],
 intro hx,
 ...
 { rw [nhds_within_le_iff]; rw [ mem_nhds_within],
 ...
 rwa [← preimage_inter] at B ; rwa [ model_with_corners.right_inv _ hx.2] at B }
end
