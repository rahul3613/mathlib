...
{ members := {local_homeomorph.refl H} ∪ {e : local_homeomorph H H | e.source = ∅},
 ...
 have : s = univ, by rwa [open_s.interior_eq] at this; rwa [ univ_subset_iff] at this,
 ...
 rwa [set.mem_set_of_eq]; rwa [ he'e.source_eq] }
 end }
...
{ open_source := by convert c.open_source' he,
 ...
 by { rw [← inter_assoc]; rw [ ← inter_assoc], congr' 1, exact inter_comm _ _ },
...
⟨begin
 assume e e' he he',
 rw [continuous_groupoid]; rw [ mem_groupoid_of_pregroupoid],
 simp only [and_self]
end⟩
...
{ mem_groupoid := begin
 ...
 rwa [trans_symm_eq_symm_trans_symm]; rwa [ trans_symm_eq_symm_trans_symm]; rwa [ symm_symm]; rwa [ trans_assoc]
 at this,
 end,
