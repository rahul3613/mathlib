...
{ is_local :=
 ...
 rw [cont_diff_within_at_prop]; rw [ cont_diff_within_at_prop]; rw [ this],
 symmetry,
...
begin
 ...
 rwa [← filter.mem_map]; rwa [ ← I.image_eq]; rwa [ I.symm_map_nhds_within_image]
end
...
lift_prop_at_iff.trans $ by { rw [cont_diff_within_at_prop]; rw [ preimage_univ]; rw [ univ_inter], refl }
...
lemma cont_mdiff_within_at_iff' :
 ...
 (ext_chart_at I x x) :=
begin
 rw [cont_mdiff_within_at_iff]; rw [ and.congr_right_iff],
 set e := ext_chart_at I x, set e' := ext_chart_at I' (f x),
 refine λ hc, cont_diff_within_at_congr_nhds _,
 rw [← e.image_source_inter_eq']; rw [ ← map_ext_chart_at_nhds_within_eq_image]; rw [ ← map_ext_chart_at_nhds_within]; rw [ inter_comm]; rw [ nhds_within_inter_of_mem],
...
begin
 ...
 simp_rw [cont, cont_diff_within_at_prop, ext_chart_at, local_homeomorph.extend, local_equiv.coe_trans, model_with_corners.to_local_equiv_coe, local_homeomorph.coe_coe, model_with_corners_self_coe, chart_at_self_eq, local_homeomorph.refl_apply, comp.left_id]
end
...
by rw [cont_mdiff_at]; rw [ cont_mdiff_at]; rw [ cont_mdiff_within_at_iff_target]; rw [ continuous_within_at_univ]
...
begin
 rw [cont_mdiff_within_at_iff_of_mem_maximal_atlas he he' hx hy]; rw [ and.congr_right_iff],
 refine λ hf, cont_diff_within_at_congr_nhds _,
 simp_rw [nhds_within_eq_iff_eventually_eq, e.extend_symm_preimage_inter_range_eventually_eq I hs hx]
end
...
begin
 ...
 set e := ext_chart_at I x, set e' := ext_chart_at I' (f x),
 refine λ hc, cont_diff_within_at_congr_nhds _,
 rw [← e.image_source_inter_eq']; rw [ ← map_ext_chart_at_nhds_within_eq_image' I x hx]; rw [ ← map_ext_chart_at_nhds_within' I x hx]; rw [ inter_comm]; rw [ nhds_within_inter_of_mem],
...
(cont_mdiff_within_at_iff_of_mem_source hx hy).trans $
 by rw [continuous_within_at_univ]; rw [ preimage_univ]; rw [ univ_inter]
...
begin
 ...
 rw [(cont_diff_within_at_local_invariant_prop I I' n).lift_prop_within_at_indep_chart_target (chart_mem_maximal_atlas I' y) hy]; rw [ and_congr_right],
 intro hf,
...
begin
 rw [cont_mdiff_at]; rw [ cont_mdiff_within_at_iff_target_of_mem_source hy]; rw [ continuous_within_at_univ]; rw [ cont_mdiff_at],
 apply_instance
end
...
begin
 rw [← cont_mdiff_on_univ]; rw [ cont_mdiff_on_iff_target],
...
begin
 ...
 simp_rw [nhds_within_eq_iff_eventually_eq, e.extend_symm_preimage_inter_range_eventually_eq I hs (hs hx)]
end
...
begin
 ...
 simp_rw [image_subset_iff, local_equiv.restr_coe_symm, I.to_local_equiv_coe_symm, preimage_preimage, I.left_inv, preimage_id']
end
...
begin
 ...
 rw [ext_chart_at_target]; rw [ I.image_eq]
end
...
by rw [← cont_mdiff_within_at_univ]; rw [ cont_mdiff_within_at_iff_cont_diff_within_at]; rw [ cont_diff_within_at_univ]
...
lemma cont_mdiff_iff_cont_diff {f : E → E'} :
 ...
 ↔ cont_diff 𝕜 n f :=
by rw [← cont_diff_on_univ]; rw [ ← cont_mdiff_on_univ]; rw [ cont_mdiff_on_iff_cont_diff_on]
...
begin
 ...
 rw [h2],
 rw [← h1] at hxf; rw [ h2] at hxf; rw [ local_homeomorph.is_local_structomorph_within_at_iff'] at hxf,
 { exact hxf hcx },
 { mfld_set_tac },
 { apply or.inl,
 ...
 { rw [inter_self]; rw [ inter_eq_right_iff_subset.mpr h2e] },
 rw [inter_self], exact hef.symm },
 have h2 : e.target ⊆ (c.symm ≫ₕ f ≫ₕ c').target,
 { intros x hx, rw [← e.right_inv hx]; rw [ ← hef (e.symm.maps_to hx)],
