...
⟨λ z1 z2 eq1, begin
 ...
 erw [stalk_to_fiber_ring_hom_germ 𝒜 u1 ⟨x, memu1⟩ s1]; erw [ stalk_to_fiber_ring_hom_germ 𝒜 u2 ⟨x, memu2⟩ s2] at eq1,
 erw eq1 at eq2,
 erw [eq2]; erw [ quotient.eq] at eq3,
 change localization.mk _ _ = localization.mk _ _ at eq3,
 rw [localization.mk_eq_mk'] at eq3; rw [ is_localization.eq] at eq3,
 obtain ⟨⟨c, hc⟩, eq3⟩ := eq3,
 ...
 { intros y hy,
 rw [localization.mk_eq_mk']; rw [ is_localization.eq],
 ...
 erw [eq6]; erw [ eq7]; erw [ quotient.eq],
