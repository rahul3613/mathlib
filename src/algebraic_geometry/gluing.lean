...
begin
 ...
 apply forall_congr,
 intro i,
 erw [← set.preimage_comp]; erw [ ← coe_comp]; erw [ ι_iso_carrier_inv]
end
...
begin
 ...
 erw [ι_from_glued]; erw [ ι_from_glued] at h,
 ...
 { erw [pullback_symmetry_hom_comp_fst]; erw [ is_limit.cone_point_unique_up_to_iso_hom_comp _ _ walking_cospan.right], refl }
end
...
begin
 rw [← ι_from_glued]; rw [ category.assoc],
 erw [is_iso.hom_inv_id_assoc]; erw [ multicoequalizer.π_desc],
end
