...
⟨e'.to_Lhom.comp e.to_Lhom, e.inv_Lhom.comp e'.inv_Lhom,
 by rw [Lhom.comp_assoc]; rw [ ← Lhom.comp_assoc e'.inv_Lhom]; rw [ e'.left_inv]; rw [ Lhom.id_comp]; rw [ e.left_inv],
 by rw [Lhom.comp_assoc]; rw [ ← Lhom.comp_assoc e.to_Lhom]; rw [ e.right_inv]; rw [ Lhom.id_comp]; rw [ e'.right_inv]⟩
...
by rw [with_constants]; rw [ card_sum]; rw [ card_constants_on]
...
{ to_Lhom := Lhom_with_constants L α,
 ...
 left_inv := by rw [Lhom_with_constants]; rw [ Lhom.sum_elim_comp_inl],
