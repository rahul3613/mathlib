...
begin
 ...
 rw [finset.sum_eq_single_of_mem i (finset.mem_univ _) (λ j _ hji, _)]; rw [ pi.single_eq_same],
 rw [pi.single_eq_of_ne hji]; rw [ map_zero], },
 { rintros h x,
...
begin
 ...
 rw [pi_apply] at hx; rw [ finset.sum_eq_zero_iff_of_nonneg (λ j hj, _)] at hx,
