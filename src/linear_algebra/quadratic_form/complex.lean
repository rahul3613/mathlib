...
begin
 ...
 ext1 v,
 erw [basis_repr_apply]; erw [ weighted_sum_squares_apply]; erw [ weighted_sum_squares_apply],
 ...
 { rw [this], ring },
 rw [← complex.cpow_add _ _ (w j).ne_zero]; rw [ show -(1 / 2 : ℂ) + -(1 / 2) = -1]; rw [ by simp [← two_mul],
