...
begin
 ...
 rw [foldl_ι]; rw [ linear_map.mk₂_apply]; rw [ alternating_map.curry_left_apply_apply],
 congr,
end
...
by rw [algebra.algebra_map_eq_smul_one]; rw [ map_smul]; rw [ lift_alternating_one]
...
begin
 ...
 { rw [list.of_fn_zero]; rw [ list.prod_nil]; rw [ lift_alternating_one]; rw [ subsingleton.elim 0 v] },
 { rw [list.of_fn_succ]; rw [ list.prod_cons]; rw [ lift_alternating_ι_mul]; rw [ ih]; rw [ alternating_map.curry_left_apply_apply],
 congr',
...
begin
 ...
 { rw [lift_alternating_algebra_map]; rw [ lift_alternating_algebra_map]; rw [ map_smul]; rw [ linear_map.comp_alternating_map_apply] },
 { rw [map_add]; rw [ map_add]; rw [ map_add]; rw [ hx]; rw [ hy] },
 { rw [lift_alternating_ι_mul]; rw [ lift_alternating_ι_mul]; rw [ ←hx],
...
begin
 ...
 { rw [lift_alternating_algebra_map]; rw [ ι_multi_zero_apply]; rw [ algebra.algebra_map_eq_smul_one] },
 { rw [map_add]; rw [ hx]; rw [ hy] },
 { simp_rw [lift_alternating_ι_mul, ι_multi_succ_curry_left, lift_alternating_comp, linear_map.comp_apply, linear_map.mul_left_apply, hx] },
end
...
{ to_fun := lift_alternating,
 ...
 by rw [lift_alternating_ι_multi]; rw [ linear_map.comp_id]}
