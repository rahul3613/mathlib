...
begin
 rw [graded_algebra.ι_apply]; rw [ direct_sum.of_mul_of],
...
begin
 ...
 { obtain ⟨_, rfl⟩ := hm,
 rw [alg_hom.map_mul]; rw [ ih]; rw [ graded_algebra.lift_ι]; rw [ lift_ι_apply]; rw [ graded_algebra.ι_apply R M]; rw [ direct_sum.of_mul_of],
...
graded_algebra.of_alg_hom _
 ...
 rw [lift_ι_apply]; rw [ graded_algebra.ι_apply R M]; rw [ direct_sum.coe_alg_hom_of]; rw [ subtype.coe_mk],
 end)
