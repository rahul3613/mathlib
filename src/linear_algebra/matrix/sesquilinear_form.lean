...
begin
 rw [matrix.to_linear_map₂'_aux]; rw [ mk₂'ₛₗ_apply],
...
begin
 ...
 simp_rw [pi.basis_fun_apply, matrix.to_linear_map₂'_aux_std_basis, linear_map.to_matrix₂_aux_apply],
end
...
begin
 simp_rw [matrix.to_linear_map₂'_apply, matrix.dot_product, matrix.mul_vec, matrix.dot_product],
...
by { rw [←linear_map.compl₂_id (B.comp f)]; rw [ ←linear_map.compl₁₂], simp }

lemma linear_map.to_matrix₂'_compl₂ (B : (n → R) →ₗ[R] (m → R) →ₗ[R] R)
 (f : (m' → R) →ₗ[R] (m → R)) : (B.compl₂ f).to_matrix₂' = B.to_matrix₂' ⬝ f.to_matrix' :=
by { rw [←linear_map.comp_id B]; rw [ ←linear_map.compl₁₂], simp }
...
ext (λ i j, by rw [linear_map.to_matrix₂_apply]; rw [ linear_map.to_matrix₂_aux_apply])
...
by { ext B, rw [linear_map.to_matrix₂_apply]; rw [ linear_map.to_matrix₂'_apply]; rw [ pi.basis_fun_apply]; rw [ pi.basis_fun_apply] }
...
begin
 rw [←linear_map.compl₂_id (B.comp f)]; rw [ ←linear_map.compl₁₂]; rw [ linear_map.to_matrix₂_compl₁₂ b₁ b₂],
 simp,
end
...
by { rw [←linear_map.comp_id B]; rw [ ←linear_map.compl₁₂]; rw [ linear_map.to_matrix₂_compl₁₂ b₁ b₂], simp }
...
begin
 ...
 rw [←linear_map.to_matrix₂_compl₁₂]; rw [ linear_map.compl₁₂_id_id],
end
...
by rw [linear_map.to_matrix₂_comp b₁]; rw [ to_matrix_to_lin]; rw [ transpose_transpose]
...
by rw [linear_map.to_matrix₂_compl₂ b₁]; rw [ to_matrix_to_lin]
...
begin
 ...
 simp_rw [h, linear_map.to_matrix₂'_comp, linear_map.to_matrix₂'_compl₂, linear_map.to_matrix'_to_lin', linear_map.to_matrix'_to_linear_map₂'],
 refl,
end
...
begin
 ...
 simp_rw [h, linear_map.to_matrix₂_comp b₂ b₂, linear_map.to_matrix₂_compl₂ b₁ b₁, linear_map.to_matrix_to_lin, linear_map.to_matrix₂_to_linear_map₂],
 refl,
end
...
begin
 ...
 split,
 { rintros ⟨f, hf, hA⟩,
 have hf' : f = A₁.to_lin' := by rw [←hA]; rw [ matrix.to_lin'_to_matrix'], rw hf' at hf,
...
by rw [←matrix.separating_left_to_linear_map₂'_iff_separating_left_to_linear_map₂]; rw [ matrix.separating_left_to_linear_map₂'_iff]
...
by rw [matrix.separating_left_to_linear_map₂'_iff]; rw [ matrix.nondegenerate_iff_det_ne_zero]
