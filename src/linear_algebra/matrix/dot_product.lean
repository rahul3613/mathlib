...
begin
 rw [dot_product]; rw [ finset.sum_eq_single i]; rw [ linear_map.std_basis_same],
 exact λ _ _ hb, by rw [linear_map.std_basis_ne _ _ _ _ hb]; rw [ mul_zero],
...
by rw [dot_product_std_basis_eq_mul]; rw [ mul_one]
...
begin
 funext x,
 classical,
 rw [← dot_product_std_basis_one v x]; rw [ ← dot_product_std_basis_one w x]; rw [ h],
end
