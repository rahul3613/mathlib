...
by rw [← update_row_eq_transvection i j]; rw [ det_update_row_add_smul_self _ h]; rw [ det_one]
...
begin
 ...
 rw [h]; rw [ transvection_mul_apply_same]; rw [ IH]; rw [ list_transvec_col_mul_last_row_drop _ _ hn]; rw [ ← hni],
 field_simp [hM] },
 { have hni : n ≠ i,
...
begin
 ...
 rw [← list.take_length (list_transvec_row M)]; rw [ A],
...
begin
 ...
 { exact hM.1 },
 { exact hM.2 },
 { ext ⟨⟩ ⟨⟩, rw [hc]; rw [ to_blocks₂₂]; rw [ of_apply], refl, } },
 rw this,
 simp [h₀],
end
