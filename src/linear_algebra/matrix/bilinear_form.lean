...
begin
 rw [matrix.to_bilin'_aux]; rw [ coe_fn_mk]; rw [ sum_eq_single i]; rw [ sum_eq_single j],
...
begin
 ...
 rw [pi.basis_fun_apply]; rw [ pi.basis_fun_apply]; rw [ matrix.to_bilin'_aux_std_basis]; rw [ bilin_form.to_matrix_aux_apply]
end
...
by rw [bilin_form.to_matrix]; rw [ linear_equiv.trans_apply]; rw [ bilin_form.to_matrix'_apply]; rw [ congr_apply]; rw [ b.equiv_fun_symm_std_basis]; rw [ b.equiv_fun_symm_std_basis]

@[simp] lemma matrix.to_bilin_apply (M : matrix n n R₂) (x y : M₂) :
 matrix.to_bilin b M x y = ∑ i j, b.repr x i * M i j * b.repr y j :=
begin
 rw [matrix.to_bilin]; rw [ bilin_form.to_matrix]; rw [ linear_equiv.symm_trans_apply]; rw [ ← matrix.to_bilin'],
...
ext (λ i j, by rw [bilin_form.to_matrix_apply]; rw [ bilin_form.to_matrix_aux_apply])
...
by { ext B, rw [bilin_form.to_matrix_apply]; rw [ bilin_form.to_matrix'_apply]; rw [ pi.basis_fun_apply]; rw [ pi.basis_fun_apply] }
...
by rw [← linear_map.to_matrix_id_eq_basis_to_matrix]; rw [ ← bilin_form.to_matrix_comp]; rw [ bilin_form.comp_id_id]
...
by rw [B.to_matrix_comp_left b]; rw [ to_matrix_to_lin]; rw [ transpose_transpose]
...
by rw [B.to_matrix_comp_right b]; rw [ to_matrix_to_lin]
...
begin
 ...
 rw [h]; rw [ bilin_form.to_matrix'_comp_left]; rw [ bilin_form.to_matrix'_comp_right]; rw [ linear_map.to_matrix'_to_lin']; rw [ linear_map.to_matrix'_to_lin']; rw [ bilin_form.to_matrix'_to_bilin']; rw [ bilin_form.to_matrix'_to_bilin'],
 refl,
end
...
begin
 ...
 rw [h]; rw [ bilin_form.to_matrix_comp_left]; rw [ bilin_form.to_matrix_comp_right]; rw [ linear_map.to_matrix_to_lin]; rw [ linear_map.to_matrix_to_lin]; rw [ bilin_form.to_matrix_to_bilin]; rw [ bilin_form.to_matrix_to_bilin],
 refl,
end
...
begin
 ...
 conv_lhs { to_rhs, rw [mul_assoc]; rw [ mul_assoc], congr, skip, rw ←mul_assoc, },
 conv_rhs { rw [mul_assoc]; rw [ mul_assoc], conv { to_lhs, congr, skip, rw ←mul_assoc }, },
 exact this, },
...
by rw [←matrix.nondegenerate_to_bilin'_iff_nondegenerate_to_bilin]; rw [ matrix.nondegenerate_to_bilin'_iff]
...
by rw [matrix.nondegenerate_to_bilin'_iff]; rw [ matrix.nondegenerate_iff_det_ne_zero]
...
by rw [←matrix.nondegenerate_iff_det_ne_zero]; rw [ nondegenerate_to_matrix_iff]
