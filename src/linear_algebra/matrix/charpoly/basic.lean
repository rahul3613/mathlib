...
begin
 ...
 by_cases h : i = j,
 { subst h, rw [charmatrix_apply_eq]; rw [ coeff_sub],
 simp only [coeff_X, coeff_C],
 split_ifs; simp, },
 { rw [charmatrix_apply_ne _ _ _ h]; rw [ coeff_X]; rw [ coeff_neg]; rw [ coeff_C]; rw [ coeff_C],
 split_ifs; simp [h], }
end
...
begin
 ...
 rw [mat_poly_equiv_smul_one] at h; rw [ eval_map] at h,
