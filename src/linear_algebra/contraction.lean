...
begin
 ...
 rw [and_iff_not_or_not] at hij; rw [ not_not] at hij, cases hij; simp [hij],
end
...
by rw [←dual_tensor_hom_equiv_of_basis_apply b]; rw [ linear_equiv.symm_apply_apply]
...
by rw [←dual_tensor_hom_equiv_of_basis_apply b]; rw [ linear_equiv.apply_symm_apply]
...
by rw [←linear_equiv.coe_to_linear_map]; rw [ ltensor_hom_equiv_hom_ltensor_to_linear_map]
...
by rw [←linear_equiv.coe_to_linear_map]; rw [ rtensor_hom_equiv_hom_rtensor_to_linear_map]
...
by rw [←linear_equiv.coe_to_linear_map]; rw [ hom_tensor_hom_equiv_to_linear_map]
