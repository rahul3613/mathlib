...
begin
 ext ⟨i, j⟩ ⟨i', j'⟩,
 simp_rw [matrix.kronecker_map_apply, to_matrix_apply, basis.tensor_product_apply, tensor_product.map_tmul, basis.tensor_product_repr_tmul_apply],
end
...
by rw [←linear_equiv.eq_symm_apply]; rw [ to_lin_symm]; rw [ tensor_product.to_matrix_map]; rw [ to_matrix_to_lin]; rw [ to_matrix_to_lin]
...
begin
 ext ⟨i, j⟩ ⟨i', j'⟩,
 simp_rw [to_matrix_apply, basis.tensor_product_apply, linear_equiv.coe_coe, tensor_product.comm_tmul, basis.tensor_product_repr_tmul_apply, matrix.submatrix_apply, prod.swap_prod_mk, id.def, basis.repr_self_apply, matrix.one_apply, prod.ext_iff, ite_and, @eq_comm _ i', @eq_comm _ j'],
 split_ifs; simp,
end
...
begin
 ext ⟨i, j, k⟩ ⟨⟨i', j'⟩, k'⟩,
 simp_rw [to_matrix_apply, basis.tensor_product_apply, linear_equiv.coe_coe, tensor_product.assoc_tmul, basis.tensor_product_repr_tmul_apply, matrix.submatrix_apply, equiv.prod_assoc_apply, id.def, basis.repr_self_apply, matrix.one_apply, prod.ext_iff, ite_and, @eq_comm _ i', @eq_comm _ j', @eq_comm _ k'],
 split_ifs; simp,
end
