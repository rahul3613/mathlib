...
begin
 ...
 rw [linear_map.compr₂_apply]; rw [ linear_map.compr₂_apply]; rw [ tensor_product.mk_apply],
 ...
 rw [tensor_product.tmul_sum]; rw [ linear_equiv.map_sum], simp only [assoc_symm_tmul],
...
begin
 ...
 rw [tensor_product.sum_tmul]; rw [ linear_equiv.map_sum], simp only [assoc_tmul],
