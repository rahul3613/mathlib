...
calc
 ...
 : by { rw [C_mul']; rw [ aeval_def], simp [algebra_map, algebra.to_ring_hom], }
 ... = (aeval f q).ker
...
begin
 ...
 { intros n a hna,
 rw [mul_comm]; rw [ pow_succ]; rw [ mul_assoc]; rw [ alg_hom.map_mul]; rw [ linear_map.mul_apply]; rw [ mul_comm]; rw [ hna],
...
begin
 ...
 rw [has_eigenvalue]; rw [ eigenspace],
 intro con,
 ...
 { rw [hp] at h_deg; rw [ degree_mul] at h_deg; rw [ degree_X_sub_C] at h_deg; rw [ polynomial.degree_eq_nat_degree p_ne_0] at h_deg,
 norm_cast at h_deg,
 linarith, },
