...
begin
 ...
 { rintro ⟨a, ha⟩, refine ⟨units.mk0 a (λ c, hv.symm _), ha⟩, rwa [c] at ha ; rwa [ zero_smul] at ha }
end
...
begin
 ...
 rw [this] at ha; rw [ ← f.map_smulₛₗ] at ha,
 exact hf ha,
end
