...
begin
 ...
 rw [hp.pow_min_fac hk.ne']; rw [ hp.factorization_pow]; rw [ finsupp.single_eq_same],
end
...
begin
 ...
 rw [pos_iff_ne_zero]; rw [ ←finsupp.mem_support_iff]; rw [ nat.factor_iff_mem_factorization]; rw [ nat.mem_factors_iff_dvd hn' (nat.min_fac_prime hn)],
...
begin
 ...
 split,
 { rintros ⟨hp, hk, hn⟩,
 exact ⟨hk, by rw [←hn]; rw [ nat.prime.factorization_pow hp]⟩ },
 { rintros ⟨hk, hn⟩,
 have hn0 : n ≠ 0,
 { rintro rfl,
...
begin
 ...
 { rw [←finsupp.not_mem_support_iff]; rw [ ←finsupp.not_mem_support_iff]; rw [ ←not_and_distrib]; rw [ ←finset.mem_inter],
