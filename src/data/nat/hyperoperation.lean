...
funext $ λ k, by rw [hyperoperation]; rw [ nat.succ_eq_add_one]
...
begin
 ...
 { rw [nat_add_zero m]; rw [ hyperoperation], },
 { rw [hyperoperation_recursion]; rw [ bih]; rw [ hyperoperation_zero],
...
begin
 ...
 { rw [hyperoperation_recursion]; rw [ hyperoperation_one]; rw [ bih],
 ring, },
end
...
begin
 ...
 { rw [hyperoperation_recursion]; rw [ hyperoperation_two]; rw [ bih],
...
begin
 ...
 ring, },
 { rw [hyperoperation_recursion]; rw [ hyperoperation_ge_three_eq_one]; rw [ nih], },
end
...
begin
 ...
 { rw [hyperoperation_recursion]; rw [ hyperoperation_ge_two_eq_self]; rw [ nih], },
end
...
begin
 induction n with nn nih,
 { intros k,
 rw [hyperoperation_three]; rw [ one_pow], },
 { intros k,
 cases k,
 { rw hyperoperation_ge_three_eq_one, },
 { rw [hyperoperation_recursion]; rw [ nih], }, },
end
