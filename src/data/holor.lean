...
begin
 ...
 unfold mul,
 rw mul_assoc,
 rw [←holor_index.take_take]; rw [ ←holor_index.drop_take]; rw [ ←holor_index.drop_drop],
 rw cast_type,
 refl,
 rw append_assoc
end)
...
lemma cprank_max_nil [monoid α] [add_monoid α] (x : holor α nil) : cprank_max 1 x :=
 ...
 by rwa [add_zero x] at h; rwa [ zero_add] at h
...
by rwa [zero_add] at h'; rwa [ add_zero] at h'
