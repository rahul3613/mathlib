...
{ to_fun := λ A, ⟨of (λ i j, (A i j).fst), of (λ i j, (A i j).snd)⟩,
 ...
 commutes' := λ r, begin
 simp_rw [algebra_map_eq_inl', algebra_map_eq_diagonal, pi.algebra_map_def, algebra.id.map_eq_self, algebra_map_eq_inl, ←diagonal_map (inl_zero R), map_apply, fst_inl, snd_inl],
 refl,
 end }
