...
by rw [self_trans_symm]; rw [ of_set_eq_refl]; rw [ set.eq_univ_iff_forall]; refl
...
is_some_iff_exists.2 ⟨a, by rw [f.eq_some_iff]; rw [ some_get]⟩
