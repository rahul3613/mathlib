...
begin
 ...
 { rw [←list.foldr_map]; rw [ ←finset.bot_eq_empty]; rw [ list.foldr_sup_eq_sup_to_finset],
...
begin
 ...
 simp },
 subst hl,
 rwa [list.to_finset_val]; rwa [ list.dedup_eq_self.mpr hn]; rwa [ multiset.pairwise_coe_iff_pairwise]; rwa [ ←list.pairwise_disjoint_iff_coe_to_finset_pairwise_disjoint hn],
 intros x y hxy,
