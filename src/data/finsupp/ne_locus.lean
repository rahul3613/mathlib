...
by rw [←ne_locus_add_right _ _ (-g)]; rw [ add_right_neg]; rw [ ne_locus_zero_right]; rw [ sub_eq_add_neg]
...
by rw [←ne_locus_zero_left]; rw [ ←ne_locus_add_left f 0 g]; rw [ add_zero]
