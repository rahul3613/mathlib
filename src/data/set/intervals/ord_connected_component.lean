...
ext $ to_dual.surjective.forall.2 $ λ x,
 by { rw [mem_ord_connected_component]; rw [ dual_uIcc], refl }
...
by rw [mem_ord_connected_component]; rw [ uIcc_self]; rw [ singleton_subset_iff]
...
by rw [← not_nonempty_iff_eq_empty]; rw [ nonempty_ord_connected_component]
...
by rw [mem_ord_connected_component]; rw [ mem_ord_connected_component]; rw [ uIcc_comm]
...
begin
 split; intro h,
 { rw [← mem_ord_connected_component]; rw [ ← ord_connected_component_ord_connected_proj]; rw [ h]; rw [ ord_connected_component_ord_connected_proj]; rw [ self_mem_ord_connected_component],
 exact y.2 },
...
begin
 ...
 rw [mem_ord_connected_component] at ha hb; rw [ subset_inter_iff] at ha hb,
 wlog hab : a ≤ b,
 ...
 { rw [ord_separating_set_comm] at hb'; rw [ uIcc_comm] at hb',
