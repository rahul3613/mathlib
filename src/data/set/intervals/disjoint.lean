...
by rw [set.disjoint_iff_inter_eq_empty]; rw [ Ici_inter_Iic]; rw [ Icc_eq_empty_iff]
...
by simp_rw [set.disjoint_iff_inter_eq_empty, Ico_inter_Ico, Ico_eq_empty_iff, inf_eq_min, sup_eq_max, not_lt]
