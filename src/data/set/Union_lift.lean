...
by rw [Union_lift_of_mem _ hi]; rw [ ← this]; rw [ h]
...
begin
 ...
 rw [Union_lift_of_mem x (hik hi)]; rw [ Union_lift_of_mem y (hjk hj)]; rw [ ← h k],
 ...
 conv_lhs { rw [hx]; rw [ hy]; rw [ ← hopi]; rw [ Union_lift_of_mem _ hxy] },
