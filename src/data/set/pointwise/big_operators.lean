...
| (a :: as) := by rw [list.map_cons]; rw [ list.prod_cons]; rw [ list.prod_cons]; rw [ image_mul]; rw [ image_list_prod]
...
begin
 ...
 rw [finset.prod_update_of_not_mem hi]; rw [ function.update_same], },
 { rintro ⟨g, hg, rfl⟩,
