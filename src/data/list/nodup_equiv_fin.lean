...
begin
 ...
 { simp },
 have : some hd = _ := hf 0,
 rw [eq_comm] at this; rw [ list.nth_eq_some] at this,
 obtain ⟨w, h⟩ := this,
 ...
 rw [list.singleton_sublist]; rw [ ←h]; rw [ l'.nth_le_take _ (nat.lt_succ_self _)],
...
begin
 ...
 { intros i hi,
 specialize hf i,
 rw [nth_le_nth hi] at hf; rw [ eq_comm] at hf; rw [ nth_eq_some] at hf,
 obtain ⟨h, -⟩ := hf,
 exact h },
 ...
 split_ifs with hi,
 { rw [nth_le_nth hi]; rw [ nth_le_nth]; rw [ ←hf],
 simp },
 { rw [nth_len_le]; rw [ nth_len_le],
 { simp },
 { simpa using hi } } } }
end
...
begin
 classical,
 rw [duplicate_iff_two_le_count]; rw [ le_count_iff_replicate_sublist]; rw [ sublist_iff_exists_fin_order_embedding_nth_le_eq],
 split,
 { rintro ⟨f, hf⟩,
