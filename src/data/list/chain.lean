...
by rw [chain_split]; rw [ chain_cons]
...
| a (b :: t) :=
begin
 rw [chain_cons]; rw [ chain_iff_nth_le],
 split,
 { rintro ⟨R, ⟨h0, h⟩⟩,
 split,
 { intro w, exact R },
...
by rw [chain'_split]; rw [ chain'_cons]
...
| (a :: b :: l₁) l₂ := by rw [cons_append]; rw [ cons_append]; rw [ chain'_cons]; rw [ chain'_cons]; rw [ ← cons_append]; rw [ chain'_append]; rw [ last']; rw [ and.assoc]
...
| (a :: b :: l) := by rw [chain'_cons]; rw [ reverse_cons]; rw [ reverse_cons]; rw [ append_assoc]; rw [ cons_append]; rw [ nil_append]; rw [ chain'_split]; rw [ ← reverse_cons]; rw [ @chain'_reverse (b :: l)]; rw [ and_comm]; rw [ chain'_pair]; rw [ flip]
...
| (a :: b :: t) :=
begin
 rw [← and_forall_succ]; rw [ chain'_cons]; rw [ chain'_iff_nth_le],
