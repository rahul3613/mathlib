...
| (i :: is) f j hj := begin
 by_cases hji : j = i,
 { subst hji, simp },
 { rw [elim_of_ne _ hji]; rw [ snd_mk]; rw [ elim_mk] }
 end
...
| (i :: is) hl v w hvw := begin
 ext, rw [← elim_self v]; rw [ hvw]; rw [ elim_self],
...
| (i :: l) t := begin
 ...
 rw [forall_eq_or_imp]; rw [ and.congr_right_iff],
 exact λ _, this
end
...
begin
 ...
 rw [← this]; rw [ ← mk_preimage_tprod]; rw [ preimage_preimage],
