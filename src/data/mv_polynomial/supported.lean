...
by rw [supported]; rw [ set.image_eq_range]; rw [ adjoin_range_eq_range_aeval]; rw [ rename]
...
begin
 classical,
 rw [supported_eq_range_rename]; rw [ alg_hom.mem_range],
 split,
 { rintros ⟨p, rfl⟩,
...
begin
 classical,
 rw [← mem_supported] at hF; rw [ supported_eq_range_rename] at hF; rw [ alg_hom.mem_range] at hF,
 cases hF with F' hF',
 use λ z, aeval z F',
 intro x,
