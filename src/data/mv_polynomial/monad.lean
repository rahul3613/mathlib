...
by rw [aeval_rename]; rw [ function.comp.left_id]
...
by rw [hom_bind₁]; rw [ eval₂_hom_comp_C]
...
by rw [bind₂_monomial]; rw [ f.map_one]; rw [ one_mul]
...
begin
 ...
 by { rw [← alg_hom.map_sum]; rw [ ← φ.as_sum], }
