...
| ⟨n₁, a₁⟩ ⟨n₂, a₂⟩ h := begin
 ...
 have e : n₁ = n₂ :=
 by rw [←array.to_list_length a₁]; rw [ ←array.to_list_length a₂]; rw [ h],
 subst e,
...
begin
 cases b,
 rw [to_list]; rw [ to_array]; rw [ list.to_buffer]; rw [ append_list_mk_buffer],
 congr,
 { simpa },
...
begin
 cases l,
 { refl },
 { rw [list.to_buffer]; rw [ to_list_append_list],
 refl }
end
...
by rw [←to_buffer_to_list b]; rw [ to_list_to_buffer]; rw [ size_to_buffer]
...
begin
 ...
 simp },
 { rw [list.length] at h; rw [ nat.succ_lt_succ_iff] at h,
