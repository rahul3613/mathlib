...
by rw [ne]; rw [ int.gcd_comm]; rw [ int.gcd_eq_one_iff_coprime]; rw [ (nat.prime_iff_prime_int.1 pp.1).coprime_iff_not_dvd]; rw [ not_not]; rw [ int_coe_zmod_eq_zero_iff_dvd]
