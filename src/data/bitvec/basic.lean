...
by rw [of_fin]; rw [to_nat_of_nat]; rw [nat.mod_eq_of_lt]; apply i.is_lt
...
by rw [list.foldr_reverse]; rw [ flip]; refl
...
by dsimp [of_fin]; rw [to_fin_val]; rw [ of_nat_to_nat]
