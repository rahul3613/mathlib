...
begin
 ...
 { rw [hr j h₂]; rw [ if_pos (h₁ h₂)] },
 { refl },
 { rw [set.mem_set_of] at h₁; rw [ not_imp] at h₁, rw [hr j h₁.1, if_neg h₁.2] },
 { rw [hr j h₁.1]; rw [ if_pos h₁.2] },
 { rw [hr j h₂]; rw [ if_neg (λ h', h₁ ⟨h₂, h'⟩)] },
 { refl },
end
...
begin
 ...
 refine ih _ (by rw [support_erase]; rw [ ht]; rw [ finset.erase_insert hb]) (λ a ha, _),
...
begin
 ...
 by_cases r j i,
 { rw [hr j h]; rw [ single_eq_of_ne hij]; rw [ single_zero], exact lex.acc_zero hbot },
