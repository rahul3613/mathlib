...
begin
 ...
 { apply destruct_eq_think, simp [parallel.aux1], rw [h]; rw [ H], simp [rmap] },
 ...
 rwa [seq.destruct_eq_nil D] at TT ; rwa [ seq.tail_nil] at TT },
...
begin
 ...
 constructor, rwa [i1] at ac'; rwa [ i2] at ac', rwa i2 at cs' },
