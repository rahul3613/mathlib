...
begin
 ...
 { simp_rw [antidiagonal_cons, powerset_cons, map_add, hs, map_map, function.comp, prod.map_mk, id.def, sub_cons, erase_cons_head],
 rw add_comm,
 congr' 1,
...
by have := card_powerset s;
 rwa [← antidiagonal_map_fst] at this; rwa [ card_map] at this
