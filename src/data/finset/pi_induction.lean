...
begin
 ...
 have hx' : x ∉ g i, by { rw [hg]; rw [ update_same], apply not_mem_erase },
 obtain rfl : f = update g i (insert x (g i)),
 by rw [hg]; rw [ update_idem]; rw [ update_same]; rw [ insert_erase x_mem]; rw [ update_eq_self],
 clear hg, rw [update_same] at hr; rw [ erase_insert hx'] at hr,
