...
{ seq_left_eq := λ α β s t, begin
 rw [seq_def]; rw [ fmap_def]; rw [ seq_left_def],
 ...
 rw [seq_def]; rw [ fmap_def]; rw [ seq_right_def],
 obtain rfl | hs := s.eq_empty_or_nonempty,
 { rw [if_pos rfl]; rw [ image_empty]; rw [ sup_empty]; rw [ bot_eq_empty] },
 { ext a,
...
by { rw [traverse]; rw [ multiset.id_traverse], exact s.val_to_finset }
...
begin
 ...
 rw [is_lawful_functor.comp_map]; rw [ multiset.map_traverse],
end
