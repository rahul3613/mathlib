...
begin
 ...
 rw [(show ∀ a b ε : ℝ, dist a b < ε ↔ a < b + ε ∧ b - ε < a, by { intros, simp only [← metric.mem_ball, real.ball_eq_Ioo, set.mem_Ioo, and_comm], })],
...
begin
 ...
 rw [set_like.mem_coe]; rw [ subalgebra.mem_comap],
