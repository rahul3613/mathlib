...
{ continuous_mul := by
 ...
 rintros ⟨f, g⟩,
 rw [continuous_at]; rw [ tendsto_iff_forall_compact_tendsto_uniformly_on]; rw [ nhds_prod_eq],
 ...
 rw continuous_iff_continuous_at,
 intro f,
 rw [continuous_at]; rw [ tendsto_iff_forall_compact_tendsto_uniformly_on],
...
begin
 ...
 simp_rw [←tsum_apply h, ←tsum_apply ((equiv.add_right (1 : ℤ)).summable_iff.mpr h), equiv.coe_add_right, comp_apply, coe_add_right, add_one_zsmul, add_comm (_ • p) p, ←add_assoc] },
