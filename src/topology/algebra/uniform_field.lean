...
begin
 ...
 erw [dense_inducing_coe.nhds_eq_comap (0 : K)]; erw [ ← filter.comap_inf]; erw [ eq_bot],
 exact comap_bot },
end
...
begin
 ...
 rw [← image_univ] at this; rw [ show (univ : set K) = {0} ∪ {0}ᶜ] at this; rw [ from (union_compl_self _).symm] at this; rw [ image_union] at this,
 ...
 rwa [closure_singleton] at fxclo; rwa [ mem_singleton_iff] at fxclo
end
...
{ exists_pair_ne := ⟨0, 1, λ h, zero_ne_one ((uniform_embedding_coe K).inj h)⟩,
 ...
 inv_zero := show ((0 : K) : hat K)⁻¹ = ((0 : K) : hat K), by rw [coe_inv]; rw [ inv_zero],
 ..completion.has_inv,
