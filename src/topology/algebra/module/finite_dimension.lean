...
begin
 ...
 by conv_rhs {congr, funext, rw [smul_eq_mul]; rw [ mul_one]}; refl
 ... ≤ (@nhds 𝕜 t ((0 : 𝕜) • 1)) :
...
begin
 ...
 { rw [finrank_eq_zero] at H; rw [ linear_map.range_eq_bot] at H,
 rw H,
 ...
 { rw [← linear_map.range_eq_top]; rw [ submodule.range_liftq],
...
begin
 ...
 ext x,
 dsimp,
 rw [basis.equiv_fun_symm_apply]; rw [ basis.sum_repr]
end
