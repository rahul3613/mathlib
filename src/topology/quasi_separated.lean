...
begin
 ...
 h.continuous,
 { symmetry,
 rw [← set.preimage_inter]; rw [ set.image_preimage_eq_inter_range]; rw [ set.inter_eq_left_iff_subset],
 ...
 convert hU'',
 rw [set.image_preimage_eq_inter_range]; rw [ set.inter_eq_left_iff_subset],
...
begin
 ...
 rw [h.to_embedding.is_compact_iff_is_compact_image]; rw [ set.image_inter h.inj],
 exact H (f '' U) (f '' V)
