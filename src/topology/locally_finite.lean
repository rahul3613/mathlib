...
begin
 ...
 by rw [← Union_inter]; rw [ ← nhds_within_inter_of_mem' (nhds_within_le_nhds haU)]
...
begin
 rintro x -,
 rw [continuous_within_at]; rw [ hf.nhds_within_Union]; rw [ tendsto_supr],
 intro i,
 by_cases hx : x ∈ closure (f i),
 { exact hc i _ hx },
 { rw [mem_closure_iff_nhds_within_ne_bot] at hx; rw [ not_ne_bot] at hx,
 rw [hx],
 exact tendsto_bot }
end
...
begin
 ...
 by rwa [← is_open_compl_iff] at this; rwa [ compl_Union] at this; rwa [ Inter_subtype] at this,
