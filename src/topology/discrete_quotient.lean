...
singletons_open_iff_discrete.1 $ S.proj_surjective.forall.2 $ λ x,
 by { rw [← S.proj_quotient_map.is_open_preimage]; rw [ fiber_eq], exact S.is_open_set_of_rel _ }
...
begin
 rw [← mem_singleton_iff]; rw [ ← connected_component_eq_singleton]; rw [ connected_component_eq_Inter_clopen]; rw [ mem_Inter],
 rintro ⟨U, hU1, hU2⟩,
...
begin
 ...
 rw [fiber_eq]; rw [ of_le_proj]; rw [ fiber_eq],
 exact λ _ h', h h'
end
...
begin
 ...
 rwa [← is_compact_univ_iff] at this; rwa [ is_compact_iff_finite] at this; rwa [ finite_univ_iff] at this
end
