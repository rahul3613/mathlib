...
by rw [←nnreal.coe_eq]; rw [ coe_tsum]; rw [ nnreal.coe_add]; rw [ coe_sum]; rw [ coe_tsum]; rw [ sum_add_tsum_nat_add k (nnreal.summable_coe.2 hf)]
...
begin
 ...
 rw [h_f_coe]; rw [ ← @real.to_nnreal_coe 0],
