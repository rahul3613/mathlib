...
begin
 ...
 by rw [h_singleton_eq_inter']; rw [ ←Ioi_pred]; rw [ ←Iio_succ],
...
begin
 ...
 by rw [inter_comm]; rw [ Ici_inter_Iic]; rw [ Icc_self a],
 by_cases ha_top : is_top a,
 { rw [ha_top.Iic_eq] at h_singleton_eq_inter; rw [ inter_comm] at h_singleton_eq_inter; rw [ inter_univ] at h_singleton_eq_inter,
 ...
 by_cases ha_bot : is_bot a,
 { rw [ha_bot.Ici_eq] at h_singleton_eq_inter; rw [ inter_univ] at h_singleton_eq_inter,
 rw h_singleton_eq_inter,
 exact is_open_generate_from_of_mem ⟨succ a, or.inr rfl⟩, },
 { rw is_bot_iff_is_min at ha_bot,
 rw ←Ioi_pred_of_not_is_min ha_bot at h_singleton_eq_inter,
