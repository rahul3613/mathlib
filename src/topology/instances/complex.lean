...
begin
 ...
 { rw [range_subset_iff] at this; rw [ ← coe_algebra_map] at this,
...
begin
 ...
 ⟨ by { erw [uniformity_subtype]; erw [ uniformity_subtype]; erw [ filter.comap_comap], congr, } ⟩,
 ...
 rw [ring_hom.comp_apply] at this; rw [ ring_hom.comp_apply] at this; rw [ hr] at this; rw [ ring_equiv.to_ring_hom_eq_coe] at this,
 convert this using 1,
 { exact (dense_inducing.extend_eq di hc.continuous _).symm, },
 { rw [← of_real.coe_range_restrict]; rw [ hr], refl, }},
