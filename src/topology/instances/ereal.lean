...
⟨⟨begin
 ...
 { rw [@order_topology.topology_eq_generate_intervals ereal _]; rw [ ← coinduced_le_iff_le_induced],
...
begin
 rw [nhds_top']; rw [ mem_infi_of_directed],
 { refl },
...
begin
 rw [nhds_bot']; rw [ mem_infi_of_directed],
 { refl },
