...
begin
 ...
 refine ⟨s, hs, _⟩,
 dsimp only [W] at hh ⊢,
 rwa [dif_pos hs]; rwa [ ← set.preimage_comp]; rwa [ ← Profinite.coe_comp]; rwa [ C.w] },
 { intro hx,
 ...
 rw (hV s).2,
 dsimp only [W] at hx,
 rwa [dif_pos hs] at hx ; rwa [ ← set.preimage_comp] at hx ; rwa [ ← Profinite.coe_comp] at hx ; rwa [ C.w] at hx } }
end
...
begin
 ...
 rw [locally_constant.of_clopen_fiber_zero hV]; rw [ ← h],
end
...
begin
 ...
 rw [h]; rw [ locally_constant.coe_comap _ _ (C.π.app j).continuous] },
