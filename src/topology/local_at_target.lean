...
begin
 simp_rw [inducing_coe.inducing_iff, inducing_iff_nhds, restrict_preimage, maps_to.coe_restrict, restrict_eq, ← @filter.comap_comap _ _ _ _ coe f] at h ⊢,
 intros a,
 rw [← h]; rw [ ← inducing_coe.nhds_eq_comap],
end
...
begin
 ...
 rw [← s.inter_univ]; rw [ ← this]; rw [ set.inter_Union],
...
begin
 simp_rw [inducing_coe.inducing_iff, inducing_iff_nhds, restrict_preimage, maps_to.coe_restrict, restrict_eq, ← @filter.comap_comap _ _ _ _ coe f],
 split,
 { intros H i x, rw [← H]; rw [ ← inducing_coe.nhds_eq_comap] },
 { intros H x,
