...
begin
 ...
 rw [comp.assoc]; rw [ stone_cech_extend_extends ht]; rw [ ← comp.assoc]; rw [ hs]; rw [ comp.left_id],
end
...
begin
 ...
 { rw [this]; rw [ set.preimage_comp]; rw [ ←is_closed_compl_iff]; rw [ ←preimage_compl]; rw [ ←preimage_subtype_coe_eq_compl subset.rfl],
 { exact hZ₁.preimage hφ },
 { rw [hZ₁₂.inter_eq]; rw [ inter_empty] } },
