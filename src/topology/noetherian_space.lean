...
begin
 rw [noetherian_space_iff]; rw [ complete_lattice.well_founded_iff_is_Sup_finite_compact]; rw [ complete_lattice.is_Sup_finite_compact_iff_all_elements_compact],
...
begin
 ...
 intros t ht,
 rw [← set.inter_eq_left_iff_subset.mpr ht]; rw [ set.inter_Union],
...
begin
 ...
 { rwa [finset.sup_union]; rwa [ ← hS₁']; rwa [ ← hS₂']; rwa [ ← inf_sup_left]; rwa [ left_eq_inf] } }
end
