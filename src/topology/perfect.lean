...
begin
 ...
 rw [acc_pt]; rw [ ← inf_principal]; rw [ ← inf_assoc]; rw [ inf_of_le_left this],
 exact h_acc,
end
...
begin
 ...
 rw [acc_pt]; rw [ nhds_within]; rw [ inf_assoc]; rw [ inf_principal]; rw [ this],
...
begin
 ...
 { rw [inter_comm]; rw [ inter_union_diff], },
end
