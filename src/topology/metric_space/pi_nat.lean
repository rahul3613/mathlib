...
begin
 ...
 rw [shortest_prefix_diff]; rw [ dif_pos A],
...
begin
 rw [longest_prefix]; rw [ le_tsub_iff_right],
...
begin
 ...
 rw [longest_prefix] at B ⊢; rw [ shortest_prefix_diff] at B ⊢; rw [ dif_pos A] at B ⊢,
 ...
 * if `x ∉ s`, `y ∉ s`, let `w` be the longest prefix of `x` shared by an element of `s`. If its
 ...
 { rw [← mem_cylinder_iff_eq]; rw [ first_diff_comm],
 apply cylinder_anti y _ A.some_spec.2,
 exact first_diff_le_longest_prefix hs ys xs },
 rwa [← fy] at I ; rwa [ ← I2] at I ; rwa [ ← mem_cylinder_iff_eq] at I ; rwa [ mem_cylinder_iff_le_first_diff hfxfy.symm] at I ; rwa [ first_diff_comm _ x] at I },
 -- case where `x ∉ s`
 { by_cases ys : y ∈ s,
 ...
 rw fs y ys at ⊢ hfxfy,
 rwa [← fx] at I ; rwa [ I2] at I ; rwa [ ← mem_cylinder_iff_eq] at I ; rwa [ mem_cylinder_iff_le_first_diff hfxfy] at I },
 -- case where `y ∉ s`
 { have Ax : (s ∩ cylinder x (longest_prefix x s)).nonempty :=
 inter_cylinder_longest_prefix_nonempty hs hne x,
 ...
 by rw [I1]; rw [ I2]; rw [ I3],
 rw [← fx] at this; rw [ ← fy] at this; rw [ ← mem_cylinder_iff_eq] at this; rw [ mem_cylinder_iff_le_first_diff hfxfy] at this,
 exact this } } } }
end
