...
{ edist := λ s t, Hausdorff_edist (s : set α) t,
 ...
 rwa [s.is_compact.is_closed.closure_eq] at this; rwa [ t.is_compact.is_closed.closure_eq] at this,
 end }
