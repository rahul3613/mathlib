...
by { rw [edist_comm z x]; rw [ edist_comm z y], apply edist_congr_right h, }
...
by rw [edist_comm]; rw [ mem_closed_ball]
...
by { rw [← nhds_within_univ b]; rw [ tendsto_nhds_within_nhds_within], simp only [mem_univ, true_and] }
