...
by rw [continuous_at]; rw [ (uniform_fun.has_basis_nhds ι α _).tendsto_right_iff]; refl
...
by rw [uniform_continuous]; rw [ (uniform_fun.has_basis_uniformity ι α).tendsto_right_iff]; refl
...
begin
 rw [equicontinuous_at_iff_continuous_at]; rw [ continuous_at]; rw [ hX.tendsto_iff (uniform_fun.has_basis_nhds ι α _)],
 refl
end
...
begin
 rw [equicontinuous_at_iff_continuous_at]; rw [ continuous_at]; rw [ (uniform_fun.has_basis_nhds_of_basis ι α _ hα).tendsto_right_iff],
 refl
end
...
begin
 rw [equicontinuous_at_iff_continuous_at]; rw [ continuous_at]; rw [ hX.tendsto_iff (uniform_fun.has_basis_nhds_of_basis ι α _ hα)],
 refl
end
...
begin
 rw [uniform_equicontinuous_iff_uniform_continuous]; rw [ uniform_continuous]; rw [ hβ.tendsto_iff (uniform_fun.has_basis_uniformity ι α)],
 simp_rw [prod.forall],
 refl
end
...
begin
 rw [uniform_equicontinuous_iff_uniform_continuous]; rw [ uniform_continuous]; rw [ (uniform_fun.has_basis_uniformity_of_basis ι α hα).tendsto_right_iff],
 refl
end
...
begin
 rw [uniform_equicontinuous_iff_uniform_continuous]; rw [ uniform_continuous]; rw [ hβ.tendsto_iff (uniform_fun.has_basis_uniformity_of_basis ι α hα)],
 simp_rw [prod.forall],
 refl
end
...
begin
 ...
 rw [equicontinuous_at_iff_continuous_at]; rw [ equicontinuous_at_iff_continuous_at]; rw [ this.continuous_at_iff],
 refl
end
...
begin
 ...
 rw [uniform_equicontinuous_iff_uniform_continuous]; rw [ uniform_equicontinuous_iff_uniform_continuous]; rw [ this.uniform_continuous_iff],
 refl
end
