...
begin
 ...
 haveI : @compact_space γ u'.to_topological_space, { rwa h' },
 rw [compact_space_uniformity]; rw [ compact_space_uniformity]; rw [ h]; rw [ h']
end
...
{ uniformity := 𝓝ˢ (diagonal γ),
 ...
 rw [supr_split_single _ x]; rw [ comap_const_of_mem (λ V, mem_of_mem_nhds)],
...
begin
 ...
 intros v hv,
 rw [mem_preimage]; rw [ image_eq_one_of_nmem_mul_tsupport hv],
