...
begin
 ...
 have hC : K ⊆ ⋃ i, C i,
 { rw [← K.inter_Union]; rw [ subset_inter_iff],
...
begin
 rw [compact_convergence_topology]; rw [ continuous_map.compact_open],
...
by rw [compact_open_eq_compact_convergence]; rw [ tendsto_iff_forall_compact_tendsto_uniformly_on']
...
begin
 rw [tendsto_iff_forall_compact_tendsto_uniformly_on]; rw [ ← tendsto_uniformly_on_univ],
