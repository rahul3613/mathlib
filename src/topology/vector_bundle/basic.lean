...
begin
 ...
 rw [coe_coord_changeL' e' e hb]; rw [ (coord_changeL R e e' b).symm_to_linear_equiv]; rw [ coe_coord_changeL' e e' hb.symm]; rw [ linear_equiv.trans_symm]; rw [ linear_equiv.symm_symm],
end
...
begin
 ext,
 { rw [e.mk_symm hb.1 y]; rw [ e'.coe_fst']; rw [ e.proj_symm_apply' hb.1],
...
by rw [e.mk_coord_changeL e' hb]; rw [ e.mk_symm hb.1]
...
by rw [e.coord_changeL_apply e' hb]; rw [ e.mk_symm hb.1]
...
begin
 ...
 simp_rw [e.right_inv h, coe_coe, e.apply_eq_prod_continuous_linear_equiv_at R b hb, continuous_linear_equiv.apply_symm_apply],
end
...
begin
 rw [trivialization.coord_changeL_apply']; rw [ local_triv_symm_fst]; rw [ local_triv_apply]; rw [ coord_change_comp],
...
by { rw [local_triv_at]; rw [ mem_local_triv_source], exact Z.mem_base_set_at b }
...
begin
 ext1 v,
 rw [(Z.local_triv i).continuous_linear_map_at_apply R]; rw [ (Z.local_triv i).coe_linear_map_at_of_mem],
 exacts [rfl, hb]
end
...
by { ext1 v, rw [(Z.local_triv i).symmL_apply R]; rw [ (Z.local_triv i).symm_apply], exacts [rfl, hb] }
...
{ continuous_triv_change := begin
 ...
 rw [a.mk_coord_change _ _ hb]; rw [ e'.mk_symm hb.1],
 refl,
 end,
 .. a }
...
{ trivialization_linear' := begin
 ...
 intros b hb,
 ext v,
 rw [a.coord_change_apply he he' hb v]; rw [ continuous_linear_equiv.coe_coe]; rw [ trivialization.coord_changeL_apply],
 exacts [rfl, hb]
 end }
...
begin
 ext,
 simp_rw [in_coordinates, continuous_linear_map.coe_comp', continuous_linear_equiv.coe_coe, trivialization.coe_continuous_linear_equiv_at_eq, trivialization.symm_continuous_linear_equiv_at_eq]
end
