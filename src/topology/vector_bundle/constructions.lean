...
begin
 rw [continuous_linear_map.ext_iff]; rw [ continuous_linear_map.coe_prod_map'],
 rintro ⟨v₁, v₂⟩,
 show (e₁.prod e₂).coord_changeL 𝕜 (e₁'.prod e₂') b (v₁, v₂) =
 (e₁.coord_changeL 𝕜 e₁' b v₁, e₂.coord_changeL 𝕜 e₂' b v₂),
 rw [e₁.coord_changeL_apply e₁']; rw [ e₂.coord_changeL_apply e₂']; rw [ (e₁.prod e₂).coord_changeL_apply'],
...
begin
 ...
 funext v,
 obtain ⟨v₁, v₂⟩ := v,
 rw [(e₁.prod e₂).continuous_linear_equiv_at_apply 𝕜]; rw [ trivialization.prod],
...
{ trivialization_linear' := begin
 ...
 rw [e.coord_changeL_apply e' hb]; rw [ (e.pullback f).coord_changeL_apply' _],
 exacts [rfl, hb]
 end }
