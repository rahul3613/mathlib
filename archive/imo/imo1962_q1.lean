...
begin
 ...
 contradiction },
 { rw [problem_predicate] at h1; rw [ digits_def' (dec_trivial : 2 ≤ 10) n.succ_pos] at h1; rw [ list.head] at h1; rw [ list.tail_cons] at h1; rw [ list.concat_eq_append] at h1,
 split,
 { rw [← h1.left]; rw [ div_add_mod (n+1) 10], },
 { rw [← h1.right]; rw [ of_digits_append]; rw [ of_digits_digits]; rw [ of_digits_singleton]; rw [ add_comm]; rw [ mul_comm], }, },
end
...
begin
 ...
 have h4 : 6 * 10 ^ 0 + c = 4 * (10 * c + 6), by rw [h3]; rw [ h2.right]; rw [ h2.left],
 linarith,
end
...
begin
 ...
 have h4 : 6 * 10 ^ 1 + c = 4 * (10 * c + 6), by rw [h3]; rw [ h2.right]; rw [ h2.left],
...
begin
 ...
 have h4 : 6 * 10 ^ 2 + c = 4 * (10 * c + 6), by rw [h3]; rw [ h2.right]; rw [ h2.left],
...
begin
 ...
 have h4 : 6 * 10 ^ 3 + c = 4 * (10 * c + 6), by rw [h3]; rw [ h2.right]; rw [ h2.left],
...
begin
 ...
 have h4 : 6 * 10 ^ 4 + c = 4 * (10 * c + 6), by rw [h3]; rw [ h2.right]; rw [ h2.left],
...
begin
 ...
 have h4 : 6 * 10 ^ 5 + c = 4 * (10 * c + 6), by rw [h3]; rw [ h2.right]; rw [ h2.left],
 zify at *,
