...
begin
 ...
 rw [fin.coe_mk]; rw [ this]; rw [ nat.add_mod_right]; rw [ nat.mod_eq_of_lt]; rw [ nat.add_sub_cancel],
 linarith
end
...
begin
 ...
 ... = (m+1) * (n+1) : by rw [sum_const]; rw [ card_fin]; rw [ nat.nsmul_eq_mul],
 ...
 intros i j hij,
 rwa [add_le_add_iff_right] at hij; rwa [ a.map_rel_iff] at hij,
 end⟩,
 ...
 rw [←mem_coe] at h2; rw [ ←range_order_emb_of_fin A hm] at h2; rw [ set.mem_range] at h2,
 cases h2 with j hj,
 refine ⟨j, ⟨_, fin.le_last j⟩, hj⟩,
 rw [← a.strict_mono.lt_iff_lt]; rw [ hj],
