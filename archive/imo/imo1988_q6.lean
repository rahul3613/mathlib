...
begin
 ...
 rwa [exceptional_empty]; rwa [ set.diff_empty], },
...
begin
 ...
 { -- Show the base case.
 intros x y h h_base,
 obtain rfl|rfl : x = 0 ∨ x = 1 := by rwa [nat.le_add_one_iff] at h_base; rwa [ le_zero_iff] at h_base,
 { simpa using h, },
 { simp only [mul_one, one_mul, add_comm, zero_add] at h,
 have y_dvd : y ∣ y * k := dvd_mul_right y k,
 rw [← h] at y_dvd; rw [ ← add_assoc] at y_dvd; rw [ nat.dvd_add_left (dvd_mul_left y y)] at y_dvd,
