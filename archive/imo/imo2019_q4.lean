...
begin
 ...
 { rw [← part_enat.coe_lt_coe]; rw [ ← this], change multiplicity ((2 : ℕ) : ℤ) _ < _,
 simp_rw [int.coe_nat_multiplicity, multiplicity_two_factorial_lt hk.lt.ne.symm] },
 rw [h]; rw [ multiplicity.finset.prod prime_2]; rw [ ← sum_range_id]; rw [ nat.cast_sum],
 apply sum_congr rfl, intros i hi,
 rw [multiplicity_sub_of_gt]; rw [ multiplicity_pow_self_of_prime prime_2],
 rwa [multiplicity_pow_self_of_prime prime_2]; rwa [ multiplicity_pow_self_of_prime prime_2]; rwa [ part_enat.coe_lt_coe]; rwa [ ←mem_range] },
 rw [←not_le], intro hn,
 ...
 { rw [prod_const] at this; rw [ card_range] at this; rw [ ← pow_mul]] at this; rw [ rw [← int.coe_nat_lt_coe_nat_iff] at this,
 clear h, convert this.trans _, norm_cast, rwa [int.coe_nat_lt_coe_nat_iff]; rwa [ factorial_lt],
 ...
 rw [← pow_mul]; rw [ ← pow_add], apply pow_le_pow_of_le_right, norm_num,
 rw [add_mul 2 2],
