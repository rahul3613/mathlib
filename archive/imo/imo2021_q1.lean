...
begin
 ...
 exact_mod_cast this, },
 rw [← le_sub_iff_add_le'] at hl; rw [ sqrt_le_iff] at hl; rw [ pow_two] at hl,
...
begin
 ...
 rw [le_sub_iff_add_le'] at hl; rw [ le_sqrt (h1 l) (h1 n)] at hl; rw [ pow_two] at hl,
 rw [← add_le_add_iff_right 2]; rw [ ← @nat.cast_le ℝ],
...
begin
 ...
 ring_exp,
 rw [pow_two]; rw [ ← sqrt_mul h1n]; rw [ sqrt_mul_self h1n],
...
begin
 ...
 { apply nat.floor_le, rw [sub_nonneg]; rw [ le_sqrt],
...
begin
 ...
 { rw [finset.mem_insert]; rw [ finset.mem_singleton]; rw [ finset.mem_singleton],
 push_neg,
...
begin
 ...
 { rw [← finset.inter_distrib_left]; rw [ finset.sdiff_union_self_eq_union]; rw [ finset.union_eq_left_iff_subset.mpr hA]; rw [ (finset.inter_eq_left_iff_subset _ _).mpr hBsub],
